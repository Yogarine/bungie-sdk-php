 ...
 * @link     https://openapi-generator.tech
 */
class ForumPostSearchResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'relatedPosts' => '\Bungie\Model\ForumPostResponse[]',
        'authors' => '\Bungie\Model\UserGeneralUser[]',
        'groups' => '\Bungie\Model\GroupsV2GroupResponse[]',
        'searchedTags' => '\Bungie\Model\TagsModelsContractsTagResponse[]',
        'polls' => '\Bungie\Model\ForumPollResponse[]',
        'recruitmentDetails' => '\Bungie\Model\ForumForumRecruitmentDetail[]',
        'availablePages' => 'int',
        'results' => '\Bungie\Model\ForumPostResponse[]',
        'totalResults' => 'int',
        'hasMore' => 'bool',
    ...
    protected static $setters = [
        ...
        'polls' => 'setPolls',
        'recruitmentDetails' => 'setRecruitmentDetails',
    ...
    protected static $getters = [
        ...
        'authors' => 'getAuthors',
        'groups' => 'getGroups',
        'searchedTags' => 'getSearchedTags',
        'polls' => 'getPolls',
        'recruitmentDetails' => 'getRecruitmentDetails',
    ...
    {
        $this->container['relatedPosts'] = isset($data['relatedPosts']) ? $data['relatedPosts'] : null;
        $this->container['authors'] = isset($data['authors']) ? $data['authors'] : null;
        $this->container['groups'] = isset($data['groups']) ? $data['groups'] : null;
        $this->container['searchedTags'] = isset($data['searchedTags']) ? $data['searchedTags'] : null;
        $this->container['polls'] = isset($data['polls']) ? $data['polls'] : null;
        $this->container['recruitmentDetails'] = isset($data['recruitmentDetails']) ? $data['recruitmentDetails'] : null;
        $this->container['availablePages'] = isset($data['availablePages']) ? $data['availablePages'] : null;
     ...
     * Gets relatedPosts
     *
     * @return \Bungie\Model\ForumPostResponse[]|null
     */
    public function getRelatedPosts()
    {
        return $this->container['relatedPosts'];
    }

    /**
     * Sets relatedPosts
     *
     * @param \Bungie\Model\ForumPostResponse[]|null $relatedPosts relatedPosts
     *
     * @return $this
     */
    public function setRelatedPosts($relatedPosts)
    {
        $this->container['relatedPosts'] = $relatedPosts;
     ...
     * Gets authors
     *
     * @return \Bungie\Model\UserGeneralUser[]|null
     */
     ...
     * Sets authors
     *
     * @param \Bungie\Model\UserGeneralUser[]|null $authors authors
     *
     * @return $this
     */
     ...
     * Gets groups
     *
     * @return \Bungie\Model\GroupsV2GroupResponse[]|null
     */
     ...
     * Sets groups
     *
     * @param \Bungie\Model\GroupsV2GroupResponse[]|null $groups groups
     *
     * @return $this
     */
     ...
     * Gets searchedTags
     *
     * @return \Bungie\Model\TagsModelsContractsTagResponse[]|null
     */
    public function getSearchedTags()
    {
        return $this->container['searchedTags'];
    }

    /**
     * Sets searchedTags
     *
     * @param \Bungie\Model\TagsModelsContractsTagResponse[]|null $searchedTags searchedTags
     *
     * @return $this
     */
    public function setSearchedTags($searchedTags)
    {
        $this->container['searchedTags'] = $searchedTags;
     ...
     * Gets polls
     *
     * @return \Bungie\Model\ForumPollResponse[]|null
     */
     ...
     * Sets polls
     *
     * @param \Bungie\Model\ForumPollResponse[]|null $polls polls
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\ForumForumRecruitmentDetail[]|null
     */
    public function getRecruitmentDetails()
    {
        return $this->container['recruitmentDetails'];
    }

    /**
     * Sets recruitmentDetails
     *
     * @param \Bungie\Model\ForumForumRecruitmentDetail[]|null $recruitmentDetails recruitmentDetails
     *
     * @return $this
     */
    public function setRecruitmentDetails($recruitmentDetails)
    {
        $this->container['recruitmentDetails'] = $recruitmentDetails;
    ...
    {
        return $this->container['availablePages'];
    }

    /**
     * Sets availablePages
     *
     * @param int|null $availablePages availablePages
     *
     * @return $this
     */
    public function setAvailablePages($availablePages)
    {
        $this->container['availablePages'] = $availablePages;
     ...
     * Sets results
     *
     * @param \Bungie\Model\ForumPostResponse[]|null $results results
     *
     * @return $this
     */
