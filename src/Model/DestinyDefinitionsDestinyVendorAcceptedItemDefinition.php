...
class DestinyDefinitionsDestinyVendorAcceptedItemDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyVendorAcceptedItemDefinition';
     ...
     *
     * @param int $destinationInventoryBucketHash This is the bucket where the item being transferred will be put, given that it was being transferred *from* the bucket defined in acceptedInventoryBucketHash.
     *
     * @return $this
     */
