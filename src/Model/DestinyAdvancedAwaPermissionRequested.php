...
class DestinyAdvancedAwaPermissionRequested implements ModelInterface, ArrayAccess
{
     ...
     * Sets type
     *
     * @param DestinyAdvancedAwaType|null $type Type of advanced write action.
     *
     * @return $this
     */
     ...
     * Sets membershipType
     *
     * @param BungieMembershipType|null $membershipType Destiny membership type of the account to modify.
     *
     * @return $this
     */
