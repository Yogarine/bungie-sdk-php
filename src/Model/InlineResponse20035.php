 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20035 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Destiny\Responses\DestinyLinkedProfilesResponse',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Destiny\Responses\DestinyLinkedProfilesResponse|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Destiny\Responses\DestinyLinkedProfilesResponse|null $response response
     *
     * @return $this
     */
