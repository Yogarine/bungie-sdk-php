 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse2004 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\User\Models\GetCredentialTypesForAccountResponse[]',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\User\Models\GetCredentialTypesForAccountResponse[]|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\User\Models\GetCredentialTypesForAccountResponse[]|null $response response
     *
     * @return $this
     */
