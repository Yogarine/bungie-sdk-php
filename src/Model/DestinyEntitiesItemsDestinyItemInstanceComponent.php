...
class DestinyEntitiesItemsDestinyItemInstanceComponent implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'cannotEquipReason' => 'DestinyEquipFailureReason'
    ];
     ...
     * Sets damageType
     *
     * @param DestinyDamageType|null $damageType If the item has a damage type, this is the item's current damage type.
     *
     * @return $this
     */
     ...
     * Sets primaryStat
     *
     * @param DestinyDestinyStat|null $primaryStat The item stat that we consider to be \"primary\" for the item. For instance, this would be \"Attack\" for Weapons or \"Defense\" for armor.
     *
     * @return $this
     */
     ...
     *
     * @return DestinyEquipFailureReason|null
     */
     ...
     *
     * @param DestinyEquipFailureReason|null $cannotEquipReason If you cannot equip the item, this is a flags enum that enumerates all of the reasons why you couldn't equip the item. You may need to refine your UI further by using unlockHashesRequiredToEquip and equipRequiredLevel.
     *
     * @return $this
     */
