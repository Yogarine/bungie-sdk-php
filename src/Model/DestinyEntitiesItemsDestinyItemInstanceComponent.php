 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyEntitiesItemsDestinyItemInstanceComponent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Entities.Items.DestinyItemInstanceComponent';
     ...
     * Sets damageType
     *
     * @param object $damageType If the item has a damage type, this is the item's current damage type.
     *
     * @return $this
     */
     ...
     * Sets damageTypeHash
     *
     * @param int $damageTypeHash The current damage type's hash, so you can look up localized info and icons for it.
     *
     * @return $this
     */
     ...
     * Sets primaryStat
     *
     * @param object $primaryStat The item stat that we consider to be \"primary\" for the item. For instance, this would be \"Attack\" for Weapons or \"Defense\" for armor.
     *
     * @return $this
     */
     ...
     * Sets itemLevel
     *
     * @param int $itemLevel The Item's \"Level\" has the most significant bearing on its stats, such as Light and Power.
     *
     * @return $this
     */
     ...
     * Sets quality
     *
     * @param int $quality The \"Quality\" of the item has a lesser - but still impactful - bearing on stats like Light and Power.
     *
     * @return $this
     */
     ...
     * Sets isEquipped
     *
     * @param bool $isEquipped Is the item currently equipped on the given character?
     *
     * @return $this
     */
     ...
     * Sets canEquip
     *
     * @param bool $canEquip If this is an equippable item, you can check it here. There are permanent as well as transitory reasons why an item might not be able to be equipped: check cannotEquipReason for details.
     *
     * @return $this
     */
     ...
     *
     * @param int $equipRequiredLevel If the item cannot be equipped until you reach a certain level, that level will be reflected here.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $unlockHashesRequiredToEquip Sometimes, there are limitations to equipping that are represented by character-level flags called \"unlocks\".  This is a list of flags that they need in order to equip the item that the character has not met. Use these to look up the descriptions to show in your UI by looking up the relevant DestinyUnlockDefinitions for the hashes.
     *
     * @return $this
     */
     ...
     *
     * @param object $cannotEquipReason If you cannot equip the item, this is a flags enum that enumerates all of the reasons why you couldn't equip the item. You may need to refine your UI further by using unlockHashesRequiredToEquip and equipRequiredLevel.
     *
     * @return $this
     */
