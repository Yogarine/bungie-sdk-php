...
class DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $overrideDisplay The node *may* have display properties that override the active Activity's display properties.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeFeaturingStateDefinition[]|null
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeFeaturingStateDefinition[]|null $featuringStates The node may have various visual accents placed on it, or styles applied. These are the list of possible styles that the Node can have. The game iterates through each, looking for the first one that passes a check of the required game/character/account state in order to show that style, and then renders the node in that style.
     *
     * @return $this
     */
     ...
     * Gets activities
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeActivityDefinition[]|null
     */
     ...
     * Sets activities
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeActivityDefinition[]|null $activities The node may have various possible activities that could be active for it, however only one may be active at a time. See the DestinyActivityGraphNodeActivityDefinition for details.
     *
     * @return $this
     */
     ...
     * Gets states
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeStateEntry[]|null
     */
     ...
     * Sets states
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeStateEntry[]|null $states Represents possible states that the graph node can be in. These are combined with some checking that happens in the game client and server to determine which state is actually active at any given time.
     *
     * @return $this
     */
