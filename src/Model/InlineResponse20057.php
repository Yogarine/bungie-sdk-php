...
class InlineResponse20057 implements ModelInterface, ArrayAccess
{
     ...
     * Gets response
     *
     * @return map[string,\Bungie\Model\DestinyMilestonesDestinyPublicMilestone]
     */
     ...
     * Sets response
     *
     * @param map[string,\Bungie\Model\DestinyMilestonesDestinyPublicMilestone] $response response
     *
     * @return $this
     */
