...
class InlineResponse20052 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => 'map[string,\Bungie\Model\Destiny\HistoricalStats\DestinyHistoricalStatsByPeriod]',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Sets response
     *
     * @param map[string,\Bungie\Model\Destiny\HistoricalStats\DestinyHistoricalStatsByPeriod]|null $response response
     *
     * @return $this
     */
