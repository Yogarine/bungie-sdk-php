...
class InlineResponse2006 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\User\UserMembershipData',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\User\UserMembershipData|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\User\UserMembershipData|null $response response
     *
     * @return $this
     */
