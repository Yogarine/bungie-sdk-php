 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsItemsDestinyDerivedItemDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Items.DestinyDerivedItemDefinition';
     ...
     * Sets itemName
     *
     * @param string $itemName The name of the derived item.
     *
     * @return $this
     */
     ...
     * Sets itemDetail
     *
     * @param string $itemDetail Additional details about the derived item, in addition to the description.
     *
     * @return $this
     */
     ...
     *
     * @param string $itemDescription A brief description of the item.
     *
     * @return $this
     */
     ...
     * Sets iconPath
     *
     * @param string $iconPath An icon for the item.
     *
     * @return $this
     */
     ...
     *
     * @param int $vendorItemIndex If the item was derived from a \"Preview Vendor\", this will be an index into the DestinyVendorDefinition's itemList property. Otherwise, -1.
     *
     * @return $this
     */
