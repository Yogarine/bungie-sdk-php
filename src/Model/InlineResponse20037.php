...
class InlineResponse20037 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => 'map[string,\Bungie\Model\Tokens\BungieRewardDisplay]',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return map[string,\Bungie\Model\Tokens\BungieRewardDisplay]|null
     */
     ...
     * Sets response
     *
     * @param map[string,\Bungie\Model\Tokens\BungieRewardDisplay]|null $response response
     *
     * @return $this
     */
