...
class DestinyEntitiesItemsDestinyItemComponent implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'itemInstanceId' => 'int',
        'quantity' => 'int',
        'bindStatus' => 'DestinyItemBindStatus',
        'location' => 'DestinyItemLocation',
        'bucketHash' => 'int',
        'transferStatus' => 'DestinyTransferStatuses',
        'lockable' => 'bool',
        'state' => 'DestinyItemState',
     ...
     * Gets bindStatus
     *
     * @return DestinyItemBindStatus|null
     */
     ...
     * Sets bindStatus
     *
     * @param DestinyItemBindStatus|null $bindStatus If the item is bound to a location, it will be specified in this enum.
     *
     * @return $this
     */
     ...
     * Gets location
     *
     * @return DestinyItemLocation|null
     */
     ...
     * Sets location
     *
     * @param DestinyItemLocation|null $location An easy reference for where the item is located. Redundant if you got the item from an Inventory, but useful when making detail calls on specific items.
     *
     * @return $this
     */
     ...
     * Gets transferStatus
     *
     * @return DestinyTransferStatuses|null
     */
     ...
     * Sets transferStatus
     *
     * @param DestinyTransferStatuses|null $transferStatus If there is a known error state that would cause this item to not be transferable, this Flags enum will indicate all of those error states. Otherwise, it will be 0 (CanTransfer).
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param DestinyItemState|null $state A flags enumeration indicating the transient/custom states of the item that affect how it is rendered: whether it's tracked or locked for example, or whether it has a masterwork plug inserted.
     *
     * @return $this
     */
