...
class DestinyResponsesDestinyProfileResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets vendorReceipts
     *
     * @param SingleComponentResponseOfDestinyVendorReceiptsComponent|null $vendorReceipts Recent, refundable purchases you have made from vendors. When will you use it? Couldn't say...  COMPONENT TYPE: VendorReceipts
     *
     * @return $this
     */
     ...
     *
     * @param SingleComponentResponseOfDestinyInventoryComponent|null $profileInventory The profile-level inventory of the Destiny Profile.  COMPONENT TYPE: ProfileInventories
     *
     * @return $this
     */
     ...
     *
     * @param SingleComponentResponseOfDestinyInventoryComponent|null $profileCurrencies The profile-level currencies owned by the Destiny Profile.  COMPONENT TYPE: ProfileCurrencies
     *
     * @return $this
     */
     ...
     *
     * @param SingleComponentResponseOfDestinyProfileProgressionComponent|null $profileProgression When we have progression information - such as Checklists - that may apply profile-wide, it will be returned here rather than in the per-character progression data.  COMPONENT TYPE: ProfileProgression
     *
     * @return $this
     */
     ...
     *
     * @param SingleComponentResponseOfDestinyPresentationNodesComponent|null $profilePresentationNodes COMPONENT TYPE: PresentationNodes
     *
     * @return $this
     */
     ...
     * Sets profileRecords
     *
     * @param SingleComponentResponseOfDestinyProfileRecordsComponent|null $profileRecords COMPONENT TYPE: Records
     *
     * @return $this
     */
     ...
     *
     * @param SingleComponentResponseOfDestinyProfileCollectiblesComponent|null $profileCollectibles COMPONENT TYPE: Collectibles
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyInventoryComponent|null $characterInventories The character-level non-equipped inventory items, keyed by the Character's Id.  COMPONENT TYPE: CharacterInventories
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyCharacterProgressionComponent|null $characterProgressions Character-level progression data, keyed by the Character's Id.  COMPONENT TYPE: CharacterProgressions
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyCharacterRenderComponent|null $characterRenderData Character rendering data - a minimal set of info needed to render a character in 3D - keyed by the Character's Id.  COMPONENT TYPE: CharacterRenderData
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyCharacterActivitiesComponent|null $characterActivities Character activity data - the activities available to this character and its status, keyed by the Character's Id.  COMPONENT TYPE: CharacterActivities
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyInventoryComponent|null $characterEquipment The character's equipped items, keyed by the Character's Id.  COMPONENT TYPE: CharacterEquipment
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyPresentationNodesComponent|null $characterPresentationNodes COMPONENT TYPE: PresentationNodes
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyCharacterRecordsComponent|null $characterRecords COMPONENT TYPE: Records
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyCollectiblesComponent|null $characterCollectibles COMPONENT TYPE: Collectibles
     *
     * @return $this
     */
     ...
     * Sets itemComponents
     *
     * @param DestinyItemComponentSetOfint64|null $itemComponents Information about instanced items across all returned characters, keyed by the item's instance ID.  COMPONENT TYPE: [See inside the DestinyItemComponentSet contract for component types.]
     *
     * @return $this
     */
     ...
     *
     * @param DictionaryComponentResponseOfint64AndDestinyCurrenciesComponent|null $characterCurrencyLookups A \"lookup\" convenience component that can be used to quickly check if the character has access to items that can be used for purchasing.  COMPONENT TYPE: CurrencyLookups
     *
     * @return $this
     */
