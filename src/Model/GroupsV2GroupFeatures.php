...
class GroupsV2GroupFeatures implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'hostGuidedGamePermissionOverride' => 'GroupsV2HostGuidedGamesPermissionLevel',
        'updateBannerPermissionOverride' => 'bool',
        'joinLevel' => 'GroupsV2RuntimeGroupMemberType'
    ];
     ...
     * Sets maximumMembers
     *
     * @param int|null $maximumMembers maximumMembers
     *
     * @return $this
     */
     ...
     *
     * @param int|null $maximumMembershipsOfGroupType Maximum number of groups of this type a typical membership may join. For example, a user may join about 50 General groups with their Bungie.net account. They may join one clan per Destiny membership.
     *
     * @return $this
     */
     ...
     * Gets capabilities
     *
     * @return \Bungie\Model\GroupsV2Capabilities|null
     */
     ...
     * Sets capabilities
     *
     * @param \Bungie\Model\GroupsV2Capabilities|null $capabilities capabilities
     *
     * @return $this
     */
     ...
     *
     * @return GroupsV2HostGuidedGamesPermissionLevel|null
     */
     ...
     *
     * @param GroupsV2HostGuidedGamesPermissionLevel|null $hostGuidedGamePermissionOverride Minimum Member Level allowed to host guided games  Always Allowed: Founder, Acting Founder, Admin  Allowed Overrides: None, Member, Beginner  Default is Member for clans, None for groups, although this means nothing for groups.
     *
     * @return $this
     */
     ...
     * Gets joinLevel
     *
     * @return GroupsV2RuntimeGroupMemberType|null
     */
     ...
     * Sets joinLevel
     *
     * @param GroupsV2RuntimeGroupMemberType|null $joinLevel Level to join a member at when accepting an invite, application, or joining an open clan  Default is Beginner.
     *
     * @return $this
     */
