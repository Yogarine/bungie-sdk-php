...
class DestinyDefinitionsDestinyItemSourceBlockDefinition implements ModelInterface, ArrayAccess
{
     ...
     * Gets sources
     *
     * @return \Bungie\Model\DestinyDefinitionsSourcesDestinyItemSourceDefinition[]|null
     */
     ...
     * Sets sources
     *
     * @param \Bungie\Model\DestinyDefinitionsSourcesDestinyItemSourceDefinition[]|null $sources A collection of details about the stats that were computed for the ways we found that the item could be spawned.
     *
     * @return $this
     */
     ...
     * Sets exclusive
     *
     * @param BungieMembershipType|null $exclusive If we found that this item is exclusive to a specific platform, this will be set to the BungieMembershipType enumeration that matches that platform.
     *
     * @return $this
     */
