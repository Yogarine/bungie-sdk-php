...
class InlineResponse20066 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\SearchResultOfFireteamSummary',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\SearchResultOfFireteamSummary|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\SearchResultOfFireteamSummary|null $response response
     *
     * @return $this
     */
