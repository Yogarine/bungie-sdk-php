...
class InlineResponse20024 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\SearchResultOfGroupMember',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\SearchResultOfGroupMember|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\SearchResultOfGroupMember|null $response response
     *
     * @return $this
     */
