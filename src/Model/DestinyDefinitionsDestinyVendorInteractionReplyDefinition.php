...
class DestinyDefinitionsDestinyVendorInteractionReplyDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyVendorInteractionReplyDefinition';
     ...
     *
     * @param object $itemRewardsSelection The rewards granted upon responding to the vendor.
     *
     * @return $this
     */
     ...
     * Sets reply
     *
     * @param string $reply The localized text for the reply.
     *
     * @return $this
     */
     ...
     * Sets replyType
     *
     * @param object $replyType An enum indicating the type of reply being made.
     *
     * @return $this
     */
