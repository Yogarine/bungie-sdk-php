 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyComponentsItemsDestinyItemPlugComponent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Components.Items.DestinyItemPlugComponent';
     ...
     * Sets plugItemHash
     *
     * @param int $plugItemHash The hash identifier of the DestinyInventoryItemDefinition that represents this plug.
     *
     * @return $this
     */
     ...
     * Sets canInsert
     *
     * @param bool $canInsert If true, this plug has met all of its insertion requirements. Big if true.
     *
     * @return $this
     */
     ...
     * Sets enabled
     *
     * @param bool $enabled If true, this plug will provide its benefits while inserted.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $insertFailIndexes If the plug cannot be inserted for some reason, this will have the indexes into the plug item definition's plug.insertionRules property, so you can show the reasons why it can't be inserted.  This list will be empty if the plug can be inserted.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $enableFailIndexes If a plug is not enabled, this will be populated with indexes into the plug item definition's plug.enabledRules property, so that you can show the reasons why it is not enabled.  This list will be empty if the plug is enabled.
     *
     * @return $this
     */
