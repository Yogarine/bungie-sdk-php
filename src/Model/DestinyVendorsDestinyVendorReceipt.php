...
class DestinyVendorsDestinyVendorReceipt implements ModelInterface, ArrayAccess
{
     ...
     * Sets currencyPaid
     *
     * @param \Bungie\Model\DestinyDestinyItemQuantity[]|null $currencyPaid The amount paid for the item, in terms of items that were consumed in the purchase and their quantity.
     *
     * @return $this
     */
     ...
     * Sets itemReceived
     *
     * @param DestinyDestinyItemQuantity|null $itemReceived The item that was received, and its quantity.
     *
     * @return $this
     */
     ...
     * Sets refundPolicy
     *
     * @param DestinyDestinyVendorItemRefundPolicy|null $refundPolicy Whether you can get a refund, and what happens in order for the refund to be received. See the DestinyVendorItemRefundPolicy enum for details.
     *
     * @return $this
     */
