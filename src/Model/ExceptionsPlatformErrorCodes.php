...
class ExceptionsPlatformErrorCodes
{
    ...
    const DESTINYCHARACTERNOTINTOWER = 1634;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::NONE,
            self::SUCCESS,
            self::TRANSPORTEXCEPTION,
            self::UNHANDLEDEXCEPTION,
            self::NOTIMPLEMENTED,
            self::SYSTEMDISABLED,
            self::FAILEDTOLOADAVAILABLELOCALESCONFIGURATION,
            self::PARAMETERPARSEFAILURE,
            self::PARAMETERINVALIDRANGE,
            self::BADREQUEST,
            self::AUTHENTICATIONINVALID,
            self::DATANOTFOUND,
            self::INSUFFICIENTPRIVILEGES,
            self::DUPLICATE,
            self::UNKNOWNSQLRESULT,
            self::VALIDATIONERROR,
            self::VALIDATIONMISSINGFIELDERROR,
            self::VALIDATIONINVALIDINPUTERROR,
            self::INVALIDPARAMETERS,
            self::PARAMETERNOTFOUND,
            self::UNHANDLEDHTTPEXCEPTION,
            self::NOTFOUND,
            self::WEBAUTHMODULEASYNCFAILED,
            self::INVALIDRETURNVALUE,
            self::USERBANNED,
            self::INVALIDPOSTBODY,
            self::MISSINGPOSTBODY,
            self::EXTERNALSERVICETIMEOUT,
            self::VALIDATIONLENGTHERROR,
            self::VALIDATIONRANGEERROR,
            self::JSONDESERIALIZATIONERROR,
            self::THROTTLELIMITEXCEEDED,
            self::VALIDATIONTAGERROR,
            self::VALIDATIONPROFANITYERROR,
            self::VALIDATIONURLFORMATERROR,
            self::THROTTLELIMITEXCEEDEDMINUTES,
            self::THROTTLELIMITEXCEEDEDMOMENTARILY,
            self::THROTTLELIMITEXCEEDEDSECONDS,
            self::EXTERNALSERVICEUNKNOWN,
            self::VALIDATIONWORDLENGTHERROR,
            self::VALIDATIONINVISIBLEUNICODE,
            self::VALIDATIONBADNAMES,
            self::EXTERNALSERVICEFAILED,
            self::SERVICERETIRED,
            self::UNKNOWNSQLEXCEPTION,
            self::UNSUPPORTEDLOCALE,
            self::INVALIDPAGENUMBER,
            self::MAXIMUMPAGESIZEEXCEEDED,
            self::SERVICEUNSUPPORTED,
            self::VALIDATIONMAXIMUMUNICODECOMBININGCHARACTERS,
            self::VALIDATIONMAXIMUMSEQUENTIALCARRIAGERETURNS,
            self::PERENDPOINTREQUESTTHROTTLEEXCEEDED,
            self::AUTHCONTEXTCACHEASSERTION,
            self::EXPLATFORMSTRINGVALIDATIONERROR,
            self::OBSOLETECREDENTIALTYPE,
            self::UNABLETOUNPAIRMOBILEAPP,
            self::UNABLETOPAIRMOBILEAPP,
            self::CANNOTUSEMOBILEAUTHWITHNONMOBILEPROVIDER,
            self::MISSINGDEVICECOOKIE,
            self::FACEBOOKTOKENEXPIRED,
            self::AUTHTICKETREQUIRED,
            self::COOKIECONTEXTREQUIRED,
            self::UNKNOWNAUTHENTICATIONERROR,
            self::BUNGIENETACCOUNTCREATIONREQUIRED,
            self::WEBAUTHREQUIRED,
            self::CONTENTUNKNOWNSQLRESULT,
            self::CONTENTNEEDUNIQUEPATH,
            self::CONTENTSQLEXCEPTION,
            self::CONTENTNOTFOUND,
            self::CONTENTSUCCESSWITHTAGADDFAIL,
            self::CONTENTSEARCHMISSINGPARAMETERS,
            self::CONTENTINVALIDID,
            self::CONTENTPHYSICALFILEDELETIONERROR,
            self::CONTENTPHYSICALFILECREATIONERROR,
            self::CONTENTPERFORCESUBMISSIONERROR,
            self::CONTENTPERFORCEINITIALIZATIONERROR,
            self::CONTENTDEPLOYMENTPACKAGENOTREADYERROR,
            self::CONTENTUPLOADFAILED,
            self::CONTENTTOOMANYRESULTS,
            self::CONTENTINVALIDSTATE,
            self::CONTENTNAVIGATIONPARENTNOTFOUND,
            self::CONTENTNAVIGATIONPARENTUPDATEERROR,
            self::DEPLOYMENTPACKAGENOTEDITABLE,
            self::CONTENTVALIDATIONERROR,
            self::CONTENTPROPERTIESVALIDATIONERROR,
            self::CONTENTTYPENOTFOUND,
            self::DEPLOYMENTPACKAGENOTFOUND,
            self::CONTENTSEARCHINVALIDPARAMETERS,
            self::CONTENTITEMPROPERTYAGGREGATIONERROR,
            self::DEPLOYMENTPACKAGEFILENOTFOUND,
            self::CONTENTPERFORCEFILEHISTORYNOTFOUND,
            self::CONTENTASSETZIPCREATIONFAILURE,
            self::CONTENTASSETZIPCREATIONBUSY,
            self::CONTENTPROJECTNOTFOUND,
            self::CONTENTFOLDERNOTFOUND,
            self::CONTENTPACKAGESINCONSISTENT,
            self::CONTENTPACKAGESINVALIDSTATE,
            self::CONTENTPACKAGESINCONSISTENTTYPE,
            self::CONTENTCANNOTDELETEPACKAGE,
            self::CONTENTLOCKEDFORCHANGES,
            self::CONTENTFILEUPLOADFAILED,
            self::CONTENTNOTREVIEWED,
            self::CONTENTPERMISSIONDENIED,
            self::CONTENTINVALIDEXTERNALURL,
            self::CONTENTEXTERNALFILECANNOTBEIMPORTEDLOCALLY,
            self::CONTENTTAGSAVEFAILURE,
            self::CONTENTPERFORCEUNMATCHEDFILEERROR,
            self::CONTENTPERFORCECHANGELISTRESULTNOTFOUND,
            self::CONTENTPERFORCECHANGELISTFILEITEMSNOTFOUND,
            self::CONTENTPERFORCEINVALIDREVISIONERROR,
            self::CONTENTUNLOADEDSAVERESULT,
            self::CONTENTPROPERTYINVALIDNUMBER,
            self::CONTENTPROPERTYINVALIDURL,
            self::CONTENTPROPERTYINVALIDDATE,
            self::CONTENTPROPERTYINVALIDSET,
            self::CONTENTPROPERTYCANNOTDESERIALIZE,
            self::CONTENTREGEXVALIDATIONFAILONPROPERTY,
            self::CONTENTMAXLENGTHFAILONPROPERTY,
            self::CONTENTPROPERTYUNEXPECTEDDESERIALIZATIONERROR,
            self::CONTENTPROPERTYREQUIRED,
            self::CONTENTCANNOTCREATEFILE,
            self::CONTENTINVALIDMIGRATIONFILE,
            self::CONTENTMIGRATIONALTERINGPROCESSEDITEM,
            self::CONTENTPROPERTYDEFINITIONNOTFOUND,
            self::CONTENTREVIEWDATACHANGED,
            self::CONTENTROLLBACKREVISIONNOTINPACKAGE,
            self::CONTENTITEMNOTBASEDONLATESTREVISION,
            self::CONTENTUNAUTHORIZED,
            self::CONTENTCANNOTCREATEDEPLOYMENTPACKAGE,
            self::CONTENTUSERNOTFOUND,
            self::CONTENTLOCALEPERMISSIONDENIED,
            self::CONTENTINVALIDLINKTOINTERNALENVIRONMENT,
            self::CONTENTINVALIDBLACKLISTEDCONTENT,
            self::CONTENTMACROMALFORMEDNOCONTENTID,
            self::CONTENTMACROMALFORMEDNOTEMPLATETYPE,
            self::CONTENTILLEGALBNETMEMBERSHIPID,
            self::CONTENTLOCALEDIDNOTMATCHEXPECTED,
            self::CONTENTBABELCALLFAILED,
            self::CONTENTENGLISHPOSTLIVEFORBIDDEN,
            self::CONTENTLOCALEEDITPERMISSIONDENIED,
            self::USERNONUNIQUENAME,
            self::USERMANUALLINKINGSTEPREQUIRED,
            self::USERCREATEUNKNOWNSQLRESULT,
            self::USERCREATEUNKNOWNSQLEXCEPTION,
            self::USERMALFORMEDMEMBERSHIPID,
            self::USERCANNOTFINDREQUESTEDUSER,
            self::USERCANNOTLOADACCOUNTCREDENTIALLINKINFO,
            self::USERINVALIDMOBILEAPPTYPE,
            self::USERMISSINGMOBILEPAIRINGINFO,
            self::USERCANNOTGENERATEMOBILEKEYWHILEUSINGMOBILECREDENTIAL,
            self::USERGENERATEMOBILEKEYEXISTINGSLOTCOLLISION,
            self::USERDISPLAYNAMEMISSINGORINVALID,
            self::USERCANNOTLOADACCOUNTPROFILEDATA,
            self::USERCANNOTSAVEUSERPROFILEDATA,
            self::USEREMAILMISSINGORINVALID,
            self::USERTERMSOFUSEREQUIRED,
            self::USERCANNOTCREATENEWACCOUNTWHILELOGGEDIN,
            self::USERCANNOTRESOLVECENTRALACCOUNT,
            self::USERINVALIDAVATAR,
            self::USERMISSINGCREATEDUSERRESULT,
            self::USERCANNOTCHANGEUNIQUENAMEYET,
            self::USERCANNOTCHANGEDISPLAYNAMEYET,
            self::USERCANNOTCHANGEEMAIL,
            self::USERUNIQUENAMEMUSTSTARTWITHLETTER,
            self::USERNOLINKEDACCOUNTSSUPPORTFRIENDLISTINGS,
            self::USERACKNOWLEDGMENTTABLEFULL,
            self::USERCREATIONDESTINYMEMBERSHIPREQUIRED,
            self::USERFRIENDSTOKENNEEDSREFRESH,
            self::MESSAGINGUNKNOWNERROR,
            self::MESSAGINGSELFERROR,
            self::MESSAGINGSENDTHROTTLE,
            self::MESSAGINGNOBODY,
            self::MESSAGINGTOOMANYUSERS,
            self::MESSAGINGCANNOTLEAVECONVERSATION,
            self::MESSAGINGUNABLETOSEND,
            self::MESSAGINGDELETEDUSERFORBIDDEN,
            self::MESSAGINGCANNOTDELETEEXTERNALCONVERSATION,
            self::MESSAGINGGROUPCHATDISABLED,
            self::MESSAGINGMUSTINCLUDESELFINPRIVATEMESSAGE,
            self::MESSAGINGSENDERISBANNED,
            self::MESSAGINGGROUPOPTIONALCHATEXCEEDEDMAXIMUM,
            self::PRIVATEMESSAGINGREQUIRESDESTINYMEMBERSHIP,
            self::ADDSURVEYANSWERSUNKNOWNSQLEXCEPTION,
            self::FORUMBODYCANNOTBEEMPTY,
            self::FORUMSUBJECTCANNOTBEEMPTYONTOPICPOST,
            self::FORUMCANNOTLOCATEPARENTPOST,
            self::FORUMTHREADLOCKEDFORREPLIES,
            self::FORUMUNKNOWNSQLRESULTDURINGCREATEPOST,
            self::FORUMUNKNOWNTAGCREATIONERROR,
            self::FORUMUNKNOWNSQLRESULTDURINGTAGITEM,
            self::FORUMUNKNOWNEXCEPTIONCREATEPOST,
            self::FORUMQUESTIONMUSTBETOPICPOST,
            self::FORUMEXCEPTIONDURINGTAGSEARCH,
            self::FORUMEXCEPTIONDURINGTOPICRETRIEVAL,
            self::FORUMALIASEDTAGERROR,
            self::FORUMCANNOTLOCATETHREAD,
            self::FORUMUNKNOWNEXCEPTIONEDITPOST,
            self::FORUMCANNOTLOCATEPOST,
            self::FORUMUNKNOWNEXCEPTIONGETORCREATETAGS,
            self::FORUMEDITPERMISSIONDENIED,
            self::FORUMUNKNOWNSQLRESULTDURINGTAGIDRETRIEVAL,
            self::FORUMCANNOTGETRATING,
            self::FORUMUNKNOWNEXCEPTIONGETRATING,
            self::FORUMRATINGSACCESSERROR,
            self::FORUMRELATEDPOSTACCESSERROR,
            self::FORUMLATESTREPLYACCESSERROR,
            self::FORUMUSERSTATUSACCESSERROR,
            self::FORUMAUTHORACCESSERROR,
            self::FORUMGROUPACCESSERROR,
            self::FORUMURLEXPECTEDBUTMISSING,
            self::FORUMREPLIESCANNOTBEEMPTY,
            self::FORUMREPLIESCANNOTBEINDIFFERENTGROUPS,
            self::FORUMSUBTOPICCANNOTBECREATEDATTHISTHREADLEVEL,
            self::FORUMCANNOTCREATECONTENTTOPIC,
            self::FORUMTOPICDOESNOTEXIST,
            self::FORUMCONTENTCOMMENTSNOTALLOWED,
            self::FORUMUNKNOWNSQLRESULTDURINGEDITPOST,
            self::FORUMUNKNOWNSQLRESULTDURINGGETPOST,
            self::FORUMPOSTVALIDATIONBADURL,
            self::FORUMBODYTOOLONG,
            self::FORUMSUBJECTTOOLONG,
            self::FORUMANNOUNCEMENTNOTALLOWED,
            self::FORUMCANNOTSHAREOWNPOST,
            self::FORUMEDITNOOP,
            self::FORUMUNKNOWNDATABASEERRORDURINGGETPOST,
            self::FORUMEXCEEEDMAXIMUMROWLIMIT,
            self::FORUMCANNOTSHAREPRIVATEPOST,
            self::FORUMCANNOTCROSSPOSTBETWEENGROUPS,
            self::FORUMINCOMPATIBLECATEGORIES,
            self::FORUMCANNOTUSETHESECATEGORIESONNONTOPICPOST,
            self::FORUMCANONLYDELETETOPICS,
            self::FORUMDELETESQLEXCEPTION,
            self::FORUMDELETESQLUNKNOWNRESULT,
            self::FORUMTOOMANYTAGS,
            self::FORUMCANONLYRATETOPICS,
            self::FORUMBANNEDPOSTSCANNOTBEEDITED,
            self::FORUMTHREADROOTISBANNED,
            self::FORUMCANNOTUSEOFFICIALTAGCATEGORYASTAG,
            self::FORUMANSWERCANNOTBEMADEONCREATEPOST,
            self::FORUMANSWERCANNOTBEMADEONEDITPOST,
            self::FORUMANSWERPOSTIDISNOTADIRECTREPLYOFQUESTION,
            self::FORUMANSWERTOPICIDISNOTAQUESTION,
            self::FORUMUNKNOWNEXCEPTIONDURINGMARKANSWER,
            self::FORUMUNKNOWNSQLRESULTDURINGMARKANSWER,
            self::FORUMCANNOTRATEYOUROWNPOSTS,
            self::FORUMPOLLSMUSTBETHEFIRSTPOSTINTOPIC,
            self::FORUMINVALIDPOLLINPUT,
            self::FORUMGROUPADMINEDITNONMEMBER,
            self::FORUMCANNOTEDITMODERATOREDITEDPOST,
            self::FORUMREQUIRESDESTINYMEMBERSHIP,
            self::FORUMUNEXPECTEDERROR,
            self::FORUMAGELOCK,
            self::FORUMMAXPAGES,
            self::FORUMMAXPAGESOLDESTFIRST,
            self::FORUMCANNOTAPPLYFORUMIDWITHOUTTAGS,
            self::FORUMCANNOTAPPLYFORUMIDTONONTOPICS,
            self::FORUMCANNOTDOWNVOTECOMMUNITYCREATIONS,
            self::FORUMTOPICSMUSTHAVEOFFICIALCATEGORY,
            self::FORUMRECRUITMENTTOPICMALFORMED,
            self::FORUMRECRUITMENTTOPICNOTFOUND,
            self::FORUMRECRUITMENTTOPICNOSLOTSREMAINING,
            self::FORUMRECRUITMENTTOPICKICKBAN,
            self::FORUMRECRUITMENTTOPICREQUIREMENTSNOTMET,
            self::FORUMRECRUITMENTTOPICNOPLAYERS,
            self::FORUMRECRUITMENTAPPROVEFAILMESSAGEBAN,
            self::FORUMRECRUITMENTGLOBALBAN,
            self::FORUMUSERBANNEDFROMTHISTOPIC,
            self::FORUMRECRUITMENTFIRETEAMMEMBERSONLY,
            self::FORUMREQUIRESDESTINY2PROGRESS,
            self::GROUPMEMBERSHIPAPPLICATIONALREADYRESOLVED,
            self::GROUPMEMBERSHIPALREADYAPPLIED,
            self::GROUPMEMBERSHIPINSUFFICIENTPRIVILEGES,
            self::GROUPIDNOTRETURNEDFROMCREATION,
            self::GROUPSEARCHINVALIDPARAMETERS,
            self::GROUPMEMBERSHIPPENDINGAPPLICATIONNOTFOUND,
            self::GROUPINVALIDID,
            self::GROUPINVALIDMEMBERSHIPID,
            self::GROUPINVALIDMEMBERSHIPTYPE,
            self::GROUPMISSINGTAGS,
            self::GROUPMEMBERSHIPNOTFOUND,
            self::GROUPINVALIDRATING,
            self::GROUPUSERFOLLOWINGACCESSERROR,
            self::GROUPUSERMEMBERSHIPACCESSERROR,
            self::GROUPCREATORACCESSERROR,
            self::GROUPADMINACCESSERROR,
            self::GROUPPRIVATEPOSTNOTVIEWABLE,
            self::GROUPMEMBERSHIPNOTLOGGEDIN,
            self::GROUPNOTDELETED,
            self::GROUPUNKNOWNERRORUNDELETINGGROUP,
            self::GROUPDELETED,
            self::GROUPNOTFOUND,
            self::GROUPMEMBERBANNED,
            self::GROUPMEMBERSHIPCLOSED,
            self::GROUPPRIVATEPOSTOVERRIDEERROR,
            self::GROUPNAMETAKEN,
            self::GROUPDELETIONGRACEPERIODEXPIRED,
            self::GROUPCANNOTCHECKBANSTATUS,
            self::GROUPMAXIMUMMEMBERSHIPCOUNTREACHED,
            self::NODESTINYACCOUNTFORCLANPLATFORM,
            self::ALREADYREQUESTINGMEMBERSHIPFORCLANPLATFORM,
            self::ALREADYCLANMEMBERONPLATFORM,
            self::GROUPJOINEDCANNOTSETCLANNAME,
            self::GROUPLEFTCANNOTCLEARCLANNAME,
            self::GROUPRELATIONSHIPREQUESTPENDING,
            self::GROUPRELATIONSHIPREQUESTBLOCKED,
            self::GROUPRELATIONSHIPREQUESTNOTFOUND,
            self::GROUPRELATIONSHIPBLOCKNOTFOUND,
            self::GROUPRELATIONSHIPNOTFOUND,
            self::GROUPALREADYALLIED,
            self::GROUPALREADYMEMBER,
            self::GROUPRELATIONSHIPALREADYEXISTS,
            self::INVALIDGROUPTYPESFORRELATIONSHIPREQUEST,
            self::GROUPATMAXIMUMALLIANCES,
            self::GROUPCANNOTSETCLANONLYSETTINGS,
            self::CLANCANNOTSETTWODEFAULTPOSTTYPES,
            self::GROUPMEMBERINVALIDMEMBERTYPE,
            self::GROUPINVALIDPLATFORMTYPE,
            self::GROUPMEMBERINVALIDSORT,
            self::GROUPINVALIDRESOLVESTATE,
            self::CLANALREADYENABLEDFORPLATFORM,
            self::CLANNOTENABLEDFORPLATFORM,
            self::CLANENABLEDBUTCOULDNOTJOINNOACCOUNT,
            self::CLANENABLEDBUTCOULDNOTJOINALREADYMEMBER,
            self::CLANCANNOTJOINNOCREDENTIAL,
            self::NOCLANMEMBERSHIPFORPLATFORM,
            self::GROUPTOGROUPFOLLOWLIMITREACHED,
            self::CHILDGROUPALREADYINALLIANCE,
            self::OWNERGROUPALREADYINALLIANCE,
            self::ALLIANCEOWNERCANNOTJOINALLIANCE,
            self::GROUPNOTINALLIANCE,
            self::CHILDGROUPCANNOTINVITETOALLIANCE,
            self::GROUPTOGROUPALREADYFOLLOWED,
            self::GROUPTOGROUPNOTFOLLOWING,
            self::CLANMAXIMUMMEMBERSHIPREACHED,
            self::CLANNAMENOTVALID,
            self::CLANNAMENOTVALIDERROR,
            self::ALLIANCEOWNERNOTDEFINED,
            self::ALLIANCECHILDNOTDEFINED,
            self::CLANCULTUREILLEGALCHARACTERS,
            self::CLANTAGILLEGALCHARACTERS,
            self::CLANREQUIRESINVITATION,
            self::CLANMEMBERSHIPCLOSED,
            self::CLANINVITEALREADYMEMBER,
            self::GROUPINVITEALREADYMEMBER,
            self::GROUPJOINAPPROVALREQUIRED,
            self::CLANTAGREQUIRED,
            self::GROUPNAMECANNOTSTARTORENDWITHWHITESPACE,
            self::CLANCALLSIGNCANNOTSTARTORENDWITHWHITESPACE,
            self::CLANMIGRATIONFAILED,
            self::CLANNOTENABLEDALREADYMEMBEROFANOTHERCLAN,
            self::GROUPMODERATIONNOTPERMITTEDONNONMEMBERS,
            self::CLANCREATIONINWORLDSERVERFAILED,
            self::CLANNOTFOUND,
            self::CLANMEMBERSHIPLEVELDOESNOTPERMITTHATACTION,
            self::CLANMEMBERNOTFOUND,
            self::CLANMISSINGMEMBERSHIPAPPROVERS,
            self::CLANINWRONGSTATEFORREQUESTEDACTION,
            self::CLANNAMEALREADYUSED,
            self::CLANTOOFEWMEMBERS,
            self::CLANINFOCANNOTBEWHITESPACE,
            self::GROUPCULTURETHROTTLE,
            self::CLANTARGETDISALLOWSINVITES,
            self::CLANINVALIDOPERATION,
            self::CLANFOUNDERCANNOTLEAVEWITHOUTABDICATION,
            self::CLANNAMERESERVED,
            self::CLANAPPLICANTINCLANSONOWINVITED,
            self::ACTIVITIESUNKNOWNEXCEPTION,
            self::ACTIVITIESPARAMETERNULL,
            self::ACTIVITYCOUNTSDIABLED,
            self::ACTIVITYSEARCHINVALIDPARAMETERS,
            self::ACTIVITYPERMISSIONDENIED,
            self::SHAREALREADYSHARED,
            self::ACTIVITYLOGGINGDISABLED,
            self::CLANREQUIRESEXISTINGDESTINYACCOUNT,
            self::ITEMALREADYFOLLOWED,
            self::ITEMNOTFOLLOWED,
            self::CANNOTFOLLOWSELF,
            self::GROUPFOLLOWLIMITEXCEEDED,
            self::TAGFOLLOWLIMITEXCEEDED,
            self::USERFOLLOWLIMITEXCEEDED,
            self::FOLLOWUNSUPPORTEDENTITYTYPE,
            self::NOVALIDTAGSINLIST,
            self::BELOWMINIMUMSUGGESTIONLENGTH,
            self::CANNOTGETSUGGESTIONSONMULTIPLETAGSSIMULTANEOUSLY,
            self::NOTAVALIDPARTIALTAG,
            self::TAGSUGGESTIONSUNKNOWNSQLRESULT,
            self::TAGSUNABLETOLOADPOPULARTAGSFROMDATABASE,
            self::TAGINVALID,
            self::TAGNOTFOUND,
            self::SINGLETAGEXPECTED,
            self::TAGSEXCEEDEDMAXIMUMPERITEM,
            self::IGNOREINVALIDPARAMETERS,
            self::IGNORESQLEXCEPTION,
            self::IGNOREERRORRETRIEVINGGROUPPERMISSIONS,
            self::IGNOREERRORINSUFFICIENTPERMISSION,
            self::IGNOREERRORRETRIEVINGITEM,
            self::IGNORECANNOTIGNORESELF,
            self::IGNOREILLEGALTYPE,
            self::IGNORENOTFOUND,
            self::IGNOREUSERGLOBALLYIGNORED,
            self::IGNOREUSERIGNORED,
            self::NOTIFICATIONSETTINGINVALID,
            self::PSNAPIEXPIREDACCESSTOKEN,
            self::PSNEXFORBIDDEN,
            self::PSNEXSYSTEMDISABLED,
            self::PSNAPIERRORCODEUNKNOWN,
            self::PSNAPIERRORWEBEXCEPTION,
            self::PSNAPIBADREQUEST,
            self::PSNAPIACCESSTOKENREQUIRED,
            self::PSNAPIINVALIDACCESSTOKEN,
            self::PSNAPIBANNEDUSER,
            self::PSNAPIACCOUNTUPGRADEREQUIRED,
            self::PSNAPISERVICETEMPORARILYUNAVAILABLE,
            self::PSNAPISERVERBUSY,
            self::PSNAPIUNDERMAINTENANCE,
            self::PSNAPIPROFILEUSERNOTFOUND,
            self::PSNAPIPROFILEPRIVACYRESTRICTION,
            self::PSNAPIPROFILEUNDERMAINTENANCE,
            self::PSNAPIACCOUNTATTRIBUTEMISSING,
            self::PSNAPINOPERMISSION,
            self::PSNAPITARGETUSERBLOCKED,
            self::XBLEXSYSTEMDISABLED,
            self::XBLEXUNKNOWNERROR,
            self::XBLAPIERRORWEBEXCEPTION,
            self::XBLSTSTOKENINVALID,
            self::XBLSTSMISSINGTOKEN,
            self::XBLSTSEXPIREDTOKEN,
            self::XBLACCESSTOTHESANDBOXDENIED,
            self::XBLMSARESPONSEMISSING,
            self::XBLMSAACCESSTOKENEXPIRED,
            self::XBLMSAINVALIDREQUEST,
            self::XBLMSAFRIENDSREQUIRESIGNIN,
            self::XBLUSERACTIONREQUIRED,
            self::XBLPARENTALCONTROLS,
            self::XBLDEVELOPERACCOUNT,
            self::XBLUSERTOKENEXPIRED,
            self::XBLUSERTOKENINVALID,
            self::XBLOFFLINE,
            self::XBLUNKNOWNERRORCODE,
            self::XBLMSAINVALIDGRANT,
            self::REPORTNOTYETRESOLVED,
            self::REPORTOVERTURNDOESNOTCHANGEDECISION,
            self::REPORTNOTFOUND,
            self::REPORTALREADYREPORTED,
            self::REPORTINVALIDRESOLUTION,
            self::REPORTNOTASSIGNEDTOYOU,
            self::LEGACYGAMESTATSSYSTEMDISABLED,
            self::LEGACYGAMESTATSUNKNOWNERROR,
            self::LEGACYGAMESTATSMALFORMEDSNEAKERNETCODE,
            self::DESTINYACCOUNTACQUISITIONFAILURE,
            self::DESTINYACCOUNTNOTFOUND,
            self::DESTINYBUILDSTATSDATABASEERROR,
            self::DESTINYCHARACTERSTATSDATABASEERROR,
            self::DESTINYPVPSTATSDATABASEERROR,
            self::DESTINYPVESTATSDATABASEERROR,
            self::DESTINYGRIMOIRESTATSDATABASEERROR,
            self::DESTINYSTATSPARAMETERMEMBERSHIPTYPEPARSEERROR,
            self::DESTINYSTATSPARAMETERMEMBERSHIPIDPARSEERROR,
            self::DESTINYSTATSPARAMETERRANGEPARSEERROR,
            self::DESTINYSTRINGITEMHASHNOTFOUND,
            self::DESTINYSTRINGSETNOTFOUND,
            self::DESTINYCONTENTLOOKUPNOTFOUNDFORKEY,
            self::DESTINYCONTENTITEMNOTFOUND,
            self::DESTINYCONTENTSECTIONNOTFOUND,
            self::DESTINYCONTENTPROPERTYNOTFOUND,
            self::DESTINYCONTENTCONFIGNOTFOUND,
            self::DESTINYCONTENTPROPERTYBUCKETVALUENOTFOUND,
            self::DESTINYUNEXPECTEDERROR,
            self::DESTINYINVALIDACTION,
            self::DESTINYCHARACTERNOTFOUND,
            self::DESTINYINVALIDFLAG,
            self::DESTINYINVALIDREQUEST,
            self::DESTINYITEMNOTFOUND,
            self::DESTINYINVALIDCUSTOMIZATIONCHOICES,
            self::DESTINYVENDORITEMNOTFOUND,
            self::DESTINYINTERNALERROR,
            self::DESTINYVENDORNOTFOUND,
            self::DESTINYRECENTACTIVITIESDATABASEERROR,
            self::DESTINYITEMBUCKETNOTFOUND,
            self::DESTINYINVALIDMEMBERSHIPTYPE,
            self::DESTINYVERSIONINCOMPATIBILITY,
            self::DESTINYITEMALREADYININVENTORY,
            self::DESTINYBUCKETNOTFOUND,
            self::DESTINYCHARACTERNOTINTOWER,
            self::DESTINYCHARACTERNOTLOGGEDIN,
            self::DESTINYDEFINITIONSNOTLOADED,
            self::DESTINYINVENTORYFULL,
            self::DESTINYITEMFAILEDLEVELCHECK,
            self::DESTINYITEMFAILEDUNLOCKCHECK,
            self::DESTINYITEMUNEQUIPPABLE,
            self::DESTINYITEMUNIQUEEQUIPRESTRICTED,
            self::DESTINYNOROOMINDESTINATION,
            self::DESTINYSERVICEFAILURE,
            self::DESTINYSERVICERETIRED,
            self::DESTINYTRANSFERFAILED,
            self::DESTINYTRANSFERNOTFOUNDFORSOURCEBUCKET,
            self::DESTINYUNEXPECTEDRESULTINVENDORTRANSFERCHECK,
            self::DESTINYUNIQUENESSVIOLATION,
            self::DESTINYERRORDESERIALIZATIONFAILURE,
            self::DESTINYVALIDACCOUNTTICKETREQUIRED,
            self::DESTINYSHARDRELAYCLIENTTIMEOUT,
            self::DESTINYSHARDRELAYPROXYTIMEOUT,
            self::DESTINYPGCRNOTFOUND,
            self::DESTINYACCOUNTMUSTBEOFFLINE,
            self::DESTINYCANONLYEQUIPINGAME,
            self::DESTINYCANNOTPERFORMACTIONONEQUIPPEDITEM,
            self::DESTINYQUESTALREADYCOMPLETED,
            self::DESTINYQUESTALREADYTRACKED,
            self::DESTINYTRACKABLEQUESTSFULL,
            self::DESTINYITEMNOTTRANSFERRABLE,
            self::DESTINYVENDORPURCHASENOTALLOWED,
            self::DESTINYCONTENTVERSIONMISMATCH,
            self::DESTINYITEMACTIONFORBIDDEN,
            self::DESTINYREFUNDINVALID,
            self::DESTINYPRIVACYRESTRICTION,
            self::DESTINYACTIONINSUFFICIENTPRIVILEGES,
            self::DESTINYINVALIDCLAIMEXCEPTION,
            self::DESTINYLEGACYPLATFORMRESTRICTED,
            self::DESTINYLEGACYPLATFORMINUSE,
            self::DESTINYLEGACYPLATFORMINACCESSIBLE,
            self::DESTINYCANNOTPERFORMACTIONATTHISLOCATION,
            self::DESTINYTHROTTLEDBYGAMESERVER,
            self::DESTINYITEMNOTTRANSFERRABLEHASSIDEEFFECTS,
            self::DESTINYITEMLOCKED,
            self::DESTINYCANNOTAFFORDMATERIALREQUIREMENTS,
            self::DESTINYFAILEDPLUGINSERTIONRULES,
            self::DESTINYSOCKETNOTFOUND,
            self::DESTINYSOCKETACTIONNOTALLOWED,
            self::DESTINYSOCKETALREADYHASPLUG,
            self::DESTINYPLUGITEMNOTAVAILABLE,
            self::DESTINYCHARACTERLOGGEDINNOTALLOWED,
            self::DESTINYPUBLICACCOUNTNOTACCESSIBLE,
            self::FBINVALIDREQUEST,
            self::FBREDIRECTMISMATCH,
            self::FBACCESSDENIED,
            self::FBUNSUPPORTEDRESPONSETYPE,
            self::FBINVALIDSCOPE,
            self::FBUNSUPPORTEDGRANTTYPE,
            self::FBINVALIDGRANT,
            self::INVITATIONEXPIRED,
            self::INVITATIONUNKNOWNTYPE,
            self::INVITATIONINVALIDRESPONSESTATUS,
            self::INVITATIONINVALIDTYPE,
            self::INVITATIONALREADYPENDING,
            self::INVITATIONINSUFFICIENTPERMISSION,
            self::INVITATIONINVALIDCODE,
            self::INVITATIONINVALIDTARGETSTATE,
            self::INVITATIONCANNOTBEREACTIVATED,
            self::INVITATIONNORECIPIENTS,
            self::INVITATIONGROUPCANNOTSENDTOSELF,
            self::INVITATIONTOOMANYRECIPIENTS,
            self::INVITATIONINVALID,
            self::INVITATIONNOTFOUND,
            self::TOKENINVALID,
            self::TOKENBADFORMAT,
            self::TOKENALREADYCLAIMED,
            self::TOKENALREADYCLAIMEDSELF,
            self::TOKENTHROTTLING,
            self::TOKENUNKNOWNREDEMPTIONFAILURE,
            self::TOKENPURCHASECLAIMFAILEDAFTERTOKENCLAIMED,
            self::TOKENUSERALREADYOWNSOFFER,
            self::TOKENINVALIDOFFERKEY,
            self::TOKENEMAILNOTVALIDATED,
            self::TOKENPROVISIONINGBADVENDOROROFFER,
            self::TOKENPURCHASEHISTORYUNKNOWNERROR,
            self::TOKENTHROTTLESTATEUNKNOWNERROR,
            self::TOKENUSERAGENOTVERIFIED,
            self::TOKENEXCEEDEDOFFERMAXIMUM,
            self::TOKENNOAVAILABLEUNLOCKS,
            self::TOKENMARKETPLACEINVALIDPLATFORM,
            self::TOKENNOMARKETPLACECODESFOUND,
            self::TOKENOFFERNOTAVAILABLEFORREDEMPTION,
            self::TOKENUNLOCKPARTIALFAILURE,
            self::TOKENMARKETPLACEINVALIDREGION,
            self::TOKENOFFEREXPIRED,
            self::RAFEXCEEDEDMAXIMUMREFERRALS,
            self::RAFDUPLICATEBOND,
            self::RAFNOVALIDVETERANDESTINYMEMBERSHIPSFOUND,
            self::RAFNOTAVALIDVETERANUSER,
            self::RAFCODEALREADYCLAIMEDORNOTFOUND,
            self::RAFMISMATCHEDDESTINYMEMBERSHIPTYPE,
            self::RAFUNABLETOACCESSPURCHASEHISTORY,
            self::RAFUNABLETOCREATEBOND,
            self::RAFUNABLETOFINDBOND,
            self::RAFUNABLETOREMOVEBOND,
            self::RAFCANNOTBONDTOSELF,
            self::RAFINVALIDPLATFORM,
            self::RAFGENERATETHROTTLED,
            self::RAFUNABLETOCREATEBONDVERSIONMISMATCH,
            self::RAFUNABLETOREMOVEBONDVERSIONMISMATCH,
            self::RAFREDEEMTHROTTLED,
            self::NOAVAILABLEDISCOUNTCODE,
            self::DISCOUNTALREADYCLAIMED,
            self::DISCOUNTCLAIMFAILURE,
            self::DISCOUNTCONFIGURATIONFAILURE,
            self::DISCOUNTGENERATIONFAILURE,
            self::DISCOUNTALREADYEXISTS,
            self::TOKENREQUIRESCREDENTIALXUID,
            self::TOKENREQUIRESCREDENTIALPSNID,
            self::OFFERREQUIRED,
            self::UNKNOWNEVERVERSEHISTORYERROR,
            self::MISSINGEVERVERSEHISTORYERROR,
            self::BUNGIEREWARDEMAILSTATEINVALID,
            self::BUNGIEREWARDNOTYETCLAIMABLE,
            self::APIEXCEEDEDMAXKEYS,
            self::APIINVALIDOREXPIREDKEY,
            self::APIKEYMISSINGFROMREQUEST,
            self::APPLICATIONDISABLED,
            self::APPLICATIONEXCEEDEDMAX,
            self::APPLICATIONDISALLOWEDBYSCOPE,
            self::AUTHORIZATIONCODEINVALID,
            self::ORIGINHEADERDOESNOTMATCHKEY,
            self::ACCESSNOTPERMITTEDBYAPPLICATIONSCOPE,
            self::APPLICATIONNAMEISTAKEN,
            self::REFRESHTOKENNOTYETVALID,
            self::ACCESSTOKENHASEXPIRED,
            self::APPLICATIONTOKENFORMATNOTVALID,
            self::APPLICATIONNOTCONFIGUREDFORBUNGIEAUTH,
            self::APPLICATIONNOTCONFIGUREDFOROAUTH,
            self::OAUTHACCESSTOKENEXPIRED,
            self::PARTNERSHIPINVALIDTYPE,
            self::PARTNERSHIPVALIDATIONERROR,
            self::PARTNERSHIPVALIDATIONTIMEOUT,
            self::PARTNERSHIPACCESSFAILURE,
            self::PARTNERSHIPACCOUNTINVALID,
            self::PARTNERSHIPGETACCOUNTINFOFAILURE,
            self::PARTNERSHIPDISABLED,
            self::PARTNERSHIPALREADYEXISTS,
            self::COMMUNITYSTREAMINGUNAVAILABLE,
            self::TWITCHNOTLINKED,
            self::TWITCHACCOUNTNOTFOUND,
            self::TWITCHCOULDNOTLOADDESTINYINFO,
            self::TRENDINGCATEGORYNOTFOUND,
            self::TRENDINGENTRYTYPENOTSUPPORTED,
            self::REPORTOFFENDERNOTINPGCR,
            self::REPORTREQUESTORNOTINPGCR,
            self::REPORTSUBMISSIONFAILED,
            self::REPORTCANNOTREPORTSELF,
            self::AWATYPEDISABLED,
            self::AWATOOMANYPENDINGREQUESTS,
            self::AWATHEFEATUREREQUIRESAREGISTEREDDEVICE,
            self::AWAREQUESTWASUNANSWEREDFORTOOLONG,
            self::AWAWRITEREQUESTMISSINGORINVALIDTOKEN,
            self::AWAWRITEREQUESTTOKENEXPIRED,
            self::AWAWRITEREQUESTTOKENUSAGELIMITREACHED,
            self::CLANFIRETEAMNOTFOUND,
            self::CLANFIRETEAMADDNOALTERNATESFORIMMEDIATE,
            self::CLANFIRETEAMFULL,
            self::CLANFIRETEAMALTFULL,
            self::CLANFIRETEAMBLOCKED,
            self::CLANFIRETEAMPLAYERENTRYNOTFOUND,
            self::CLANFIRETEAMPERMISSIONS,
            self::CLANFIRETEAMINVALIDPLATFORM,
            self::CLANFIRETEAMCANNOTADJUSTSLOTCOUNT,
            self::CLANFIRETEAMINVALIDPLAYERPLATFORM,
            self::CLANFIRETEAMNOTREADYFORINVITESNOTENOUGHPLAYERS,
            self::CLANFIRETEAMGAMEINVITESNOTSUPPORTFORPLATFORM,
            self::CLANFIRETEAMPLATFORMINVITEPREQFAILURE,
            self::CLANFIRETEAMINVALIDAUTHCONTEXT,
            self::CLANFIRETEAMINVALIDAUTHPROVIDERPSN,
            self::CLANFIRETEAMPS4SESSIONFULL,
            self::CLANFIRETEAMINVALIDAUTHTOKEN,
            self::CLANFIRETEAMSCHEDULEDFIRETEAMSDISABLED,
            self::CLANFIRETEAMNOTREADYFORINVITESNOTSCHEDULEDYET,
            self::CLANFIRETEAMNOTREADYFORINVITESCLOSED,
            self::CLANFIRETEAMSCHEDULEDFIRETEAMSREQUIREADMINPERMISSIONS,
            self::CLANFIRETEAMNONPUBLICMUSTHAVECLAN,
            self::CLANFIRETEAMPUBLICCREATIONRESTRICTION,
            self::CLANFIRETEAMALREADYJOINED,
            self::CLANFIRETEAMSCHEDULEDFIRETEAMSRANGE,
            self::CLANFIRETEAMPUBLICCREATIONRESTRICTIONEXTENDED,
        ];
    }
}
