 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyMilestonesDestinyMilestoneQuest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Milestones.DestinyMilestoneQuest';
     ...
     * Sets status
     *
     * @param object $status The current status of the quest for the character making the request.
     *
     * @return $this
     */
