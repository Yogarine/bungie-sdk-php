 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20078 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_78';
    ...
    protected static $openAPITypes = [
        'response' => 'map[string,\Bungie\Model\Common\Models\CoreSystem]',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Sets response
     *
     * @param map[string,\Bungie\Model\Common\Models\CoreSystem]|null $response response
     *
     * @return $this
     */
