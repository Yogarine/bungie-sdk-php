...
class InlineResponse20068 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\CommonModelsCoreSettingsConfiguration',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\CommonModelsCoreSettingsConfiguration|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\CommonModelsCoreSettingsConfiguration|null $response response
     *
     * @return $this
     */
