...
class TrendingTrendingEntry implements ModelInterface, ArrayAccess
{
     ...
     * Gets entityType
     *
     * @return TrendingTrendingEntryType|null
     */
     ...
     * Sets entityType
     *
     * @param TrendingTrendingEntryType|null $entityType An enum - unfortunately - dictating all of the possible kinds of trending items that you might get in your result set, in case you want to do custom rendering or call to get the details of the item.
     *
     * @return $this
     */
     ...
     * Sets items
     *
     * @param \Bungie\Model\TrendingTrendingEntry[]|null $items If the item is of entityType TrendingEntryType.Container, it may have items - also Trending Entries - contained within it. This is the ordered list of those to display under the Container's header.
     *
     * @return $this
     */
