...
class DestinyEntitiesCharactersDestinyCharacterRenderComponent implements ModelInterface, ArrayAccess
{
     ...
     * Gets customDyes
     *
     * @return \Bungie\Model\DestinyDyeReference[]|null
     */
     ...
     * Sets customDyes
     *
     * @param \Bungie\Model\DestinyDyeReference[]|null $customDyes Custom dyes, calculated by iterating over the character's equipped items. Useful for pre-fetching all of the dye data needed from our server.
     *
     * @return $this
     */
     ...
     * Sets peerView
     *
     * @param DestinyCharacterDestinyCharacterPeerView|null $peerView A minimal view of:  - Equipped items  - The rendering-related custom options on those equipped items  Combined, that should be enough to render all of the items on the equipped character.
     *
     * @return $this
     */
