 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsSocketsDestinyPlugWhitelistEntryDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Sockets.DestinyPlugWhitelistEntryDefinition';
     ...
     * Sets categoryHash
     *
     * @param int $categoryHash The hash identifier of the Plug Category to compare against the plug item's plug.plugCategoryHash.  Note that this does NOT relate to any Definition in itself, it is only used for comparison purposes.
     *
     * @return $this
     */
     ...
     *
     * @param string $categoryIdentifier The string identifier for the category, which is here mostly for debug purposes.
     *
     * @return $this
     */
