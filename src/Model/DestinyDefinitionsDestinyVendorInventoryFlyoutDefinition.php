...
class DestinyDefinitionsDestinyVendorInventoryFlyoutDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $lockedDescription If the flyout is locked, this is the reason why.
     *
     * @return $this
     */
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $displayProperties The title and other common properties of the flyout.
     *
     * @return $this
     */
     ...
     * Gets buckets
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyVendorInventoryFlyoutBucketDefinition[]|null
     */
     ...
     * Sets buckets
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyVendorInventoryFlyoutBucketDefinition[]|null $buckets A list of inventory buckets and other metadata to show on the screen.
     *
     * @return $this
     */
     ...
     * Sets flyoutId
     *
     * @param int|null $flyoutId An identifier for the flyout, in case anything else needs to refer to them.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $suppressNewness If this is true, don't show any of the glistening \"this is a new item\" UI elements, like we show on the inventory items themselves in in-game UI.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $equipmentSlotHash If this flyout is meant to show you the contents of the player's equipment slot, this is the slot to show.
     *
     * @return $this
     */
