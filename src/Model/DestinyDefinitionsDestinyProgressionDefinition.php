 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyProgressionDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyProgressionDefinition';
    ...
    protected static $swaggerTypes = [
        'displayProperties' => '\Bungie\Model\DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition',
        'scope' => 'object',
        'repeatLastStep' => 'bool',
        'source' => 'string',
        'steps' => '\Bungie\Model\DestinyDefinitionsDestinyProgressionStepDefinition[]',
        'visible' => 'bool',
        'factionHash' => 'int',
        'hash' => 'int',
        'index' => 'int',
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyProgressionDisplayPropertiesDefinition $displayProperties displayProperties
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param object $scope The \"Scope\" of the progression indicates the source of the progression's live data.  See the DestinyProgressionScope enum for more info: but essentially, a Progression can either be backed by a stored value, or it can be a calculated derivative of other values.
     *
     * @return $this
     */
     ...
     * Sets repeatLastStep
     *
     * @param bool $repeatLastStep If this is True, then the progression doesn't have a maximum level.
     *
     * @return $this
     */
     ...
     * Sets source
     *
     * @param string $source If there's a description of how to earn this progression in the local config, this will be that localized description.
     *
     * @return $this
     */
     ...
     * Gets steps
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyProgressionStepDefinition[]
     */
     ...
     * Sets visible
     *
     * @param bool $visible If true, the Progression is something worth showing to users.  If false, BNet isn't going to show it. But that doesn't mean you can't. We're all friends here.
     *
     * @return $this
     */
     ...
     * Sets factionHash
     *
     * @param int $factionHash If the value exists, this is the hash identifier for the Faction that owns this Progression.  This is purely for convenience, if you're looking at a progression and want to know if and who it's related to in terms of Faction Reputation.
     *
     * @return $this
     */
