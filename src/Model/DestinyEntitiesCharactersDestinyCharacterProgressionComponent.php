...
class DestinyEntitiesCharactersDestinyCharacterProgressionComponent implements ModelInterface, ArrayAccess
{
     ...
     * Gets progressions
     *
     * @return map[string,\Bungie\Model\DestinyDestinyProgression]|null
     */
     ...
     * Sets progressions
     *
     * @param map[string,\Bungie\Model\DestinyDestinyProgression]|null $progressions A Dictionary of all known progressions for the Character, keyed by the Progression's hash.  Not all progressions have user-facing data, but those who do will have that data contained in the DestinyProgressionDefinition.
     *
     * @return $this
     */
     ...
     * Gets factions
     *
     * @return map[string,\Bungie\Model\DestinyProgressionDestinyFactionProgression]|null
     */
     ...
     * Sets factions
     *
     * @param map[string,\Bungie\Model\DestinyProgressionDestinyFactionProgression]|null $factions A dictionary of all known Factions, keyed by the Faction's hash. It contains data about this character's status with the faction.
     *
     * @return $this
     */
     ...
     * Gets milestones
     *
     * @return map[string,\Bungie\Model\DestinyMilestonesDestinyMilestone]|null
     */
     ...
     * Sets milestones
     *
     * @param map[string,\Bungie\Model\DestinyMilestonesDestinyMilestone]|null $milestones Milestones are related to the simple progressions shown in the game, but return additional and hopefully helpful information for users about the specifics of the Milestone's status.
     *
     * @return $this
     */
     ...
     * Gets quests
     *
     * @return \Bungie\Model\DestinyQuestsDestinyQuestStatus[]|null
     */
     ...
     * Sets quests
     *
     * @param \Bungie\Model\DestinyQuestsDestinyQuestStatus[]|null $quests If the user has any active quests, the quests' statuses will be returned here.  Note that quests have been largely supplanted by Milestones, but that doesn't mean that they won't make a comeback independent of milestones at some point.
     *
     * @return $this
     */
     ...
     *
     * @return map[string,\Bungie\Model\DestinyQuestsDestinyObjectiveProgress[]]|null
     */
     ...
     *
     * @param map[string,\Bungie\Model\DestinyQuestsDestinyObjectiveProgress[]]|null $uninstancedItemObjectives Sometimes, you have items in your inventory that don't have instances, but still have Objective information. This provides you that objective information for uninstanced items.   This dictionary is keyed by the item's hash: which you can use to look up the name and description for the overall task(s) implied by the objective. The value is the list of objectives for this item, and their statuses.
     *
     * @return $this
     */
