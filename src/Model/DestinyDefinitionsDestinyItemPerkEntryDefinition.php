...
class DestinyDefinitionsDestinyItemPerkEntryDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'perkHash' => 'int',
        'perkVisibility' => 'DestinyItemPerkVisibility'
    ];
     ...
     * Gets perkVisibility
     *
     * @return DestinyItemPerkVisibility|null
     */
     ...
     * Sets perkVisibility
     *
     * @param DestinyItemPerkVisibility|null $perkVisibility Indicates whether this perk should be shown, or if it should be shown disabled.
     *
     * @return $this
     */
