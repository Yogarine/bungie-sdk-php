...
class DestinyHistoricalStatsDestinyPlayer implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param UserUserInfoCard|null $destinyUserInfo Details about the player as they are known in game (platform display name, Destiny emblem)
     *
     * @return $this
     */
     ...
     *
     * @param UserUserInfoCard|null $bungieNetUserInfo Details about the player as they are known on BungieNet. This will be undefined if the player has marked their credential private, or does not have a BungieNet account.
     *
     * @return $this
     */
