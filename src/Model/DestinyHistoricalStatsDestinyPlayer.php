 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyHistoricalStatsDestinyPlayer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.HistoricalStats.DestinyPlayer';
     ...
     *
     * @param object $destinyUserInfo Details about the player as they are known in game (platform display name, Destiny emblem)
     *
     * @return $this
     */
     ...
     * Sets characterClass
     *
     * @param string $characterClass Class of the character if applicable and available.
     *
     * @return $this
     */
     ...
     * Sets genderHash
     *
     * @param int $genderHash genderHash
     *
     * @return $this
     */
     ...
     * Sets characterLevel
     *
     * @param int $characterLevel Level of the character if available. Zero if it is not available.
     *
     * @return $this
     */
     ...
     * Sets lightLevel
     *
     * @param int $lightLevel Light Level of the character if available. Zero if it is not available.
     *
     * @return $this
     */
     ...
     *
     * @param object $bungieNetUserInfo Details about the player as they are known on BungieNet. This will be undefined if the player has marked their credential private, or does not have a BungieNet account.
     *
     * @return $this
     */
     ...
     * Sets clanName
     *
     * @param string $clanName Current clan name for the player. This value may be null or an empty string if the user does not have a clan.
     *
     * @return $this
     */
     ...
     * Sets clanTag
     *
     * @param string $clanTag Current clan tag for the player. This value may be null or an empty string if the user does not have a clan.
     *
     * @return $this
     */
     ...
     * Sets emblemHash
     *
     * @param int $emblemHash If we know the emblem's hash, this can be used to look up the player's emblem at the time of a match when receiving PGCR data, or otherwise their currently equipped emblem (if we are able to obtain it).
     *
     * @return $this
     */
