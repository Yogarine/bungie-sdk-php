...
class TrendingEntry implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets entityType
     *
     * @param int|null $entityType An enum - unfortunately - dictating all of the possible kinds of trending items that you might get in your result set, in case you want to do custom rendering or call to get the details of the item.
     *
     * @return $this
     */
