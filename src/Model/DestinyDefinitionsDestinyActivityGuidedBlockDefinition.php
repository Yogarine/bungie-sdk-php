 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyActivityGuidedBlockDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyActivityGuidedBlockDefinition';
     ...
     *
     * @param int $guidedMaxLobbySize The maximum amount of people that can be in the waiting lobby.
     *
     * @return $this
     */
     ...
     *
     * @param int $guidedMinLobbySize The minimum amount of people that can be in the waiting lobby.
     *
     * @return $this
     */
     ...
     *
     * @param int $guidedDisbandCount If -1, the guided group cannot be disbanded. Otherwise, take the total # of players in the activity and subtract this number: that is the total # of votes needed for the guided group to disband.
     *
     * @return $this
     */
