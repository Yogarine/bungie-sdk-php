...
class DestinyDefinitionsSocketsDestinySocketTypeDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Sockets.DestinySocketTypeDefinition';
     ...
     *
     * @param object $displayProperties There are fields for this display data, but they appear to be unpopulated as of now. I am not sure where in the UI these would show if they even were populated, but I will continue to return this data in case it becomes useful.
     *
     * @return $this
     */
     ...
     * Sets insertAction
     *
     * @param object $insertAction Defines what happens when a plug is inserted into sockets of this type.
     *
     * @return $this
     */
     ...
     * Gets plugWhitelist
     *
     * @return \Bungie\Model\DestinyDefinitionsSocketsDestinyPlugWhitelistEntryDefinition[]
     */
     ...
     * Sets plugWhitelist
     *
     * @param \Bungie\Model\DestinyDefinitionsSocketsDestinyPlugWhitelistEntryDefinition[] $plugWhitelist A list of Plug \"Categories\" that are allowed to be plugged into sockets of this type.  These should be compared against a given plug item's DestinyInventoryItemDefinition.plug.plugCategoryHash, which indicates the plug item's category.  If the plug's category matches any whitelisted plug, or if the whitelist is empty, it is allowed to be inserted.
     *
     * @return $this
     */
     ...
     *
     * @param int $socketCategoryHash socketCategoryHash
     *
     * @return $this
     */
     ...
     * Sets visibility
     *
     * @param object $visibility Sometimes a socket isn't visible. These are some of the conditions under which sockets of this type are not visible. Unfortunately, the truth of visibility is much, much more complex. Best to rely on the live data for whether the socket is visible and enabled.
     *
     * @return $this
     */
     ...
     *
     * @param bool $alwaysRandomizeSockets alwaysRandomizeSockets
     *
     * @return $this
     */
     ...
     *
     * @param bool $isPreviewEnabled isPreviewEnabled
     *
     * @return $this
     */
     ...
     *
     * @param bool $hideDuplicateReusablePlugs hideDuplicateReusablePlugs
     *
     * @return $this
     */
     ...
     *
     * @param bool $overridesUiAppearance This property indicates if the socket type determines whether Emblem icons and nameplates should be overridden by the inserted plug item's icon and nameplate.
     *
     * @return $this
     */
     ...
     *
     * @param bool $avoidDuplicatesOnInitialization avoidDuplicatesOnInitialization
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsSocketsDestinySocketTypeScalarMaterialRequirementEntry[]
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsSocketsDestinySocketTypeScalarMaterialRequirementEntry[] $currencyScalars currencyScalars
     *
     * @return $this
     */
