 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyStatGroupDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyStatGroupDefinition';
    ...
    protected static $swaggerTypes = [
        'maximumValue' => 'int',
        'uiPosition' => 'int',
        'scaledStats' => '\Bungie\Model\DestinyDefinitionsDestinyStatDisplayDefinition[]',
        'overrides' => 'map[string,\Bungie\Model\DestinyDefinitionsDestinyStatOverrideDefinition]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     * Sets uiPosition
     *
     * @param int $uiPosition This apparently indicates the position of the stats in the UI? I've returned it in case anyone can use it, but it's not of any use to us on BNet. Something's being lost in translation with this value.
     *
     * @return $this
     */
     ...
     * Gets scaledStats
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyStatDisplayDefinition[]
     */
     ...
     * Gets overrides
     *
     * @return map[string,\Bungie\Model\DestinyDefinitionsDestinyStatOverrideDefinition]
     */
