...
/**
 * FireteamUserInfoCard Class Doc Comment
 *
 * @category Class
 * @package  Bungie
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FireteamUserInfoCard implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPIFormats = [
        'fireteamDisplayName' => null,
        'fireteamMembershipType' => 'int32',
        'fireteamPlatformProfileUrl' => null,
        'fireteamPlatformUniqueIdentifier' => null,
    ...
    protected static $setters = [
        'fireteamDisplayName' => 'setFireteamDisplayName',
        'fireteamMembershipType' => 'setFireteamMembershipType',
        'fireteamPlatformProfileUrl' => 'setFireteamPlatformProfileUrl',
        'fireteamPlatformUniqueIdentifier' => 'setFireteamPlatformUniqueIdentifier',
    ...
    protected static $getters = [
        'fireteamDisplayName' => 'getFireteamDisplayName',
        'fireteamMembershipType' => 'getFireteamMembershipType',
        'fireteamPlatformProfileUrl' => 'getFireteamPlatformProfileUrl',
        'fireteamPlatformUniqueIdentifier' => 'getFireteamPlatformUniqueIdentifier',
    ...
    {
        $this->container['fireteamDisplayName'] = isset($data['fireteamDisplayName']) ? $data['fireteamDisplayName'] : null;
        $this->container['fireteamMembershipType'] = isset($data['fireteamMembershipType']) ? $data['fireteamMembershipType'] : null;
        $this->container['fireteamPlatformProfileUrl'] = isset($data['fireteamPlatformProfileUrl']) ? $data['fireteamPlatformProfileUrl'] : null;
        $this->container['fireteamPlatformUniqueIdentifier'] = isset($data['fireteamPlatformUniqueIdentifier']) ? $data['fireteamPlatformUniqueIdentifier'] : null;
    ...
    /**
     * Gets fireteamDisplayName
     *
     * @return string|null
     */
    public function getFireteamDisplayName()
    {
        return $this->container['fireteamDisplayName'];
    }

    /**
     * Sets fireteamDisplayName
     *
     * @param string|null $fireteamDisplayName fireteamDisplayName
     *
     * @return $this
     */
    public function setFireteamDisplayName($fireteamDisplayName)
    {
        $this->container['fireteamDisplayName'] = $fireteamDisplayName;

        return $this;
    }

    /**
     * Gets fireteamMembershipType
     *
     * @return int|null
     */
    public function getFireteamMembershipType()
    {
        return $this->container['fireteamMembershipType'];
    }

    /**
     * Sets fireteamMembershipType
     *
     * @param int|null $fireteamMembershipType fireteamMembershipType
     *
     * @return $this
     */
    public function setFireteamMembershipType($fireteamMembershipType)
    {
        $this->container['fireteamMembershipType'] = $fireteamMembershipType;

        return $this;
    }

    /**
     * Gets fireteamPlatformProfileUrl
     *
     * @return string|null
     */
    public function getFireteamPlatformProfileUrl()
    {
        return $this->container['fireteamPlatformProfileUrl'];
    }

    /**
     * Sets fireteamPlatformProfileUrl
     *
     * @param string|null $fireteamPlatformProfileUrl fireteamPlatformProfileUrl
     *
     * @return $this
     */
    public function setFireteamPlatformProfileUrl($fireteamPlatformProfileUrl)
    {
        $this->container['fireteamPlatformProfileUrl'] = $fireteamPlatformProfileUrl;

        return $this;
    }

    /**
     * Gets fireteamPlatformUniqueIdentifier
     *
     * @return string|null
     */
    public function getFireteamPlatformUniqueIdentifier()
    {
        return $this->container['fireteamPlatformUniqueIdentifier'];
    }

    /**
     * Sets fireteamPlatformUniqueIdentifier
     *
     * @param string|null $fireteamPlatformUniqueIdentifier fireteamPlatformUniqueIdentifier
     *
     * @return $this
     */
    public function setFireteamPlatformUniqueIdentifier($fireteamPlatformUniqueIdentifier)
    {
        $this->container['fireteamPlatformUniqueIdentifier'] = $fireteamPlatformUniqueIdentifier;
