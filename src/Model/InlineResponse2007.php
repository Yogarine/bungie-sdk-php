 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse2007 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Content\Models\ContentTypeDescription',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Content\Models\ContentTypeDescription|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Content\Models\ContentTypeDescription|null $response response
     *
     * @return $this
     */
