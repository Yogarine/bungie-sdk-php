...
class InlineResponse2007 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\User\HardLinkedUserMembership',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\User\HardLinkedUserMembership|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\User\HardLinkedUserMembership|null $response response
     *
     * @return $this
     */
