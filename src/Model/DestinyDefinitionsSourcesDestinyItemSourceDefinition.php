 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsSourcesDestinyItemSourceDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Sources.DestinyItemSourceDefinition';
    ...
    protected static $swaggerTypes = [
        ...
        'computedStats' => 'map[string,\Bungie\Model\DestinyDefinitionsDestinyInventoryItemStatDefinition]',
        'sourceHashes' => 'int[]'
    ];
     ...
     * Sets level
     *
     * @param int $level The level at which the item spawns. Essentially the Primary Key for this source data: there will be multiple of these source entries per item that has source data, grouped by the level at which the item spawns.
     *
     * @return $this
     */
     ...
     * Sets minQuality
     *
     * @param int $minQuality The minimum Quality at which the item spawns for this level. Examine DestinyInventoryItemDefinition for more information about what Quality means. Just don't ask Phaedrus about it, he'll never stop talking and you'll have to write a book about it.
     *
     * @return $this
     */
     ...
     * Sets maxQuality
     *
     * @param int $maxQuality The maximum quality at which the item spawns for this level.
     *
     * @return $this
     */
     ...
     *
     * @param int $minLevelRequired The minimum Character Level required for equipping the item when the item spawns at the item level defined on this DestinyItemSourceDefinition, as far as we saw in our processing.
     *
     * @return $this
     */
     ...
     *
     * @param int $maxLevelRequired The maximum Character Level required for equipping the item when the item spawns at the item level defined on this DestinyItemSourceDefinition, as far as we saw in our processing.
     *
     * @return $this
     */
     ...
     * Gets computedStats
     *
     * @return map[string,\Bungie\Model\DestinyDefinitionsDestinyInventoryItemStatDefinition]
     */
     ...
     * Sets computedStats
     *
     * @param map[string,\Bungie\Model\DestinyDefinitionsDestinyInventoryItemStatDefinition] $computedStats The stats computed for this level/quality range.
     *
     * @return $this
     */
     ...
     * Sets sourceHashes
     *
     * @param int[] $sourceHashes The DestinyRewardSourceDefinitions found that can spawn the item at this level.
     *
     * @return $this
     */
