 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyQuestsDestinyObjectiveProgress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Quests.DestinyObjectiveProgress';
     ...
     * Sets objectiveHash
     *
     * @param int $objectiveHash The unique identifier of the Objective being referred to. Use to look up the DestinyObjectiveDefinition in static data.
     *
     * @return $this
     */
     ...
     *
     * @param int $destinationHash If the Objective has a Destination associated with it, this is the unique identifier of the Destination being referred to. Use to look up the DestinyDestinationDefinition in static data. This will give localized data about *where* in the universe the objective should be achieved.
     *
     * @return $this
     */
     ...
     * Sets activityHash
     *
     * @param int $activityHash If the Objective has an Activity associated with it, this is the unique identifier of the Activity being referred to. Use to look up the DestinyActivityDefinition in static data. This will give localized data about *what* you should be playing for the objective to be achieved.
     *
     * @return $this
     */
     ...
     *
     * @param int $completionValue As of Forsaken, objectives' completion value is determined dynamically at runtime.  This value represents the threshold of progress you need to surpass in order for this objective to be considered \"complete\".  If you were using objective data, switch from using the DestinyObjectiveDefinition's \"completionValue\" to this value.
     *
     * @return $this
     */
     ...
     * Sets complete
     *
     * @param bool $complete Whether or not the Objective is completed.
     *
     * @return $this
     */
     ...
     * Sets visible
     *
     * @param bool $visible If this is true, the objective is visible in-game. Otherwise, it's not yet visible to the player. Up to you if you want to honor this property.
     *
     * @return $this
     */
