 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinySandboxPerkDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinySandboxPerkDefinition';
     ...
     *
     * @param object $displayProperties These display properties are by no means guaranteed to be populated. Usually when it is, it's only because we back-filled them with the displayProperties of some Talent Node or Plug item that happened to be uniquely providing that perk.
     *
     * @return $this
     */
     ...
     * Sets perkIdentifier
     *
     * @param string $perkIdentifier The string identifier for the perk.
     *
     * @return $this
     */
     ...
     * Sets isDisplayable
     *
     * @param bool $isDisplayable If true, you can actually show the perk in the UI. Otherwise, it doesn't have useful player-facing information.
     *
     * @return $this
     */
     ...
     * Sets damageType
     *
     * @param object $damageType If this perk grants a damage type to a weapon, the damage type will be defined here.  Unless you have a compelling reason to use this enum value, use the damageTypeHash instead to look up the actual DestinyDamageTypeDefinition.
     *
     * @return $this
     */
     ...
     * Sets damageTypeHash
     *
     * @param int $damageTypeHash The hash identifier for looking up the DestinyDamageTypeDefinition, if this perk has a damage type.  This is preferred over using the damageType enumeration value, which has been left purely because it is occasionally convenient.
     *
     * @return $this
     */
     ...
     * Sets perkGroups
     *
     * @param object $perkGroups An old holdover from the original Armory, this was an attempt to group perks by functionality.  It is as yet unpopulated, and there will be quite a bit of work needed to restore it to its former working order.
     *
     * @return $this
     */
