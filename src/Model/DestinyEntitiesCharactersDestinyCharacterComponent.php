...
class DestinyEntitiesCharactersDestinyCharacterComponent implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'genderHash' => 'int',
        'classHash' => 'int',
        'raceType' => 'DestinyDestinyRace',
        'classType' => 'DestinyDestinyClass',
        'genderType' => 'DestinyDestinyGender',
        'emblemPath' => 'string',
     ...
     * Sets membershipType
     *
     * @param BungieMembershipType|null $membershipType membershipType tells you the platform on which the character plays. Examine the BungieMembershipType enumeration for possible values.
     *
     * @return $this
     */
     ...
     * Gets raceType
     *
     * @return DestinyDestinyRace|null
     */
     ...
     * Sets raceType
     *
     * @param DestinyDestinyRace|null $raceType Mostly for historical purposes at this point, this is an enumeration for the character's race.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove.
     *
     * @return $this
     */
     ...
     * Sets classType
     *
     * @param DestinyDestinyClass|null $classType Mostly for historical purposes at this point, this is an enumeration for the character's class.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove.
     *
     * @return $this
     */
     ...
     * Gets genderType
     *
     * @return DestinyDestinyGender|null
     */
     ...
     * Sets genderType
     *
     * @param DestinyDestinyGender|null $genderType Mostly for historical purposes at this point, this is an enumeration for the character's Gender.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove. And yeah, it's an enumeration and not a boolean. Fight me.
     *
     * @return $this
     */
     ...
     * Sets emblemColor
     *
     * @param DestinyMiscDestinyColor|null $emblemColor A shortcut for getting the background color of the user's currently equipped emblem without having to do a DestinyInventoryItemDefinition lookup.
     *
     * @return $this
     */
     ...
     *
     * @param DestinyDestinyProgression|null $levelProgression The progression that indicates your character's level. Not their light level, but their character level: you know, the thing you max out a couple hours in and then ignore for the sake of light level.
     *
     * @return $this
     */
