...
class DestinyDefinitionsDestinyObjectiveDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'completedValueStyle' => 'DestinyDestinyUnlockValueUIStyle',
        'inProgressValueStyle' => 'DestinyDestinyUnlockValueUIStyle',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $displayProperties Ideally, this should tell you what your task is. I'm not going to lie to you though. Sometimes this doesn't have useful information at all. Which sucks, but there's nothing either of us can do about it.
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param DestinyDestinyGatingScope|null $scope A shortcut for determining the most restrictive gating that this Objective is set to use. This includes both the dynamic determination of progress and of completion values. See the DestinyGatingScope enum's documentation for more details.
     *
     * @return $this
     */
     ...
     * Gets valueStyle
     *
     * @return DestinyDestinyUnlockValueUIStyle|null
     */
     ...
     * Sets valueStyle
     *
     * @param DestinyDestinyUnlockValueUIStyle|null $valueStyle The UI style applied to the objective. It's an enum, take a look at DestinyUnlockValueUIStyle for details of the possible styles. Use this info as you wish to customize your UI.
     *
     * @return $this
     */
     ...
     *
     * @param DestinyDestinyUnlockValueUIStyle|null $completedValueStyle The style to use when the objective is completed.
     *
     * @return $this
     */
     ...
     *
     * @param DestinyDestinyUnlockValueUIStyle|null $inProgressValueStyle The style to use when the objective is still in progress.
     *
     * @return $this
     */
