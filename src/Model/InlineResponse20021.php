 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20021 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\GroupsV2\GroupOptionalConversation[]',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\GroupsV2\GroupOptionalConversation[]|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\GroupsV2\GroupOptionalConversation[]|null $response response
     *
     * @return $this
     */
