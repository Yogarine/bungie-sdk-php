...
class DestinyDefinitionsDestinyNodeSocketReplaceResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyNodeSocketReplaceResponse';
     ...
     * Sets socketTypeHash
     *
     * @param int $socketTypeHash The hash identifier of the socket type to find amidst the item's sockets (the item to which this talent grid is attached). See DestinyInventoryItemDefinition.sockets.socketEntries to find the socket type of sockets on the item in question.
     *
     * @return $this
     */
     ...
     * Sets plugItemHash
     *
     * @param int $plugItemHash The hash identifier of the plug item that will be inserted into the socket found.
     *
     * @return $this
     */
