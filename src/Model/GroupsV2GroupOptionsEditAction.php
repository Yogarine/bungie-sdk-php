 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupsV2GroupOptionsEditAction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupsV2.GroupOptionsEditAction';
     ...
     *
     * @param int $hostGuidedGamePermissionOverride Minimum Member Level allowed to host guided games  Always Allowed: Founder, Acting Founder, Admin  Allowed Overrides: None, Member, Beginner  Default is Member for clans, None for groups, although this means nothing for groups.
     *
     * @return $this
     */
     ...
     * Sets joinLevel
     *
     * @param int $joinLevel Level to join a member at when accepting an invite, application, or joining an open clan  Default is Beginner.
     *
     * @return $this
     */
