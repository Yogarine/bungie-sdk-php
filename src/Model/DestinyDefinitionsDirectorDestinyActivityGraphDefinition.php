 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDirectorDestinyActivityGraphDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Director.DestinyActivityGraphDefinition';
    ...
    protected static $swaggerTypes = [
        'nodes' => '\Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinition[]',
        'artElements' => '\Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphArtElementDefinition[]',
        'connections' => '\Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphConnectionDefinition[]',
        'displayObjectives' => '\Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphDisplayObjectiveDefinition[]',
        'displayProgressions' => '\Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphDisplayProgressionDefinition[]',
        'linkedGraphs' => '\Bungie\Model\DestinyDefinitionsDirectorDestinyLinkedGraphDefinition[]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     * Gets nodes
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinition[]
     */
     ...
     * Sets nodes
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphNodeDefinition[] $nodes These represent the visual \"nodes\" on the map's view. These are the activities you can click on in the map.
     *
     * @return $this
     */
     ...
     * Gets artElements
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphArtElementDefinition[]
     */
     ...
     * Sets artElements
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphArtElementDefinition[] $artElements Represents one-off/special UI elements that appear on the map.
     *
     * @return $this
     */
     ...
     * Gets connections
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphConnectionDefinition[]
     */
     ...
     * Sets connections
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphConnectionDefinition[] $connections Represents connections between graph nodes. However, it lacks context that we'd need to make good use of it.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphDisplayObjectiveDefinition[]
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphDisplayObjectiveDefinition[] $displayObjectives Objectives can display on maps, and this is supposedly metadata for that. I have not had the time to analyze the details of what is useful within however: we could be missing important data to make this work. Expect this property to be expanded on later if possible.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphDisplayProgressionDefinition[]
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyActivityGraphDisplayProgressionDefinition[] $displayProgressions Progressions can also display on maps, but similarly to displayObjectives we appear to lack some required information and context right now. We will have to look into it later and add more data if possible.
     *
     * @return $this
     */
     ...
     * Gets linkedGraphs
     *
     * @return \Bungie\Model\DestinyDefinitionsDirectorDestinyLinkedGraphDefinition[]
     */
     ...
     * Sets linkedGraphs
     *
     * @param \Bungie\Model\DestinyDefinitionsDirectorDestinyLinkedGraphDefinition[] $linkedGraphs Represents links between this Activity Graph and other ones.
     *
     * @return $this
     */
