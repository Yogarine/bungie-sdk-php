 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyItemPreviewBlockDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyItemPreviewBlockDefinition';
    ...
    protected static $swaggerTypes = [
        ...
        'derivedItemCategories' => '\Bungie\Model\DestinyDefinitionsItemsDestinyDerivedItemCategoryDefinition[]'
    ];
     ...
     * Sets screenStyle
     *
     * @param string $screenStyle A string that the game UI uses as a hint for which detail screen to show for the item. You, too, can leverage this for your own custom screen detail views. Note, however, that these are arbitrarily defined by designers: there's no guarantees of a fixed, known number of these - so fall back to something reasonable if you don't recognize it.
     *
     * @return $this
     */
     ...
     *
     * @param int $previewVendorHash If the preview data is derived from a fake \"Preview\" Vendor, this will be the hash identifier for the DestinyVendorDefinition of that fake vendor.
     *
     * @return $this
     */
     ...
     *
     * @param string $previewActionString If the preview has an associated action (like \"Open\"), this will be the localized string for that action.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsItemsDestinyDerivedItemCategoryDefinition[]
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsItemsDestinyDerivedItemCategoryDefinition[] $derivedItemCategories This is a list of the items being previewed, categorized in the same way as they are in the preview UI.
     *
     * @return $this
     */
