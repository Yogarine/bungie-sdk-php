...
class DestinyDefinitionsDestinyInventoryItemDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'specialItemType' => 'DestinySpecialItemType',
        'itemType' => 'DestinyDestinyItemType',
        'itemSubType' => 'DestinyDestinyItemSubType',
        'classType' => 'DestinyDestinyClass',
        'equippable' => 'bool',
        'damageTypeHashes' => 'int[]',
        'damageTypes' => '\Bungie\Model\DestinyDamageType[]',
        'defaultDamageType' => 'DestinyDamageType',
     ...
     * Sets setData
     *
     * @param DestinyDefinitionsDestinyItemSetBlockDefinition|null $setData If this item is a quest, this block will be non-null. In practice, I wish I had called this the Quest block, but at the time it wasn't clear to me whether it would end up being used for purposes other than quests. It will contain data about the steps in the quest, and mechanics we can use for displaying and tracking the quest.
     *
     * @return $this
     */
     ...
     * Sets equippingBlock
     *
     * @param DestinyDefinitionsDestinyEquippingBlockDefinition|null $equippingBlock If this item can be equipped, this block will be non-null and will be populated with the conditions under which it can be equipped.
     *
     * @return $this
     */
     ...
     *
     * @param DestinyDefinitionsDestinyItemTranslationBlockDefinition|null $translationBlock If this item can be rendered, this block will be non-null and will be populated with rendering information.
     *
     * @return $this
     */
     ...
     * Sets sourceData
     *
     * @param DestinyDefinitionsDestinyItemSourceBlockDefinition|null $sourceData If this item has a known source, this block will be non-null and populated with source information. Unfortunately, at this time we are not generating sources: that is some aggressively manual work which we didn't have time for, and I'm hoping to get back to at some point in the future.
     *
     * @return $this
     */
     ...
     * Sets talentGrid
     *
     * @param DestinyDefinitionsDestinyItemTalentGridBlockDefinition|null $talentGrid If the item has a Talent Grid, this will be non-null and the properties of the grid defined herein. Note that, while many items still have talent grids, the only ones with meaningful Nodes still on them will be Subclass/\"Build\" items.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyItemInvestmentStatDefinition[]|null
     */
     ...
     * Gets perks
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyItemPerkEntryDefinition[]|null
     */
     ...
     * Sets perks
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyItemPerkEntryDefinition[]|null $perks If the item has any *intrinsic* Perks (Perks that it will provide regardless of Sockets, Talent Grid, and other transitory state), they will be defined here.
     *
     * @return $this
     */
     ...
     * Gets animations
     *
     * @return \Bungie\Model\DestinyDefinitionsAnimationsDestinyAnimationReference[]|null
     */
     ...
     * Sets animations
     *
     * @param \Bungie\Model\DestinyDefinitionsAnimationsDestinyAnimationReference[]|null $animations If any animations were extracted from game content for this item, these will be the definitions of those animations.
     *
     * @return $this
     */
     ...
     * Gets links
     *
     * @return \Bungie\Model\LinksHyperlinkReference[]|null
     */
     ...
     * Sets links
     *
     * @param \Bungie\Model\LinksHyperlinkReference[]|null $links If we added any help or informational URLs about this item, these will be those links.
     *
     * @return $this
     */
     ...
     *
     * @return DestinySpecialItemType|null
     */
     ...
     *
     * @param DestinySpecialItemType|null $specialItemType In Destiny 1, we identified some items as having particular categories that we'd like to know about for various internal logic purposes. These are defined in SpecialItemType, and while these days the itemCategoryHashes are the preferred way of identifying types, we have retained this enum for its convenience.
     *
     * @return $this
     */
     ...
     * Gets itemType
     *
     * @return DestinyDestinyItemType|null
     */
     ...
     * Sets itemType
     *
     * @param DestinyDestinyItemType|null $itemType A value indicating the \"base\" the of the item. This enum is a useful but dramatic oversimplification of what it means for an item to have a \"Type\". Still, it's handy in many situations.  itemCategoryHashes are the preferred way of identifying types, we have retained this enum for its convenience.
     *
     * @return $this
     */
     ...
     * Gets itemSubType
     *
     * @return DestinyDestinyItemSubType|null
     */
     ...
     * Gets classType
     *
     * @return DestinyDestinyClass|null
     */
     ...
     * Gets damageTypes
     *
     * @return \Bungie\Model\DestinyDamageType[]|null
     */
     ...
     *
     * @param DestinyDamageType|null $defaultDamageType If the item has a damage type that could be considered to be default, it will be populated here.  For various upsetting reasons, it's surprisingly cumbersome to figure this out. I hope you're happy.
     *
     * @return $this
     */
