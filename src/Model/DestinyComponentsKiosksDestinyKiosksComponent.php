...
class DestinyComponentsKiosksDestinyKiosksComponent implements ModelInterface, ArrayAccess
{
     ...
     * Gets kioskItems
     *
     * @return map[string,\Bungie\Model\DestinyComponentsKiosksDestinyKioskItem[]]|null
     */
     ...
     * Sets kioskItems
     *
     * @param map[string,\Bungie\Model\DestinyComponentsKiosksDestinyKioskItem[]]|null $kioskItems A dictionary keyed by the Kiosk Vendor's hash identifier (use it to look up the DestinyVendorDefinition for the relevant kiosk vendor), and whose value is a list of all the items that the user can \"see\" in the Kiosk, and any other interesting metadata.
     *
     * @return $this
     */
