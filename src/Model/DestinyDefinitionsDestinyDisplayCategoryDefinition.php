 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyDisplayCategoryDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyDisplayCategoryDefinition';
     ...
     * Sets identifier
     *
     * @param string $identifier A string identifier for the display category.
     *
     * @return $this
     */
     ...
     *
     * @param int $displayCategoryHash displayCategoryHash
     *
     * @return $this
     */
     ...
     *
     * @param bool $displayInBanner If true, this category should be displayed in the \"Banner\" section of the vendor's UI.
     *
     * @return $this
     */
     ...
     *
     * @param int $progressionHash If it exists, this is the hash identifier of a DestinyProgressionDefinition that represents the progression to show on this display category.  Specific categories can now have thier own distinct progression, apparently. So that's cool.
     *
     * @return $this
     */
     ...
     * Sets sortOrder
     *
     * @param object $sortOrder If this category sorts items in a nonstandard way, this will be the way we sort.
     *
     * @return $this
     */
     ...
     *
     * @param int $displayStyleHash An indicator of how the category will be displayed in the UI. It's up to you to do something cool or interesting in response to this, or just to treat it as a normal category.
     *
     * @return $this
     */
     ...
     *
     * @param string $displayStyleIdentifier An indicator of how the category will be displayed in the UI. It's up to you to do something cool or interesting in response to this, or just to treat it as a normal category.
     *
     * @return $this
     */
