...
class GroupAction implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets groupType
     *
     * @param int|null $groupType Type of group, either Bungie.net hosted group, or a game services hosted clan.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $platformMembershipType When operation needs a platform specific account ID for the present user, use this property. In particular, groupType of Clan requires this value to be set.
     *
     * @return $this
     */
