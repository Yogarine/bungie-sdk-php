 ...
 * @link     https://openapi-generator.tech
 */
class DestinyDefinitionsDirectorDestinyActivityGraphNodeFeaturingStateDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'highlightType' => 'DestinyActivityGraphNodeHighlightType'
    ];
     ...
     * Gets highlightType
     *
     * @return DestinyActivityGraphNodeHighlightType|null
     */
     ...
     * Sets highlightType
     *
     * @param DestinyActivityGraphNodeHighlightType|null $highlightType The node can be highlighted in a variety of ways - the game iterates through these and finds the first FeaturingState that is valid at the present moment given the Game, Account, and Character state, and renders the node in that state. See the ActivityGraphNodeHighlightType enum for possible values.
     *
     * @return $this
     */
