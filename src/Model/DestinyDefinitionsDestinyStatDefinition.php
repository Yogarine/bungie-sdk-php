 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyStatDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyStatDefinition';
     ...
     *
     * @param object $aggregationType Stats can exist on a character or an item, and they may potentially be aggregated in different ways. The DestinyStatAggregationType enum value indicates the way that this stat is being aggregated.
     *
     * @return $this
     */
     ...
     *
     * @param bool $hasComputedBlock True if the stat is computed rather than being delivered as a raw value on items.  For instance, the Light stat in Destiny 1 was a computed stat.
     *
     * @return $this
     */
     ...
     * Sets statCategory
     *
     * @param object $statCategory The category of the stat, according to the game.
     *
     * @return $this
     */
