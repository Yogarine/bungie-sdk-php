...
class DestinyDefinitionsDestinyStatDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'statCategory' => 'DestinyDestinyStatCategory',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     *
     * @return DestinyDestinyStatAggregationType|null
     */
     ...
     *
     * @param DestinyDestinyStatAggregationType|null $aggregationType Stats can exist on a character or an item, and they may potentially be aggregated in different ways. The DestinyStatAggregationType enum value indicates the way that this stat is being aggregated.
     *
     * @return $this
     */
     ...
     * Gets statCategory
     *
     * @return DestinyDestinyStatCategory|null
     */
     ...
     * Sets statCategory
     *
     * @param DestinyDestinyStatCategory|null $statCategory The category of the stat, according to the game.
     *
     * @return $this
     */
