...
class DestinyDefinitionsDestinyActivityDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $originalDisplayProperties The unadulterated form of the display properties, as they ought to be shown in the Director (if the activity appears in the director).
     *
     * @return $this
     */
     ...
     * Gets rewards
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityRewardDefinition[]|null
     */
     ...
     * Gets modifiers
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityModifierReferenceDefinition[]|null
     */
     ...
     * Sets modifiers
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyActivityModifierReferenceDefinition[]|null $modifiers Activities can have Modifiers, as defined in DestinyActivityModifierDefinition. These are references to the modifiers that *can* be applied to that activity, along with data that we use to determine if that modifier is actually active at any given point in time.
     *
     * @return $this
     */
     ...
     * Gets challenges
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityChallengeDefinition[]|null
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityUnlockStringDefinition[]|null
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyActivityUnlockStringDefinition[]|null $optionalUnlockStrings If there are status strings related to the activity and based on internal state of the game, account, or character, then this will be the definition of those strings and the states needed in order for the strings to be shown.
     *
     * @return $this
     */
     ...
     * Gets playlistItems
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityPlaylistItemDefinition[]|null
     */
     ...
     * Sets playlistItems
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyActivityPlaylistItemDefinition[]|null $playlistItems Represents all of the possible activities that could be played in the Playlist, along with information that we can use to determine if they are active at the present time.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityGraphListEntryDefinition[]|null
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyActivityGraphListEntryDefinition[]|null $activityGraphList Unfortunately, in practice this is almost never populated. In theory, this is supposed to tell which Activity Graph to show if you bring up the director while in this activity.
     *
     * @return $this
     */
     ...
     * Sets guidedGame
     *
     * @param DestinyDefinitionsDestinyActivityGuidedBlockDefinition|null $guidedGame This block of data, if it exists, provides information about the guided game experience and restrictions for this activity. If it doesn't exist, the game is not able to be played as a guided game.
     *
     * @return $this
     */
     ...
     * Gets loadouts
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityLoadoutRequirementSet[]|null
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyActivityInsertionPointDefinition[]|null
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyActivityInsertionPointDefinition[]|null $insertionPoints The list of phases or points of entry into an activity, along with information we can use to determine their gating and availability.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyConstantsDestinyEnvironmentLocationMapping[]|null
     */
     ...
     *
     * @param \Bungie\Model\DestinyConstantsDestinyEnvironmentLocationMapping[]|null $activityLocationMappings A list of location mappings that are affected by this activity. Pulled out of DestinyLocationDefinitions for our/your lookup convenience.
     *
     * @return $this
     */
