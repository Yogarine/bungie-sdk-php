 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyActivitiesDestinyPublicActivityStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Activities.DestinyPublicActivityStatus';
    ...
    protected static $swaggerTypes = [
        ...
        'modifierHashes' => 'int[]',
        'rewardTooltipItems' => '\Bungie\Model\DestinyDestinyItemQuantity[]'
    ];
     ...
     *
     * @param int[] $challengeObjectiveHashes Active Challenges for the activity, if any - represented as hashes for DestinyObjectiveDefinitions.
     *
     * @return $this
     */
     ...
     * Sets modifierHashes
     *
     * @param int[] $modifierHashes The active modifiers on this activity, if any - represented as hashes for DestinyActivityModifierDefinitions.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\DestinyDestinyItemQuantity[] $rewardTooltipItems If the activity itself provides any specific \"mock\" rewards, this will be the items and their quantity.  Why \"mock\", you ask? Because these are the rewards as they are represented in the tooltip of the Activity.  These are often pointers to fake items that look good in a tooltip, but represent an abstract concept of what you will get for a reward rather than the specific items you may obtain.
     *
     * @return $this
     */
