...
class DestinyResponsesDestinyCharacterResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets renderData
     *
     * @param SingleComponentResponseOfDestinyCharacterRenderComponent|null $renderData Character rendering data - a minimal set of information about equipment and dyes used for rendering.  COMPONENT TYPE: CharacterRenderData
     *
     * @return $this
     */
     ...
     *
     * @param SingleComponentResponseOfDestinyPresentationNodesComponent|null $presentationNodes COMPONENT TYPE: PresentationNodes
     *
     * @return $this
     */
     ...
     * Sets itemComponents
     *
     * @param DestinyItemComponentSetOfint64|null $itemComponents The set of components belonging to the player's instanced items.  COMPONENT TYPE: [See inside the DestinyItemComponentSet contract for component types.]
     *
     * @return $this
     */
     ...
     *
     * @param SingleComponentResponseOfDestinyCurrenciesComponent|null $currencyLookups A \"lookup\" convenience component that can be used to quickly check if the character has access to items that can be used for purchasing.  COMPONENT TYPE: CurrencyLookups
     *
     * @return $this
     */
