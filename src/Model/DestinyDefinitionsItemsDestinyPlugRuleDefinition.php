...
class DestinyDefinitionsItemsDestinyPlugRuleDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Items.DestinyPlugRuleDefinition';
     ...
     * Sets failureMessage
     *
     * @param string $failureMessage The localized string to show if this rule fails.
     *
     * @return $this
     */
