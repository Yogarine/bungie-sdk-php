...
class DestinyResponsesDestinyVendorResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets itemComponents
     *
     * @param DestinyItemComponentSetOfint32|null $itemComponents Item components, keyed by the vendorItemIndex of the active sale items.  COMPONENT TYPE: [See inside the DestinyItemComponentSet contract for component types.]
     *
     * @return $this
     */
