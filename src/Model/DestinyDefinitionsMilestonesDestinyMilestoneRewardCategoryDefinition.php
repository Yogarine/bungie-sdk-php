...
class DestinyDefinitionsMilestonesDestinyMilestoneRewardCategoryDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $displayProperties Hopefully this is obvious by now.
     *
     * @return $this
     */
     ...
     * Gets rewardEntries
     *
     * @return map[string,\Bungie\Model\DestinyDefinitionsMilestonesDestinyMilestoneRewardEntryDefinition]|null
     */
     ...
     * Sets rewardEntries
     *
     * @param map[string,\Bungie\Model\DestinyDefinitionsMilestonesDestinyMilestoneRewardEntryDefinition]|null $rewardEntries If this milestone can provide rewards, this will define the sets of rewards that can be earned, the conditions under which they can be acquired, internal data that we'll use at runtime to determine whether you've already earned or redeemed this set of rewards, and the category that this reward should be placed under.
     *
     * @return $this
     */
