...
class DestinyComponentsCollectiblesDestinyProfileCollectiblesComponent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Components.Collectibles.DestinyProfileCollectiblesComponent';
     ...
     *
     * @param int[] $recentCollectibleHashes The list of collectibles determined by the game as having been \"recently\" acquired.
     *
     * @return $this
     */
     ...
     * Gets collectibles
     *
     * @return map[string,\Bungie\Model\DestinyComponentsCollectiblesDestinyCollectibleComponent]
     */
     ...
     * Sets collectibles
     *
     * @param map[string,\Bungie\Model\DestinyComponentsCollectiblesDestinyCollectibleComponent] $collectibles collectibles
     *
     * @return $this
     */
