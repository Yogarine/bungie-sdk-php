...
class DestinyDefinitionsDestinyNodeStepDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyNodeStepDefinition';
     ...
     *
     * @param object $displayProperties These are the display properties actually used to render the Talent Node. The currently active step's displayProperties are shown.
     *
     * @return $this
     */
     ...
     * Sets nodeStepHash
     *
     * @param int $nodeStepHash The hash of this node step. Unfortunately, while it can be used to uniquely identify the step within a node, it is also content version dependent and should not be relied on without ensuring you have the latest vesion of content.
     *
     * @return $this
     */
     ...
     *
     * @param string $interactionDescription If you can interact with this node in some way, this is the localized description of that interaction.
     *
     * @return $this
     */
     ...
     * Sets damageType
     *
     * @param object $damageType An enum representing a damage type granted by activating this step, if any.
     *
     * @return $this
     */
     ...
     * Sets damageTypeHash
     *
     * @param int $damageTypeHash If the step provides a damage type, this will be the hash identifier used to look up the damage type's DestinyDamageTypeDefinition.
     *
     * @return $this
     */
     ...
     *
     * @param object $activationRequirement If the step has requirements for activation (they almost always do, if nothing else than for the Talent Grid's Progression to have reached a certain level), they will be defined here.
     *
     * @return $this
     */
     ...
     * Sets nextStepIndex
     *
     * @param int $nextStepIndex The stepIndex of the next step in the talent node, or -1 if this is the last step or if the next step to be chosen is random.  This doesn't really matter anymore unless canActivateNextStep begins to be used again.
     *
     * @return $this
     */
     ...
     *
     * @param bool $isNextStepRandom If true, the next step to be chosen is random, and if you're allowed to activate the next step. (if canActivateNextStep = true)
     *
     * @return $this
     */
     ...
     * Sets perkHashes
     *
     * @param int[] $perkHashes The list of hash identifiers for Perks (DestinySandboxPerkDefinition) that are applied when this step is active. Perks provide a variety of benefits and modifications - examine DestinySandboxPerkDefinition to learn more.
     *
     * @return $this
     */
     ...
     * Sets statHashes
     *
     * @param int[] $statHashes When the step provides stat benefits on the item or character, this is the list of hash identifiers for stats (DestinyStatDefinition) that are provided.
     *
     * @return $this
     */
     ...
     * Sets affectsQuality
     *
     * @param bool $affectsQuality If this is true, the step affects the item's Quality in some way. See DestinyInventoryItemDefinition for more information about the meaning of Quality. I already made a joke about Zen and the Art of Motorcycle Maintenance elsewhere in the documentation, so I will avoid doing it again. Oops too late
     *
     * @return $this
     */
     ...
     * Sets affectsLevel
     *
     * @param bool $affectsLevel If true, this step can affect the level of the item. See DestinyInventoryItemDefintion for more information about item levels and their effect on stats.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyNodeSocketReplaceResponse[]
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyNodeSocketReplaceResponse[] $socketReplacements If this step is activated, this will be a list of information used to replace socket items with new Plugs. See DestinyInventoryItemDefinition for more information about sockets and plugs.
     *
     * @return $this
     */
