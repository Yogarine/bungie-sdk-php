 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyMaterialRequirement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyMaterialRequirement';
     ...
     * Sets itemHash
     *
     * @param int $itemHash The hash identifier of the material required. Use it to look up the material's DestinyInventoryItemDefinition.
     *
     * @return $this
     */
     ...
     * Sets deleteOnAction
     *
     * @param bool $deleteOnAction If True, the material will be removed from the character's inventory when the action is performed.
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count The amount of the material required.
     *
     * @return $this
     */
     ...
     *
     * @param bool $omitFromRequirements If True, this requirement is \"silent\": don't bother showing it in a material requirements display. I mean, I'm not your mom: I'm not going to tell you you *can't* show it. But we won't show it in our UI.
     *
     * @return $this
     */
