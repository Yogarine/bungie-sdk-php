 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyFactionVendorDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyFactionVendorDefinition';
     ...
     * Sets vendorHash
     *
     * @param int $vendorHash The faction vendor hash.
     *
     * @return $this
     */
     ...
     *
     * @param int $destinationHash The hash identifier for a Destination at which this vendor may be located. Each destination where a Vendor may exist will only ever have a single entry.
     *
     * @return $this
     */
     ...
     *
     * @param string $backgroundImagePath The relative path to the background image representing this Vendor at this location, for use in a banner.
     *
     * @return $this
     */
