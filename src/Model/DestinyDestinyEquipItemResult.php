...
class DestinyDestinyEquipItemResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'itemInstanceId' => 'int',
        'equipStatus' => 'ExceptionsPlatformErrorCodes'
    ];
     ...
     * Sets equipStatus
     *
     * @param ExceptionsPlatformErrorCodes|null $equipStatus A PlatformErrorCodes enum indicating whether it succeeded, and if it failed why.
     *
     * @return $this
     */
