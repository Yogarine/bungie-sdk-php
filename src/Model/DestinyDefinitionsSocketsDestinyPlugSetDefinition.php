 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsSocketsDestinyPlugSetDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Sockets.DestinyPlugSetDefinition';
     ...
     *
     * @param object $displayProperties If you want to show these plugs in isolation, these are the display properties for them.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyItemSocketEntryPlugItemDefinition[] $reusablePlugItems This is a list of pre-determined plugs that can be plugged into this socket, without the character having the plug in their inventory.  If this list is populated, you will not be allowed to plug an arbitrary item in the socket: you will only be able to choose from one of these reusable plugs.
     *
     * @return $this
     */
