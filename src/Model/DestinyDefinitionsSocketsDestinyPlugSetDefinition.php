...
class DestinyDefinitionsSocketsDestinyPlugSetDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $displayProperties If you want to show these plugs in isolation, these are the display properties for them.
     *
     * @return $this
     */
