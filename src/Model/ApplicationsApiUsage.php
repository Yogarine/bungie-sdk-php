...
class ApplicationsApiUsage implements ModelInterface, ArrayAccess
{
     ...
     * Sets range
     *
     * @param DatesDateRange|null $range The date range for the data being reported.
     *
     * @return $this
     */
     ...
     * Gets apiCalls
     *
     * @return \Bungie\Model\ApplicationsSeries[]|null
     */
     ...
     * Sets apiCalls
     *
     * @param \Bungie\Model\ApplicationsSeries[]|null $apiCalls Counts for on API calls made for the time range.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\ApplicationsSeries[]|null $throttledRequests Instances of blocked requests or requests that crossed the warn threshold during the time range.
     *
     * @return $this
     */
