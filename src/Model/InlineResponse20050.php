 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20050 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Destiny\HistoricalStats\DestinyHistoricalStatsAccountResult',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Destiny\HistoricalStats\DestinyHistoricalStatsAccountResult|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Destiny\HistoricalStats\DestinyHistoricalStatsAccountResult|null $response response
     *
     * @return $this
     */
