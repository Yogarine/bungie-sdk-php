 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20047 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\map[string,\Bungie\Model\Destiny\HistoricalStats\Definitions\DestinyHistoricalStatsDefinition]',
     ...
     * Gets response
     *
     * @return \Bungie\Model\map[string,\Bungie\Model\Destiny\HistoricalStats\Definitions\DestinyHistoricalStatsDefinition]|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\map[string,\Bungie\Model\Destiny\HistoricalStats\Definitions\DestinyHistoricalStatsDefinition]|null $response response
     *
     * @return $this
     */
