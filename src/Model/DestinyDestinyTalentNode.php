 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDestinyTalentNode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.DestinyTalentNode';
    ...
    protected static $swaggerTypes = [
        ...
        'isActivated' => 'bool',
        'stepIndex' => 'int',
        'materialsToUpgrade' => '\Bungie\Model\DestinyDefinitionsDestinyMaterialRequirement[]',
     ...
     * Sets nodeIndex
     *
     * @param int $nodeIndex The index of the Talent Node being referred to (an index into DestinyTalentGridDefinition.nodes[]). CONTENT VERSION DEPENDENT.
     *
     * @return $this
     */
     ...
     * Sets nodeHash
     *
     * @param int $nodeHash The hash of the Talent Node being referred to (in DestinyTalentGridDefinition.nodes). Deceptively CONTENT VERSION DEPENDENT. We have no guarantee of the hash's immutability between content versions.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param object $state An DestinyTalentNodeState enum value indicating the node's state: whether it can be activated or swapped, and why not if neither can be performed.
     *
     * @return $this
     */
     ...
     * Sets isActivated
     *
     * @param bool $isActivated If true, the node is activated: it's current step then provides its benefits.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyMaterialRequirement[]
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyMaterialRequirement[] $materialsToUpgrade If the node has material requirements to be activated, this is the list of those requirements.
     *
     * @return $this
     */
     ...
     *
     * @param int $activationGridLevel The progression level required on the Talent Grid in order to be able to activate this talent node. Talent Grids have their own Progression - similar to Character Level, but in this case it is experience related to the item itself.
     *
     * @return $this
     */
     ...
     *
     * @param float $progressPercent If you want to show a progress bar or circle for how close this talent node is to being activate-able, this is the percentage to show. It follows the node's underlying rules about when the progress bar should first show up, and when it should be filled.
     *
     * @return $this
     */
     ...
     * Sets hidden
     *
     * @param bool $hidden Whether or not the talent node is actually visible in the game's UI. Whether you want to show it in your own UI is up to you! I'm not gonna tell you who to sock it to.
     *
     * @return $this
     */
     ...
     * Sets nodeStatsBlock
     *
     * @param object $nodeStatsBlock This property has some history. A talent grid can provide stats on both the item it's related to and the character equipping the item. This returns data about those stat bonuses.
     *
     * @return $this
     */
