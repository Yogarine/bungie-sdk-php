...
class DestinyDestinyTalentNode implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'nodeIndex' => 'int',
        'nodeHash' => 'int',
        'state' => 'DestinyDestinyTalentNodeState',
        'isActivated' => 'bool',
        'stepIndex' => 'int',
     ...
     * Gets state
     *
     * @return DestinyDestinyTalentNodeState|null
     */
     ...
     * Sets state
     *
     * @param DestinyDestinyTalentNodeState|null $state An DestinyTalentNodeState enum value indicating the node's state: whether it can be activated or swapped, and why not if neither can be performed.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyMaterialRequirement[]|null
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyMaterialRequirement[]|null $materialsToUpgrade If the node has material requirements to be activated, this is the list of those requirements.
     *
     * @return $this
     */
     ...
     * Sets nodeStatsBlock
     *
     * @param DestinyDestinyTalentNodeStatBlock|null $nodeStatsBlock This property has some history. A talent grid can provide stats on both the item it's related to and the character equipping the item. This returns data about those stat bonuses.
     *
     * @return $this
     */
