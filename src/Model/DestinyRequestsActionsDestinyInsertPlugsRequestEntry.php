...
class DestinyRequestsActionsDestinyInsertPlugsRequestEntry implements ModelInterface, ArrayAccess
{
     ...
     *
     * @return DestinyRequestsActionsDestinySocketArrayType|null
     */
     ...
     *
     * @param DestinyRequestsActionsDestinySocketArrayType|null $socketArrayType This property, combined with the socketIndex, tells us which socket we are referring to (since operations can be performed on both Intrinsic and \"default\" sockets, and they occupy different arrays in the Inventory Item Definition). I know, I know. Don't give me that look.
     *
     * @return $this
     */
