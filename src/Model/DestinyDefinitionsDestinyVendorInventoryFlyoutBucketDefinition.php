 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyVendorInventoryFlyoutBucketDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyVendorInventoryFlyoutBucketDefinition';
     ...
     * Sets collapsible
     *
     * @param bool $collapsible If true, the inventory bucket should be able to be collapsed visually.
     *
     * @return $this
     */
     ...
     *
     * @param int $inventoryBucketHash The inventory bucket whose contents should be shown.
     *
     * @return $this
     */
     ...
     * Sets sortItemsBy
     *
     * @param object $sortItemsBy The methodology to use for sorting items from the flyout.
     *
     * @return $this
     */
