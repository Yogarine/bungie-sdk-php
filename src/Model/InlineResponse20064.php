...
class InlineResponse20064 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\TrendingTrendingDetail',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\TrendingTrendingDetail|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\TrendingTrendingDetail|null $response response
     *
     * @return $this
     */
