...
class ContentTypeProperty implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        'name' => 'setName',
        'rootPropertyName' => 'setRootPropertyName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rootPropertyName'] = isset($data['rootPropertyName']) ? $data['rootPropertyName'] : null;
    ...
    /**
     * Gets rootPropertyName
     *
     * @return string|null
     */
    public function getRootPropertyName()
    {
        return $this->container['rootPropertyName'];
    }

    /**
     * Sets rootPropertyName
     *
     * @param string|null $rootPropertyName rootPropertyName
     *
     * @return $this
     */
    public function setRootPropertyName($rootPropertyName)
    {
        $this->container['rootPropertyName'] = $rootPropertyName;
