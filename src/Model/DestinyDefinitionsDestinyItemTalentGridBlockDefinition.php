...
class DestinyDefinitionsDestinyItemTalentGridBlockDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'buildName' => 'string',
        'hudDamageType' => 'DestinyDamageType',
        'hudIcon' => 'string'
    ];
     ...
     * Sets hudDamageType
     *
     * @param DestinyDamageType|null $hudDamageType If the talent grid implies a damage type, this is the enum value for that damage type.
     *
     * @return $this
     */
