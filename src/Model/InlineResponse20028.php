...
class InlineResponse20028 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\SearchResultOfGroupBan',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\SearchResultOfGroupBan|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\SearchResultOfGroupBan|null $response response
     *
     * @return $this
     */
