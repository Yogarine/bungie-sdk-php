...
class DestinyDefinitionsDestinyDestinationDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyActivityGraphListEntryDefinition[]|null $activityGraphEntries If the Destination has default Activity Graphs (i.e. \"Map\") that should be shown in the director, this is the list of those Graphs. At most, only one should be active at any given time for a Destination: these would represent, for example, different variants on a Map if the Destination is changing on a macro level based on game state.
     *
     * @return $this
     */
     ...
     * Gets bubbleSettings
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyDestinationBubbleSettingDefinition[]|null
     */
     ...
     * Gets bubbles
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyBubbleDefinition[]|null
     */
