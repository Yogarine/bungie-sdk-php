...
class DestinyEntitiesItemsDestinyItemTalentGridComponent implements ModelInterface, ArrayAccess
{
     ...
     * Gets nodes
     *
     * @return \Bungie\Model\DestinyDestinyTalentNode[]|null
     */
     ...
     *
     * @param DestinyDestinyProgression|null $gridProgression If the item has a progression, it will be detailed here. A progression means that the item can gain experience. Thresholds of experience are what determines whether and when a talent node can be activated.
     *
     * @return $this
     */
