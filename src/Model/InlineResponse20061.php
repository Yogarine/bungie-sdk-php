...
class InlineResponse20061 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Trending\TrendingCategories',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Trending\TrendingCategories|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Trending\TrendingCategories|null $response response
     *
     * @return $this
     */
