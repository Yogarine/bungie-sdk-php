...
class InlineResponse20061 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\SearchResultOfCommunityLiveStatus',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\SearchResultOfCommunityLiveStatus|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\SearchResultOfCommunityLiveStatus|null $response response
     *
     * @return $this
     */
