...
class DestinyDefinitionsDestinyRaceDefinition implements ModelInterface, ArrayAccess
{
     ...
     * Sets raceType
     *
     * @param DestinyDestinyRace|null $raceType An enumeration defining the existing, known Races/Species for player characters. This value will be the enum value matching this definition.
     *
     * @return $this
     */
