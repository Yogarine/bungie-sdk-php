...
class GroupsV2GroupResponse implements ModelInterface, ArrayAccess
{
     ...
     * Gets detail
     *
     * @return \Bungie\Model\GroupsV2GroupV2|null
     */
     ...
     * Sets detail
     *
     * @param \Bungie\Model\GroupsV2GroupV2|null $detail detail
     *
     * @return $this
     */
     ...
     * Gets founder
     *
     * @return \Bungie\Model\GroupsV2GroupMember|null
     */
     ...
     * Sets founder
     *
     * @param \Bungie\Model\GroupsV2GroupMember|null $founder founder
     *
     * @return $this
     */
     ...
     * Sets parentGroup
     *
     * @param \Bungie\Model\GroupsV2GroupV2|null $parentGroup parentGroup
     *
     * @return $this
     */
     ...
     * Gets allianceStatus
     *
     * @return \Bungie\Model\GroupsV2GroupAllianceStatus|null
     */
     ...
     * Sets allianceStatus
     *
     * @param \Bungie\Model\GroupsV2GroupAllianceStatus|null $allianceStatus allianceStatus
     *
     * @return $this
     */
     ...
     *
     * @return map[string,\Bungie\Model\GroupsV2GroupMember]|null
     */
     ...
     *
     * @param map[string,\Bungie\Model\GroupsV2GroupMember]|null $currentUserMemberMap This property will be populated if the authenticated user is a member of the group. Note that because of account linking, a user can sometimes be part of a clan more than once. As such, this returns the highest member type available.
     *
     * @return $this
     */
     ...
     *
     * @return map[string,\Bungie\Model\GroupsV2GroupPotentialMember]|null
     */
     ...
     *
     * @param map[string,\Bungie\Model\GroupsV2GroupPotentialMember]|null $currentUserPotentialMemberMap This property will be populated if the authenticated user is an applicant or has an outstanding invitation to join. Note that because of account linking, a user can sometimes be part of a clan more than once.
     *
     * @return $this
     */
