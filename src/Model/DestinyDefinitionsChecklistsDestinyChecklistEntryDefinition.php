...
class DestinyDefinitionsChecklistsDestinyChecklistEntryDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Checklists.DestinyChecklistEntryDefinition';
     ...
     * Sets hash
     *
     * @param int $hash The identifier for this Checklist entry. Guaranteed unique only within this Checklist Definition, and not globally/for all checklists.
     *
     * @return $this
     */
     ...
     *
     * @param object $displayProperties Even if no other associations exist, we will give you *something* for display properties. In cases where we have no associated entities, it may be as simple as a numerical identifier.
     *
     * @return $this
     */
     ...
     *
     * @param int $destinationHash destinationHash
     *
     * @return $this
     */
     ...
     * Sets locationHash
     *
     * @param int $locationHash locationHash
     *
     * @return $this
     */
     ...
     * Sets bubbleHash
     *
     * @param int $bubbleHash Note that a Bubble's hash doesn't uniquely identify a \"top level\" entity in Destiny. Only the combination of location and bubble can uniquely identify a place in the world of Destiny: so if bubbleHash is populated, locationHash must too be populated for it to have any meaning.  You can use this property if it is populated to look up the DestinyLocationDefinition's associated .locationReleases[].activityBubbleName property.
     *
     * @return $this
     */
     ...
     * Sets vendorHash
     *
     * @param int $vendorHash vendorHash
     *
     * @return $this
     */
     ...
     *
     * @param int $vendorInteractionIndex vendorInteractionIndex
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param object $scope The scope at which this specific entry can be computed.
     *
     * @return $this
     */
