...
class InlineResponse20051 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => 'map[string,\Bungie\Model\DestinyHistoricalStatsDestinyHistoricalStatsByPeriod]',
        'message' => 'string',
     ...
     * Sets response
     *
     * @param map[string,\Bungie\Model\DestinyHistoricalStatsDestinyHistoricalStatsByPeriod]|null $response response
     *
     * @return $this
     */
