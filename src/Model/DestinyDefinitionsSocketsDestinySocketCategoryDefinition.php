 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsSocketsDestinySocketCategoryDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Sockets.DestinySocketCategoryDefinition';
     ...
     *
     * @param int $uiCategoryStyle A string hinting to the game's UI system about how the sockets in this category should be displayed.  BNet doesn't use it: it's up to you to find valid values and make your own special UI if you want to honor this category style.
     *
     * @return $this
     */
     ...
     * Sets categoryStyle
     *
     * @param object $categoryStyle Same as uiCategoryStyle, but in a more usable enumeration form.
     *
     * @return $this
     */
