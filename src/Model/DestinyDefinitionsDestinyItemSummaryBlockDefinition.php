 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyItemSummaryBlockDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyItemSummaryBlockDefinition';
     ...
     * Sets sortPriority
     *
     * @param int $sortPriority Apparently when rendering an item in a reward, this should be used as a sort priority. We're not doing it presently.
     *
     * @return $this
     */
