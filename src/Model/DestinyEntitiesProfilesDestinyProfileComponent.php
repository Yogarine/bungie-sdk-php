 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyEntitiesProfilesDestinyProfileComponent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Entities.Profiles.DestinyProfileComponent';
     ...
     * Sets userInfo
     *
     * @param object $userInfo If you need to render the Profile (their platform name, icon, etc...) somewhere, this property contains that information.
     *
     * @return $this
     */
     ...
     * Sets dateLastPlayed
     *
     * @param \DateTime $dateLastPlayed The last time the user played with any character on this Profile.
     *
     * @return $this
     */
     ...
     * Sets versionsOwned
     *
     * @param object $versionsOwned If you want to know what expansions they own, this will contain that data.
     *
     * @return $this
     */
     ...
     * Sets characterIds
     *
     * @param int[] $characterIds A list of the character IDs, for further querying on your part.
     *
     * @return $this
     */
