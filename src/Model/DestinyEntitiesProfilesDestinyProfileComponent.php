...
class DestinyEntitiesProfilesDestinyProfileComponent implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'versionsOwned' => 'DestinyDestinyGameVersions',
        'characterIds' => 'int[]'
    ];
     ...
     * Sets userInfo
     *
     * @param UserUserInfoCard|null $userInfo If you need to render the Profile (their platform name, icon, etc...) somewhere, this property contains that information.
     *
     * @return $this
     */
     ...
     * Gets versionsOwned
     *
     * @return DestinyDestinyGameVersions|null
     */
     ...
     * Sets versionsOwned
     *
     * @param DestinyDestinyGameVersions|null $versionsOwned If you want to know what expansions they own, this will contain that data.
     *
     * @return $this
     */
