...
class DestinyDefinitionsDestinyItemActionRequiredItemDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyItemActionRequiredItemDefinition';
     ...
     * Sets count
     *
     * @param int $count The minimum quantity of the item you have to have.
     *
     * @return $this
     */
     ...
     * Sets itemHash
     *
     * @param int $itemHash The hash identifier of the item you need to have. Use it to look up the DestinyInventoryItemDefinition for more info.
     *
     * @return $this
     */
     ...
     * Sets deleteOnAction
     *
     * @param bool $deleteOnAction If true, the item/quantity will be deleted from your inventory when the action is performed. Otherwise, you'll retain these required items after the action is complete.
     *
     * @return $this
     */
