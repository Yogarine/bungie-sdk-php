 ...
 * @link     https://openapi-generator.tech
 */
class DestinyAdvancedAwaUserResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets selection
     *
     * @param DestinyAdvancedAwaUserSelection|null $selection Indication of the selection the user has made (Approving or rejecting the action)
     *
     * @return $this
     */
