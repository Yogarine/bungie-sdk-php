...
class DestinyEntitiesVendorsDestinyVendorSaleItemComponent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Entities.Vendors.DestinyVendorSaleItemComponent';
     ...
     *
     * @param int $vendorItemIndex The index into the DestinyVendorDefinition.itemList property. Note that this means Vendor data *is* Content Version dependent: make sure you have the latest content before you use Vendor data, or these indexes may mismatch.   Most systems avoid this problem, but Vendors is one area where we are unable to reasonably avoid content dependency at the moment.
     *
     * @return $this
     */
     ...
     * Sets itemHash
     *
     * @param int $itemHash The hash of the item being sold, as a quick shortcut for looking up the DestinyInventoryItemDefinition of the sale item.
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param int $quantity How much of the item you'll be getting.
     *
     * @return $this
     */
     ...
     * Sets saleStatus
     *
     * @param object $saleStatus A flag indicating whether the requesting character can buy the item, and if not the reasons why the character can't buy it.
     *
     * @return $this
     */
     ...
     * Sets costs
     *
     * @param \Bungie\Model\DestinyDestinyItemQuantity[] $costs A summary of the current costs of the item.
     *
     * @return $this
     */
     ...
     * Gets unlockStatuses
     *
     * @return \Bungie\Model\DestinyDestinyUnlockStatus[]
     */
     ...
     * Sets failureIndexes
     *
     * @param int[] $failureIndexes Indexes in to the \"failureStrings\" lookup table in DestinyVendorDefinition for the given Vendor. Gives some more reliable failure information for why you can't purchase an item.  It is preferred to use these over requiredUnlocks and unlockStatuses: the latter are provided mostly in case someone can do something interesting with it that I didn't anticipate.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $overrideNextRefreshDate If this item has its own custom date where it may be removed from the Vendor's rotation, this is that date.  Note that there's not actually any guarantee that it will go away: it could be chosen again and end up still being in the Vendor's sale items! But this is the next date where that test will occur, and is also the date that the game shows for availability on things like Bounties being sold. So it's the best we can give.
     *
     * @return $this
     */
