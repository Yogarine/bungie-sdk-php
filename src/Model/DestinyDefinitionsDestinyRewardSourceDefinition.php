...
class DestinyDefinitionsDestinyRewardSourceDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyRewardSourceDefinition';
     ...
     * Sets category
     *
     * @param object $category Sources are grouped into categories: common ways that items are provided. I hope to see this expand in Destiny 2 once we have time to generate accurate reward source data.
     *
     * @return $this
     */
