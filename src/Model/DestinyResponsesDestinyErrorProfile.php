...
class DestinyResponsesDestinyErrorProfile implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Responses.DestinyErrorProfile';
     ...
     * Sets errorCode
     *
     * @param object $errorCode The error that we encountered. You should be able to look up localized text to show to the user for these failures.
     *
     * @return $this
     */
     ...
     * Sets infoCard
     *
     * @param object $infoCard Basic info about the account that failed. Don't expect anything other than membership ID, Membership Type, and displayName to be populated.
     *
     * @return $this
     */
