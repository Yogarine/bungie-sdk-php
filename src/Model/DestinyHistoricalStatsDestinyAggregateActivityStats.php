...
class DestinyHistoricalStatsDestinyAggregateActivityStats implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.HistoricalStats.DestinyAggregateActivityStats';
     ...
     * Sets activityHash
     *
     * @param int $activityHash Hash ID that can be looked up in the DestinyActivityTable.
     *
     * @return $this
     */
