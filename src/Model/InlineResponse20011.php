 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20011 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\SearchResultOfContentItemPublicContract',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\SearchResultOfContentItemPublicContract|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\SearchResultOfContentItemPublicContract|null $response response
     *
     * @return $this
     */
