...
class DestinyItemType
{
    ...
    const DESTINY_ITEM_TYPE_SEASONALARTIFACT = 28;
    const DESTINY_ITEM_TYPE_FINISHER = 29;
    const DESTINY_ITEM_TYPE_PATTERN = 30;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::DESTINY_ITEM_TYPE_SEASONALARTIFACT,
            self::DESTINY_ITEM_TYPE_FINISHER,
            self::DESTINY_ITEM_TYPE_PATTERN,
        ];
    }
}
