...
class DestinyItemPlugDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'isPseudoPlug' => 'bool',
        'plugAvailability' => '\Bungie\Model\Destiny\PlugAvailabilityMode',
        'alternateUiPlugLabel' => 'string',
        'alternatePlugStyle' => '\Bungie\Model\Destiny\PlugUiStyles',
        'isDummyPlug' => 'bool',
     ...
     * Gets plugStyle
     *
     * @return \Bungie\Model\Destiny\PlugUiStyles|null
     */
     ...
     * Sets plugStyle
     *
     * @param \Bungie\Model\Destiny\PlugUiStyles|null $plugStyle plugStyle
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\Destiny\PlugAvailabilityMode|null
     */
     ...
     *
     * @param \Bungie\Model\Destiny\PlugAvailabilityMode|null $plugAvailability Indicates the rules about when this plug can be used. See the PlugAvailabilityMode enumeration for more information!
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\Destiny\PlugUiStyles|null $alternatePlugStyle The alternate plug of the plug: only applies when the item is in states that only the server can know about and control, unfortunately. See AlternateUiPlugLabel for the related label info.
     *
     * @return $this
     */
