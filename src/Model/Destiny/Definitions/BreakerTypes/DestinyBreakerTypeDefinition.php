...
namespace Bungie\Model\Destiny\Definitions\BreakerTypes;

use \ArrayAccess;
use \Bungie\ObjectSerializer;

/**
 * DestinyBreakerTypeDefinition Class Doc Comment
 *
 * @category Class
 * @package  Bungie
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DestinyBreakerTypeDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets enumValue
     *
     * @param int|null $enumValue We have an enumeration for Breaker types for quick reference. This is the current definition's breaker type enum value.
     *
     * @return $this
     */
