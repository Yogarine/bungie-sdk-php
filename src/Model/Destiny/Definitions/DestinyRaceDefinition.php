...
class DestinyRaceDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets raceType
     *
     * @param \Bungie\Model\Destiny\DestinyRace|null $raceType An enumeration defining the existing, known Races/Species for player characters. This value will be the enum value matching this definition.
     *
     * @return $this
     */
