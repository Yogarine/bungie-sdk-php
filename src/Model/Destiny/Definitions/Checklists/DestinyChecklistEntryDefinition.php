 ...
 * @link     https://openapi-generator.tech
 */
class DestinyChecklistEntryDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Bungie\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition|null $displayProperties Even if no other associations exist, we will give you *something* for display properties. In cases where we have no associated entities, it may be as simple as a numerical identifier.
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param \Bungie\Model\Destiny\DestinyScope|null $scope The scope at which this specific entry can be computed.
     *
     * @return $this
     */
