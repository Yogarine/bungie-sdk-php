...
class DestinyMilestoneDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['displayPreference'] = isset($data['displayPreference']) ? $data['displayPreference'] : null;
     ...
     *
     * @param int|null $displayPreference A hint to the UI to indicate what to show as the display properties for this Milestone when showing \"Live\" milestone data. Feel free to show more than this if desired: this hint is meant to simplify our own UI, but it may prove useful to you as well.
     *
     * @return $this
     */
