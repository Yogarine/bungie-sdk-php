...
class DestinyItemSetBlockDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPIFormats = [
        ...
        'setType' => null,
        'questLineName' => null,
        'questLineDescription' => null,
        'questStepSummary' => null
    ];
    ...
    protected static $setters = [
        ...
        'setType' => 'setSetType',
        'questLineName' => 'setQuestLineName',
        'questLineDescription' => 'setQuestLineDescription',
        'questStepSummary' => 'setQuestStepSummary'
    ];
    ...
    protected static $getters = [
        ...
        'setType' => 'getSetType',
        'questLineName' => 'getQuestLineName',
        'questLineDescription' => 'getQuestLineDescription',
        'questStepSummary' => 'getQuestStepSummary'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['questLineName'] = isset($data['questLineName']) ? $data['questLineName'] : null;
        $this->container['questLineDescription'] = isset($data['questLineDescription']) ? $data['questLineDescription'] : null;
        $this->container['questStepSummary'] = isset($data['questStepSummary']) ? $data['questStepSummary'] : null;
    }
    ...
    {
        return $this->container['questLineName'];
    }

    /**
     * Sets questLineName
     *
     * @param string|null $questLineName The name of the quest line that this quest step is a part of.
     *
     * @return $this
     */
    public function setQuestLineName($questLineName)
    {
        $this->container['questLineName'] = $questLineName;

        return $this;
    }

    /**
     * Gets questLineDescription
     *
     * @return string|null
     */
    public function getQuestLineDescription()
    {
        return $this->container['questLineDescription'];
    }

    /**
     * Sets questLineDescription
     *
     * @param string|null $questLineDescription The description of the quest line that this quest step is a part of.
     *
     * @return $this
     */
    public function setQuestLineDescription($questLineDescription)
    {
        $this->container['questLineDescription'] = $questLineDescription;

        return $this;
    }

    /**
     * Gets questStepSummary
     *
     * @return string|null
     */
    public function getQuestStepSummary()
    {
        return $this->container['questStepSummary'];
    }

    /**
     * Sets questStepSummary
     *
     * @param string|null $questStepSummary An additional summary of this step in the quest line.
     *
     * @return $this
     */
    public function setQuestStepSummary($questStepSummary)
    {
        $this->container['questStepSummary'] = $questStepSummary;
