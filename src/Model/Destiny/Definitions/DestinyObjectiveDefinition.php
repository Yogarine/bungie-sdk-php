...
class DestinyObjectiveDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'completionValue' => 'int',
        'scope' => '\Bungie\Model\Destiny\DestinyGatingScope',
        'locationHash' => 'int',
        'allowNegativeValue' => 'bool',
        'allowValueChangeWhenCompleted' => 'bool',
        'isCountingDownward' => 'bool',
        'valueStyle' => '\Bungie\Model\Destiny\DestinyUnlockValueUIStyle',
        ...
        'completedValueStyle' => '\Bungie\Model\Destiny\DestinyUnlockValueUIStyle',
        'inProgressValueStyle' => '\Bungie\Model\Destiny\DestinyUnlockValueUIStyle',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     * Gets scope
     *
     * @return \Bungie\Model\Destiny\DestinyGatingScope|null
     */
     ...
     * Sets scope
     *
     * @param \Bungie\Model\Destiny\DestinyGatingScope|null $scope A shortcut for determining the most restrictive gating that this Objective is set to use. This includes both the dynamic determination of progress and of completion values. See the DestinyGatingScope enum's documentation for more details.
     *
     * @return $this
     */
     ...
     * Gets valueStyle
     *
     * @return \Bungie\Model\Destiny\DestinyUnlockValueUIStyle|null
     */
     ...
     * Sets valueStyle
     *
     * @param \Bungie\Model\Destiny\DestinyUnlockValueUIStyle|null $valueStyle The UI style applied to the objective. It's an enum, take a look at DestinyUnlockValueUIStyle for details of the possible styles. Use this info as you wish to customize your UI.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\Destiny\DestinyUnlockValueUIStyle|null $completedValueStyle The style to use when the objective is completed.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\Destiny\DestinyUnlockValueUIStyle|null $inProgressValueStyle The style to use when the objective is still in progress.
     *
     * @return $this
     */
