...
class DestinyObjectiveDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['uiLabel'] = isset($data['uiLabel']) ? $data['uiLabel'] : null;
        $this->container['uiStyle'] = isset($data['uiStyle']) ? $data['uiStyle'] : null;
     ...
     * Sets valueStyle
     *
     * @param int|null $valueStyle The UI style applied to the objective. It's an enum, take a look at DestinyUnlockValueUIStyle for details of the possible styles. Use this info as you wish to customize your UI.  DEPRECATED: This is no longer populated by Destiny 2 game content. Please use inProgressValueStyle and completedValueStyle instead.
     *
     * @return $this
     */
    ...
    {
        return $this->container['uiLabel'];
    }

    /**
     * Sets uiLabel
     *
     * @param string|null $uiLabel Objectives can have arbitrary UI-defined identifiers that define the style applied to objectives. For convenience, known UI labels will be defined in the uiStyle enum value.
     *
     * @return $this
     */
    public function setUiLabel($uiLabel)
    {
        $this->container['uiLabel'] = $uiLabel;
    ...
    {
        return $this->container['uiStyle'];
    }

    /**
     * Sets uiStyle
     *
     * @param int|null $uiStyle If the objective has a known UI label value, this property will represent it.
     *
     * @return $this
     */
    public function setUiStyle($uiStyle)
    {
        $this->container['uiStyle'] = $uiStyle;
