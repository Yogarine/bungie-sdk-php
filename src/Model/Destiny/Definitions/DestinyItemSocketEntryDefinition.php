...
class DestinyItemSocketEntryDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'randomizedPlugSetHash' => 'setRandomizedPlugSetHash',
    ...
    protected static $getters = [
        ...
        'randomizedPlugSetHash' => 'getRandomizedPlugSetHash',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['randomizedPlugSetHash'] = isset($data['randomizedPlugSetHash']) ? $data['randomizedPlugSetHash'] : null;
    ...
    /**
     * Gets randomizedPlugSetHash
     *
     * @return int|null
     */
    public function getRandomizedPlugSetHash()
    {
        return $this->container['randomizedPlugSetHash'];
    }

    /**
     * Sets randomizedPlugSetHash
     *
     * @param int|null $randomizedPlugSetHash This field replaces \"randomizedPlugItems\" as of Shadowkeep launch. If a socket has randomized plugs, this is a pointer to the set of plugs that could be used, as defined in DestinyPlugSetDefinition.   If null, the item has no randomized plugs.
     *
     * @return $this
     */
    public function setRandomizedPlugSetHash($randomizedPlugSetHash)
    {
        $this->container['randomizedPlugSetHash'] = $randomizedPlugSetHash;
