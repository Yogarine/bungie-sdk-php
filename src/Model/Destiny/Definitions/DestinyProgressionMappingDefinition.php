...
/**
 * DestinyProgressionMappingDefinition Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyProgressionMappingDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['displayUnits'] = isset($data['displayUnits']) ? $data['displayUnits'] : null;
     ...
     *
     * @param \Bungie\Model\Destiny\Definitions\Common\DestinyDisplayPropertiesDefinition|null $displayProperties Infrequently defined in practice. Defer to the individual progressions' display properties.
     *
     * @return $this
     */
    ...
    {
        return $this->container['displayUnits'];
    }

    /**
     * Sets displayUnits
     *
     * @param string|null $displayUnits The localized unit of measurement for progression across the progressions defined in this mapping. Unfortunately, this is very infrequently defined. Defer to the individual progressions' display units.
     *
     * @return $this
     */
    public function setDisplayUnits($displayUnits)
    {
        $this->container['displayUnits'] = $displayUnits;
