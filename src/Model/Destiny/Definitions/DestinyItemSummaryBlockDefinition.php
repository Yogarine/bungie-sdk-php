...
/**
 * DestinyItemSummaryBlockDefinition Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyItemSummaryBlockDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets sortPriority
     *
     * @param int|null $sortPriority Apparently when rendering an item in a reward, this should be used as a sort priority. We're not doing it presently.
     *
     * @return $this
     */
