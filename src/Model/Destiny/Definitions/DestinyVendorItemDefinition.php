...
class DestinyVendorItemDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'visibilityScope' => '\Bungie\Model\Destiny\DestinyGatingScope',
        'purchasableScope' => '\Bungie\Model\Destiny\DestinyGatingScope',
        'exclusivity' => '\Bungie\Model\BungieMembershipType',
        'isOffer' => 'bool',
        'isCrm' => 'bool',
        'sortValue' => 'int',
     ...
     * Sets refundPolicy
     *
     * @param \Bungie\Model\Destiny\DestinyVendorItemRefundPolicy|null $refundPolicy If this item can be refunded, this is the policy for what will be refundd, how, and in what time period.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\Destiny\DestinyGatingScope|null $visibilityScope The most restrictive scope that determines whether the item is available in the Vendor's inventory. See DestinyGatingScope's documentation for more information.  This can be determined by Unlock gating, or by whether or not the item has purchase level requirements (minimumLevel and maximumLevel properties).
     *
     * @return $this
     */
     ...
     * Sets exclusivity
     *
     * @param \Bungie\Model\BungieMembershipType|null $exclusivity If this item can only be purchased by a given platform, this indicates the platform to which it is restricted.
     *
     * @return $this
     */
