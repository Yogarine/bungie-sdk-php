...
class DestinyInventoryItemDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     *
     * @return \Bungie\Model\Destiny\SpecialItemType|null
     */
     ...
     *
     * @param \Bungie\Model\Destiny\SpecialItemType|null $specialItemType In Destiny 1, we identified some items as having particular categories that we'd like to know about for various internal logic purposes. These are defined in SpecialItemType, and while these days the itemCategoryHashes are the preferred way of identifying types, we have retained this enum for its convenience.
     *
     * @return $this
     */
     ...
     * Sets itemType
     *
     * @param \Bungie\Model\Destiny\DestinyItemType|null $itemType A value indicating the \"base\" the of the item. This enum is a useful but dramatic oversimplification of what it means for an item to have a \"Type\". Still, it's handy in many situations.  itemCategoryHashes are the preferred way of identifying types, we have retained this enum for its convenience.
     *
     * @return $this
     */
     ...
     *
     * @param \Bungie\Model\Destiny\DamageType|null $defaultDamageType If the item has a damage type that could be considered to be default, it will be populated here.  For various upsetting reasons, it's surprisingly cumbersome to figure this out. I hope you're happy.
     *
     * @return $this
     */
