...
class DestinyVendorInteractionReplyDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     *
     * @param int|null $itemRewardsSelection The rewards granted upon responding to the vendor.
     *
     * @return $this
     */
     ...
     * Sets replyType
     *
     * @param int|null $replyType An enum indicating the type of reply being made.
     *
     * @return $this
     */
