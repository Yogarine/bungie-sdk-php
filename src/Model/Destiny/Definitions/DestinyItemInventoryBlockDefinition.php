...
class DestinyItemInventoryBlockDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'recipeItemHash' => 'setRecipeItemHash'
    ];
    ...
    protected static $getters = [
        ...
        'recipeItemHash' => 'getRecipeItemHash'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['recipeItemHash'] = isset($data['recipeItemHash']) ? $data['recipeItemHash'] : null;
    }
     ...
     * @return int|null
     */
    public function getRecipeItemHash()
    {
        return $this->container['recipeItemHash'];
    }

    /**
     * Sets recipeItemHash
     *
     * @param int|null $recipeItemHash A reference to the associated crafting 'recipe' item definition, if this item can be crafted.
     *
     * @return $this
     */
    public function setRecipeItemHash($recipeItemHash)
    {
        $this->container['recipeItemHash'] = $recipeItemHash;
