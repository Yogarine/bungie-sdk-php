...
class DestinyGenderDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets genderType
     *
     * @param \Bungie\Model\Destiny\DestinyGender|null $genderType This is a quick reference enumeration for all of the currently defined Genders. We use the enumeration for quicker lookups in related data, like DestinyClassDefinition.genderedClassNames.
     *
     * @return $this
     */
