...
namespace Bungie\Model\Destiny\Definitions\PowerCaps;

use \ArrayAccess;
use \Bungie\ObjectSerializer;

/**
 * DestinyPowerCapDefinition Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyPowerCapDefinition implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['powerCap'] = isset($data['powerCap']) ? $data['powerCap'] : null;
    ...
    {
        return $this->container['powerCap'];
    }

    /**
     * Sets powerCap
     *
     * @param int|null $powerCap The raw value for a power cap.
     *
     * @return $this
     */
    public function setPowerCap($powerCap)
    {
        $this->container['powerCap'] = $powerCap;
