...
class DestinyComponentType
{
    ...
    const DESTINY_COMPONENT_TYPE_ITEMPLUGOBJECTIVES = 309;
    const DESTINY_COMPONENT_TYPE_ITEMREUSABLEPLUGS = 310;
    ...
    const DESTINY_COMPONENT_TYPE_METRICS = 1100;
    const DESTINY_COMPONENT_TYPE_STRINGVARIABLES = 1200;
    const DESTINY_COMPONENT_TYPE_CRAFTABLES = 1300;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::DESTINY_COMPONENT_TYPE_ITEMPLUGOBJECTIVES,
            self::DESTINY_COMPONENT_TYPE_ITEMREUSABLEPLUGS,
            ...
            self::DESTINY_COMPONENT_TYPE_METRICS,
            self::DESTINY_COMPONENT_TYPE_STRINGVARIABLES,
            self::DESTINY_COMPONENT_TYPE_CRAFTABLES,
        ];
    }
}
