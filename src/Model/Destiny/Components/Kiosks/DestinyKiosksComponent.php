...
class DestinyKiosksComponent implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'kioskItems' => '\Bungie\Model\map[string,\Bungie\Model\\Bungie\Model\Destiny\Components\Kiosks\DestinyKioskItem[]]'
    ];
     ...
     * Gets kioskItems
     *
     * @return \Bungie\Model\map[string,\Bungie\Model\\Bungie\Model\Destiny\Components\Kiosks\DestinyKioskItem[]]|null
     */
     ...
     * Sets kioskItems
     *
     * @param \Bungie\Model\map[string,\Bungie\Model\\Bungie\Model\Destiny\Components\Kiosks\DestinyKioskItem[]]|null $kioskItems A dictionary keyed by the Kiosk Vendor's hash identifier (use it to look up the DestinyVendorDefinition for the relevant kiosk vendor), and whose value is a list of all the items that the user can \"see\" in the Kiosk, and any other interesting metadata.
     *
     * @return $this
     */
