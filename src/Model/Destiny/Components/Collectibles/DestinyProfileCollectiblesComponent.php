...
class DestinyProfileCollectiblesComponent implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPIFormats = [
        ...
        'collectibles' => null,
        'collectionCategoriesRootNodeHash' => 'uint32',
        'collectionBadgesRootNodeHash' => 'uint32'
    ];
    ...
    protected static $setters = [
        ...
        'collectionCategoriesRootNodeHash' => 'setCollectionCategoriesRootNodeHash',
        'collectionBadgesRootNodeHash' => 'setCollectionBadgesRootNodeHash'
    ];
    ...
    protected static $getters = [
        ...
        'collectionCategoriesRootNodeHash' => 'getCollectionCategoriesRootNodeHash',
        'collectionBadgesRootNodeHash' => 'getCollectionBadgesRootNodeHash'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['collectionCategoriesRootNodeHash'] = isset($data['collectionCategoriesRootNodeHash']) ? $data['collectionCategoriesRootNodeHash'] : null;
        $this->container['collectionBadgesRootNodeHash'] = isset($data['collectionBadgesRootNodeHash']) ? $data['collectionBadgesRootNodeHash'] : null;
    }
    ...
    /**
     * Gets collectionCategoriesRootNodeHash
     *
     * @return int|null
     */
    public function getCollectionCategoriesRootNodeHash()
    {
        return $this->container['collectionCategoriesRootNodeHash'];
    }

    /**
     * Sets collectionCategoriesRootNodeHash
     *
     * @param int|null $collectionCategoriesRootNodeHash The hash for the root presentation node definition of Collection categories.
     *
     * @return $this
     */
    public function setCollectionCategoriesRootNodeHash($collectionCategoriesRootNodeHash)
    {
        $this->container['collectionCategoriesRootNodeHash'] = $collectionCategoriesRootNodeHash;

        return $this;
    }

    /**
     * Gets collectionBadgesRootNodeHash
     *
     * @return int|null
     */
    public function getCollectionBadgesRootNodeHash()
    {
        return $this->container['collectionBadgesRootNodeHash'];
    }

    /**
     * Sets collectionBadgesRootNodeHash
     *
     * @param int|null $collectionBadgesRootNodeHash The hash for the root presentation node definition of Collection Badges.
     *
     * @return $this
     */
    public function setCollectionBadgesRootNodeHash($collectionBadgesRootNodeHash)
    {
        $this->container['collectionBadgesRootNodeHash'] = $collectionBadgesRootNodeHash;
