...
/**
 * DestinyItemReusablePlugsComponent Class Doc Comment
 *
 * @category Class
 * @package  Bungie
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DestinyItemReusablePlugsComponent implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'plugs' => 'map[string,\Bungie\Model\Destiny\Sockets\DestinyItemPlugBase[]]'
    ];
     ...
     * Gets plugs
     *
     * @return map[string,\Bungie\Model\Destiny\Sockets\DestinyItemPlugBase[]]|null
     */
