...
class DestinyTalentNode implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Gets state
     *
     * @return \Bungie\Model\Destiny\DestinyTalentNodeState|null
     */
     ...
     * Sets state
     *
     * @param \Bungie\Model\Destiny\DestinyTalentNodeState|null $state An DestinyTalentNodeState enum value indicating the node's state: whether it can be activated or swapped, and why not if neither can be performed.
     *
     * @return $this
     */
