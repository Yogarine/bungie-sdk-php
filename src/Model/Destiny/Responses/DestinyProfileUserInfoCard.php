...
class DestinyProfileUserInfoCard implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    const UNPAIRED_GAME_VERSIONS_BEYONDLIGHT = 64;
    const UNPAIRED_GAME_VERSIONS_ANNIVERSARY30TH = 128;
    const UNPAIRED_GAME_VERSIONS_THEWITCHQUEEN = 256;
    const UNPAIRED_GAME_VERSIONS_LIGHTFALL = 512;
    ...
    public function getUnpairedGameVersionsAllowableValues()
    {
        return [
            ...
            self::UNPAIRED_GAME_VERSIONS_BEYONDLIGHT,
            self::UNPAIRED_GAME_VERSIONS_ANNIVERSARY30TH,
            self::UNPAIRED_GAME_VERSIONS_THEWITCHQUEEN,
            self::UNPAIRED_GAME_VERSIONS_LIGHTFALL,
        ];
    }
