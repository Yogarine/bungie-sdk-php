...
/**
 * DestinyErrorProfile Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyErrorProfile implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'infoCard' => '\Bungie\Model\User\UserInfoCard'
    ];
     ...
     * Sets errorCode
     *
     * @param \Bungie\Model\Exceptions\PlatformErrorCodes|null $errorCode The error that we encountered. You should be able to look up localized text to show to the user for these failures.
     *
     * @return $this
     */
     ...
     * Sets infoCard
     *
     * @param \Bungie\Model\User\UserInfoCard|null $infoCard Basic info about the account that failed. Don't expect anything other than membership ID, Membership Type, and displayName to be populated.
     *
     * @return $this
     */
