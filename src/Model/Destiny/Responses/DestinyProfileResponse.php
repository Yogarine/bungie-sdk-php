...
class DestinyProfileResponse implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'responseMintedTimestamp' => '\DateTime',
        'secondaryComponentsMintedTimestamp' => '\DateTime',
        ...
        'profileStringVariables' => '\Bungie\Model\SingleComponentResponseOfDestinyStringVariablesComponent',
        ...
        'characterStringVariables' => '\Bungie\Model\DictionaryComponentResponseOfint64AndDestinyStringVariablesComponent',
        'characterCraftables' => '\Bungie\Model\DictionaryComponentResponseOfint64AndDestinyCraftablesComponent',
    ...
    protected static $openAPIFormats = [
        'responseMintedTimestamp' => 'date-time',
        'secondaryComponentsMintedTimestamp' => 'date-time',
        'vendorReceipts' => null,
        ...
        'characterStringVariables' => null,
        'characterCraftables' => null,
        'itemComponents' => null,
    ...
    protected static $attributeMap = [
        'responseMintedTimestamp' => 'responseMintedTimestamp',
        'secondaryComponentsMintedTimestamp' => 'secondaryComponentsMintedTimestamp',
        ...
        'characterCraftables' => 'characterCraftables',
    ...
    protected static $setters = [
        'responseMintedTimestamp' => 'setResponseMintedTimestamp',
        'secondaryComponentsMintedTimestamp' => 'setSecondaryComponentsMintedTimestamp',
        ...
        'metrics' => 'setMetrics',
        'profileStringVariables' => 'setProfileStringVariables',
        ...
        'characterStringVariables' => 'setCharacterStringVariables',
        'characterCraftables' => 'setCharacterCraftables',
    ...
    protected static $getters = [
        'responseMintedTimestamp' => 'getResponseMintedTimestamp',
        'secondaryComponentsMintedTimestamp' => 'getSecondaryComponentsMintedTimestamp',
        ...
        'metrics' => 'getMetrics',
        'profileStringVariables' => 'getProfileStringVariables',
        ...
        'characterStringVariables' => 'getCharacterStringVariables',
        'characterCraftables' => 'getCharacterCraftables',
    ...
    {
        $this->container['responseMintedTimestamp'] = isset($data['responseMintedTimestamp']) ? $data['responseMintedTimestamp'] : null;
        $this->container['secondaryComponentsMintedTimestamp'] = isset($data['secondaryComponentsMintedTimestamp']) ? $data['secondaryComponentsMintedTimestamp'] : null;
        ...
        $this->container['profileStringVariables'] = isset($data['profileStringVariables']) ? $data['profileStringVariables'] : null;
        ...
        $this->container['characterStringVariables'] = isset($data['characterStringVariables']) ? $data['characterStringVariables'] : null;
        $this->container['characterCraftables'] = isset($data['characterCraftables']) ? $data['characterCraftables'] : null;
    ...
    /**
     * Gets responseMintedTimestamp
     *
     * @return \DateTime|null
     */
    public function getResponseMintedTimestamp()
    {
        return $this->container['responseMintedTimestamp'];
    }

    /**
     * Sets responseMintedTimestamp
     *
     * @param \DateTime|null $responseMintedTimestamp Records the timestamp of when most components were last generated from the world server source. Unless the component type is specified in the documentation for secondaryComponentsMintedTimestamp, this value is sufficient to do data freshness.
     *
     * @return $this
     */
    public function setResponseMintedTimestamp($responseMintedTimestamp)
    {
        $this->container['responseMintedTimestamp'] = $responseMintedTimestamp;

        return $this;
    }

    /**
     * Gets secondaryComponentsMintedTimestamp
     *
     * @return \DateTime|null
     */
    public function getSecondaryComponentsMintedTimestamp()
    {
        return $this->container['secondaryComponentsMintedTimestamp'];
    }

    /**
     * Sets secondaryComponentsMintedTimestamp
     *
     * @param \DateTime|null $secondaryComponentsMintedTimestamp Some secondary components are not tracked in the primary response timestamp and have their timestamp tracked here. If your component is any of the following, this field is where you will find your timestamp value:   PresentationNodes, Records, Collectibles, Metrics, StringVariables, Craftables, Transitory   All other component types may use the primary timestamp property.
     *
     * @return $this
     */
    public function setSecondaryComponentsMintedTimestamp($secondaryComponentsMintedTimestamp)
    {
        $this->container['secondaryComponentsMintedTimestamp'] = $secondaryComponentsMintedTimestamp;
    ...
    /**
     * Gets profileStringVariables
     *
     * @return \Bungie\Model\SingleComponentResponseOfDestinyStringVariablesComponent|null
     */
    public function getProfileStringVariables()
    {
        return $this->container['profileStringVariables'];
    }

    /**
     * Sets profileStringVariables
     *
     * @param \Bungie\Model\SingleComponentResponseOfDestinyStringVariablesComponent|null $profileStringVariables COMPONENT TYPE: StringVariables
     *
     * @return $this
     */
    public function setProfileStringVariables($profileStringVariables)
    {
        $this->container['profileStringVariables'] = $profileStringVariables;
    ...
    /**
     * Gets characterStringVariables
     *
     * @return \Bungie\Model\DictionaryComponentResponseOfint64AndDestinyStringVariablesComponent|null
     */
    public function getCharacterStringVariables()
    {
        return $this->container['characterStringVariables'];
    }

    /**
     * Sets characterStringVariables
     *
     * @param \Bungie\Model\DictionaryComponentResponseOfint64AndDestinyStringVariablesComponent|null $characterStringVariables COMPONENT TYPE: StringVariables
     *
     * @return $this
     */
    public function setCharacterStringVariables($characterStringVariables)
    {
        $this->container['characterStringVariables'] = $characterStringVariables;

        return $this;
    }

    /**
     * Gets characterCraftables
     *
     * @return \Bungie\Model\DictionaryComponentResponseOfint64AndDestinyCraftablesComponent|null
     */
    public function getCharacterCraftables()
    {
        return $this->container['characterCraftables'];
    }

    /**
     * Sets characterCraftables
     *
     * @param \Bungie\Model\DictionaryComponentResponseOfint64AndDestinyCraftablesComponent|null $characterCraftables COMPONENT TYPE: Craftables
     *
     * @return $this
     */
    public function setCharacterCraftables($characterCraftables)
    {
        $this->container['characterCraftables'] = $characterCraftables;
