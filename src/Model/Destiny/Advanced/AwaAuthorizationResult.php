...
class AwaAuthorizationResult implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'userSelection' => '\Bungie\Model\Destiny\Advanced\AwaUserSelection',
        'responseReason' => '\Bungie\Model\Destiny\Advanced\AwaResponseReason',
        'developerNote' => 'string',
        'actionToken' => 'string',
        'maximumNumberOfUses' => 'int',
        'validUntil' => '\DateTime',
        'type' => '\Bungie\Model\Destiny\Advanced\AwaType',
     ...
     * Sets userSelection
     *
     * @param \Bungie\Model\Destiny\Advanced\AwaUserSelection|null $userSelection Indication of how the user responded to the request. If the value is \"Approved\" the actionToken will contain the token that can be presented when performing the advanced write action.
     *
     * @return $this
     */
     ...
     * Gets responseReason
     *
     * @return \Bungie\Model\Destiny\Advanced\AwaResponseReason|null
     */
     ...
     * Sets responseReason
     *
     * @param \Bungie\Model\Destiny\Advanced\AwaResponseReason|null $responseReason responseReason
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Bungie\Model\Destiny\Advanced\AwaType|null
     */
     ...
     * Sets type
     *
     * @param \Bungie\Model\Destiny\Advanced\AwaType|null $type Advanced Write Action Type from the permission request.
     *
     * @return $this
     */
     ...
     * Sets membershipType
     *
     * @param \Bungie\Model\BungieMembershipType|null $membershipType MembershipType from the permission request.
     *
     * @return $this
     */
