...
class DestinyInsertPlugsRequestEntry implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'socketIndex' => 'int',
        'socketArrayType' => '\Bungie\Model\Destiny\Requests\Actions\DestinySocketArrayType',
        'plugItemHash' => 'int'
    ];
     ...
     *
     * @return \Bungie\Model\Destiny\Requests\Actions\DestinySocketArrayType|null
     */
     ...
     *
     * @param \Bungie\Model\Destiny\Requests\Actions\DestinySocketArrayType|null $socketArrayType This property, combined with the socketIndex, tells us which socket we are referring to (since operations can be performed on both Intrinsic and \"default\" sockets, and they occupy different arrays in the Inventory Item Definition). I know, I know. Don't give me that look.
     *
     * @return $this
     */
