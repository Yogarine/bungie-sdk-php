...
class DestinySocketCategoryStyle
{
    ...
    const DESTINY_SOCKET_CATEGORY_STYLE_ABILITIES = 7;
    const DESTINY_SOCKET_CATEGORY_STYLE_SUPERS = 8;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::DESTINY_SOCKET_CATEGORY_STYLE_ABILITIES,
            self::DESTINY_SOCKET_CATEGORY_STYLE_SUPERS,
        ];
    }
}
