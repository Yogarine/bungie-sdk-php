...
/**
 * DestinyLeaderboardEntry Class Doc Comment
 *
 * @category Class
 * @package  Bungie
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DestinyLeaderboardEntry implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets characterId
     *
     * @param int|null $characterId ID of the player's best character for the reported stat.
     *
     * @return $this
     */
