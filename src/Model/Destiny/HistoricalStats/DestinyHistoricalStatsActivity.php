...
class DestinyHistoricalStatsActivity implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets mode
     *
     * @param \Bungie\Model\Destiny\HistoricalStats\Definitions\DestinyActivityModeType|null $mode Indicates the most specific game mode of the activity that we could find.
     *
     * @return $this
     */
