...
class DestinyProfileComponent implements \Bungie\Model\ModelInterface, ArrayAccess
{
     ...
     * Sets seasonHashes
     *
     * @param int[]|null $seasonHashes A list of seasons that this profile owns. Unlike versionsOwned, these stay with the profile across Platforms, and thus will be valid.
     *
     * @return $this
     */
