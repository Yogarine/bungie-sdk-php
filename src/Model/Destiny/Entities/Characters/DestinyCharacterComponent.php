...
class DestinyCharacterComponent implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'genderType' => '\Bungie\Model\Destiny\DestinyGender',
        'emblemPath' => 'string',
     ...
     * Sets membershipType
     *
     * @param \Bungie\Model\BungieMembershipType|null $membershipType membershipType tells you the platform on which the character plays. Examine the BungieMembershipType enumeration for possible values.
     *
     * @return $this
     */
     ...
     * Gets raceType
     *
     * @return \Bungie\Model\Destiny\DestinyRace|null
     */
     ...
     * Sets raceType
     *
     * @param \Bungie\Model\Destiny\DestinyRace|null $raceType Mostly for historical purposes at this point, this is an enumeration for the character's race.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove.
     *
     * @return $this
     */
     ...
     * Sets classType
     *
     * @param \Bungie\Model\Destiny\DestinyClass|null $classType Mostly for historical purposes at this point, this is an enumeration for the character's class.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove.
     *
     * @return $this
     */
     ...
     * Gets genderType
     *
     * @return \Bungie\Model\Destiny\DestinyGender|null
     */
     ...
     * Sets genderType
     *
     * @param \Bungie\Model\Destiny\DestinyGender|null $genderType Mostly for historical purposes at this point, this is an enumeration for the character's Gender.  It'll be preferable in the general case to look up the related definition: but for some people this was too convenient to remove. And yeah, it's an enumeration and not a boolean. Fight me.
     *
     * @return $this
     */
