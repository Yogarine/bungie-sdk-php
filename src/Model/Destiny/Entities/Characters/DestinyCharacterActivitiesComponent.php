...
/**
 * DestinyCharacterActivitiesComponent Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DestinyCharacterActivitiesComponent implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    const CURRENT_ACTIVITY_MODE_TYPE_BLACKARMORYRUN = 66;
    const CURRENT_ACTIVITY_MODE_TYPE_SALVAGE = 67;
    const CURRENT_ACTIVITY_MODE_TYPE_IRONBANNERSALVAGE = 68;
    const CURRENT_ACTIVITY_MODE_TYPE_PVPCOMPETITIVE = 69;
    const CURRENT_ACTIVITY_MODE_TYPE_PVPQUICKPLAY = 70;
    const CURRENT_ACTIVITY_MODE_TYPE_CLASHQUICKPLAY = 71;
    const CURRENT_ACTIVITY_MODE_TYPE_CLASHCOMPETITIVE = 72;
    const CURRENT_ACTIVITY_MODE_TYPE_CONTROLQUICKPLAY = 73;
    const CURRENT_ACTIVITY_MODE_TYPE_CONTROLCOMPETITIVE = 74;
    const CURRENT_ACTIVITY_MODE_TYPE_GAMBITPRIME = 75;
    const CURRENT_ACTIVITY_MODE_TYPE_RECKONING = 76;
    const CURRENT_ACTIVITY_MODE_TYPE_MENAGERIE = 77;
    const CURRENT_ACTIVITY_MODE_TYPE_VEXOFFENSIVE = 78;
    const CURRENT_ACTIVITY_MODE_TYPE_NIGHTMAREHUNT = 79;
    const CURRENT_ACTIVITY_MODE_TYPE_ELIMINATION = 80;
    const CURRENT_ACTIVITY_MODE_TYPE_MOMENTUM = 81;
    const CURRENT_ACTIVITY_MODE_TYPE_DUNGEON = 82;
    const CURRENT_ACTIVITY_MODE_TYPE_SUNDIAL = 83;
    const CURRENT_ACTIVITY_MODE_TYPE_TRIALSOFOSIRIS = 84;
    const CURRENT_ACTIVITY_MODE_TYPE_DARES = 85;
    const CURRENT_ACTIVITY_MODE_TYPE_OFFENSIVE = 86;
    const CURRENT_ACTIVITY_MODE_TYPE_LOSTSECTOR = 87;
    const CURRENT_ACTIVITY_MODE_TYPE_RIFT = 88;
    const CURRENT_ACTIVITY_MODE_TYPE_ZONECONTROL = 89;
    const CURRENT_ACTIVITY_MODE_TYPE_IRONBANNERRIFT = 90;
    const CURRENT_ACTIVITY_MODE_TYPE_IRONBANNERZONECONTROL = 91;
    ...
    public function getCurrentActivityModeTypeAllowableValues()
    {
        return [
            ...
            self::CURRENT_ACTIVITY_MODE_TYPE_BLACKARMORYRUN,
            self::CURRENT_ACTIVITY_MODE_TYPE_SALVAGE,
            self::CURRENT_ACTIVITY_MODE_TYPE_IRONBANNERSALVAGE,
            self::CURRENT_ACTIVITY_MODE_TYPE_PVPCOMPETITIVE,
            self::CURRENT_ACTIVITY_MODE_TYPE_PVPQUICKPLAY,
            self::CURRENT_ACTIVITY_MODE_TYPE_CLASHQUICKPLAY,
            self::CURRENT_ACTIVITY_MODE_TYPE_CLASHCOMPETITIVE,
            self::CURRENT_ACTIVITY_MODE_TYPE_CONTROLQUICKPLAY,
            self::CURRENT_ACTIVITY_MODE_TYPE_CONTROLCOMPETITIVE,
            self::CURRENT_ACTIVITY_MODE_TYPE_GAMBITPRIME,
            self::CURRENT_ACTIVITY_MODE_TYPE_RECKONING,
            self::CURRENT_ACTIVITY_MODE_TYPE_MENAGERIE,
            self::CURRENT_ACTIVITY_MODE_TYPE_VEXOFFENSIVE,
            self::CURRENT_ACTIVITY_MODE_TYPE_NIGHTMAREHUNT,
            self::CURRENT_ACTIVITY_MODE_TYPE_ELIMINATION,
            self::CURRENT_ACTIVITY_MODE_TYPE_MOMENTUM,
            self::CURRENT_ACTIVITY_MODE_TYPE_DUNGEON,
            self::CURRENT_ACTIVITY_MODE_TYPE_SUNDIAL,
            self::CURRENT_ACTIVITY_MODE_TYPE_TRIALSOFOSIRIS,
            self::CURRENT_ACTIVITY_MODE_TYPE_DARES,
            self::CURRENT_ACTIVITY_MODE_TYPE_OFFENSIVE,
            self::CURRENT_ACTIVITY_MODE_TYPE_LOSTSECTOR,
            self::CURRENT_ACTIVITY_MODE_TYPE_RIFT,
            self::CURRENT_ACTIVITY_MODE_TYPE_ZONECONTROL,
            self::CURRENT_ACTIVITY_MODE_TYPE_IRONBANNERRIFT,
            self::CURRENT_ACTIVITY_MODE_TYPE_IRONBANNERZONECONTROL,
        ];
    }
     ...
     *
     * @param int[]|null $currentActivityModeTypes All Activity Modes that apply to the current activity being played, in enum form.
     *
     * @return $this
     */
