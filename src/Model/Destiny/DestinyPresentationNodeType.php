...
class DestinyPresentationNodeType
{
    ...
    const DESTINY_PRESENTATION_NODE_TYPE_METRIC = 4;
    const DESTINY_PRESENTATION_NODE_TYPE_CRAFTABLE = 5;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::DESTINY_PRESENTATION_NODE_TYPE_METRIC,
            self::DESTINY_PRESENTATION_NODE_TYPE_CRAFTABLE,
        ];
    }
}
