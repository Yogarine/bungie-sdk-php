...
class DestinyUnlockValueUIStyle
{
    ...
    const DESTINY_UNLOCK_VALUE_UISTYLE_GREENPIPS = 10;
    const DESTINY_UNLOCK_VALUE_UISTYLE_REDPIPS = 11;
    const DESTINY_UNLOCK_VALUE_UISTYLE_EXPLICITPERCENTAGE = 12;
    const DESTINY_UNLOCK_VALUE_UISTYLE_RAWFLOAT = 13;
    const DESTINY_UNLOCK_VALUE_UISTYLE_LEVELANDREWARD = 14;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::DESTINY_UNLOCK_VALUE_UISTYLE_GREENPIPS,
            self::DESTINY_UNLOCK_VALUE_UISTYLE_REDPIPS,
            self::DESTINY_UNLOCK_VALUE_UISTYLE_EXPLICITPERCENTAGE,
            self::DESTINY_UNLOCK_VALUE_UISTYLE_RAWFLOAT,
            self::DESTINY_UNLOCK_VALUE_UISTYLE_LEVELANDREWARD,
        ];
    }
}
