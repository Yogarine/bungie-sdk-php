 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse200 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Applications\ApiUsage',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Applications\ApiUsage|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Applications\ApiUsage|null $response response
     *
     * @return $this
     */
