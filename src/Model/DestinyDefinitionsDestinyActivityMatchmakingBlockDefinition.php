 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyActivityMatchmakingBlockDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyActivityMatchmakingBlockDefinition';
     ...
     * Sets isMatchmade
     *
     * @param bool $isMatchmade If TRUE, the activity is matchmade. Otherwise, it requires explicit forming of a party.
     *
     * @return $this
     */
     ...
     * Sets minParty
     *
     * @param int $minParty The minimum # of people in the fireteam for the activity to launch.
     *
     * @return $this
     */
     ...
     * Sets maxParty
     *
     * @param int $maxParty The maximum # of people allowed in a Fireteam.
     *
     * @return $this
     */
     ...
     * Sets maxPlayers
     *
     * @param int $maxPlayers The maximum # of people allowed across all teams in the activity.
     *
     * @return $this
     */
     ...
     *
     * @param bool $requiresGuardianOath If true, you have to Solemnly Swear to be up to Nothing But Good(tm) to play.
     *
     * @return $this
     */
