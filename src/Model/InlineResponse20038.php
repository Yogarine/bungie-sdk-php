 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20038 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Destiny\Responses\DestinyCharacterResponse',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Destiny\Responses\DestinyCharacterResponse|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Destiny\Responses\DestinyCharacterResponse|null $response response
     *
     * @return $this
     */
