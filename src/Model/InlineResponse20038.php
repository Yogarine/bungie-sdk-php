...
class InlineResponse20038 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\DestinyResponsesDestinyCharacterResponse',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\DestinyResponsesDestinyCharacterResponse|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\DestinyResponsesDestinyCharacterResponse|null $response response
     *
     * @return $this
     */
