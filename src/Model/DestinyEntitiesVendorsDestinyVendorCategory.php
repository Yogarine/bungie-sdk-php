 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyEntitiesVendorsDestinyVendorCategory implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Entities.Vendors.DestinyVendorCategory';
     ...
     *
     * @param int $displayCategoryIndex An index into the DestinyVendorDefinition.displayCategories property, so you can grab the display data for this category.
     *
     * @return $this
     */
