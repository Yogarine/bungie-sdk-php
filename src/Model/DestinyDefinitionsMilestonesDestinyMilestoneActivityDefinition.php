 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsMilestonesDestinyMilestoneActivityDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.Milestones.DestinyMilestoneActivityDefinition';
     ...
     *
     * @param int $conceptualActivityHash The \"Conceptual\" activity hash. Basically, we picked the lowest level activity and are treating it as the canonical definition of the activity for rendering purposes.  If you care about the specific difficulty modes and variations, use the activities under \"Variants\".
     *
     * @return $this
     */
     ...
     * Gets variants
     *
     * @return map[string,\Bungie\Model\DestinyDefinitionsMilestonesDestinyMilestoneActivityVariantDefinition]
     */
