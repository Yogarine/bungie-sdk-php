...
class DestinyAdvancedAwaAuthorizationResult implements ModelInterface, ArrayAccess
{
     ...
     * Gets userSelection
     *
     * @return DestinyAdvancedAwaUserSelection|null
     */
     ...
     * Sets userSelection
     *
     * @param DestinyAdvancedAwaUserSelection|null $userSelection Indication of how the user responded to the request. If the value is \"Approved\" the actionToken will contain the token that can be presented when performing the advanced write action.
     *
     * @return $this
     */
     ...
     * Gets responseReason
     *
     * @return \Bungie\Model\DestinyAdvancedAwaResponseReason|null
     */
     ...
     * Sets responseReason
     *
     * @param \Bungie\Model\DestinyAdvancedAwaResponseReason|null $responseReason responseReason
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return DestinyAdvancedAwaType|null
     */
     ...
     * Sets type
     *
     * @param DestinyAdvancedAwaType|null $type Advanced Write Action Type from the permission request.
     *
     * @return $this
     */
     ...
     * Sets membershipType
     *
     * @param BungieMembershipType|null $membershipType MembershipType from the permission request.
     *
     * @return $this
     */
