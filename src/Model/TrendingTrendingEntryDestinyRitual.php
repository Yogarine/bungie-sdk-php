...
class TrendingTrendingEntryDestinyRitual implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Trending.TrendingEntryDestinyRitual';
     ...
     *
     * @param object $milestoneDetails A destiny event does not necessarily have a related Milestone, but if it does the details will be returned here.
     *
     * @return $this
     */
     ...
     * Sets eventContent
     *
     * @param object $eventContent A destiny event will not necessarily have milestone \"custom content\", but if it does the details will be here.
     *
     * @return $this
     */
