...
class DestinyDefinitionsDestinyItemCategoryDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'grantDestinyItemType' => 'DestinyDestinyItemType',
        'grantDestinySubType' => 'DestinyDestinyItemSubType',
        'grantDestinyClass' => 'DestinyDestinyClass',
     ...
     *
     * @param DestinyDestinyItemType|null $grantDestinyItemType If an item belongs to this category, it will also receive this item type. This is now how DestinyItemType is populated for items: it used to be an even jankier process, but that's a story that requires more alcohol.
     *
     * @return $this
     */
     ...
     *
     * @param DestinyDestinyClass|null $grantDestinyClass If an item belongs to this category, it will also get this class restriction enum value.  See the other \"grant\"-prefixed properties on this definition for my color commentary.
     *
     * @return $this
     */
