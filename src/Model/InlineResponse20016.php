 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20016 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Config\GroupTheme[]',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Config\GroupTheme[]|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Config\GroupTheme[]|null $response response
     *
     * @return $this
     */
