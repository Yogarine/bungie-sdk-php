 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyTalentNodeDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyTalentNodeDefinition';
    ...
    protected static $swaggerTypes = [
        ...
        'steps' => '\Bungie\Model\DestinyDefinitionsDestinyNodeStepDefinition[]',
     ...
     * Sets nodeIndex
     *
     * @param int $nodeIndex The index into the DestinyTalentGridDefinition's \"nodes\" property where this node is located. Used to uniquely identify the node within the Talent Grid. Note that this is content version dependent: make sure you have the latest version of content before trying to use these properties.
     *
     * @return $this
     */
     ...
     * Sets row
     *
     * @param int $row The visual \"row\" where the node should be shown in the UI. If negative, then the node is hidden.
     *
     * @return $this
     */
     ...
     * Sets column
     *
     * @param int $column The visual \"column\" where the node should be shown in the UI. If negative, the node is hidden.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $prerequisiteNodeIndexes Indexes into the DestinyTalentGridDefinition.nodes property for any nodes that must be activated before this one is allowed to be activated.  I would have liked to change this to hashes for Destiny 2, but we have run out of time.
     *
     * @return $this
     */
     ...
     * Sets autoUnlocks
     *
     * @param bool $autoUnlocks If true, this node will automatically unlock when the Talent Grid's level reaches the required level of the current step of this node.
     *
     * @return $this
     */
     ...
     * Sets isRandom
     *
     * @param bool $isRandom If this is true, the node's step is determined randomly rather than the first step being chosen.
     *
     * @return $this
     */
     ...
     *
     * @param object $randomActivationRequirement At one point, you were going to be able to repurchase talent nodes that had random steps, to \"re-roll\" the current step of the node (and thus change the properties of your item). This was to be the activation requirement for performing that re-roll.  The system still exists to do this, as far as I know, so it may yet come back around!
     *
     * @return $this
     */
     ...
     *
     * @param bool $isRandomRepurchasable If this is true, the node can be \"re-rolled\" to acquire a different random current step. This is not used, but still exists for a theoretical future of talent grids.
     *
     * @return $this
     */
     ...
     * Gets steps
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyNodeStepDefinition[]
     */
     ...
     * Sets steps
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyNodeStepDefinition[] $steps At this point, \"steps\" have been obfuscated into conceptual entities, aggregating the underlying notions of \"properties\" and \"true steps\".  If you need to know a step as it truly exists - such as when recreating Node logic when processing Vendor data - you'll have to use the \"realSteps\" property below.
     *
     * @return $this
     */
     ...
     *
     * @param int[] $exclusiveWithNodeHashes The nodeHash values for nodes that are in an Exclusive Set with this node.  See DestinyTalentGridDefinition.exclusiveSets for more info about exclusive sets.  Again, note that these are nodeHashes and *not* nodeIndexes.
     *
     * @return $this
     */
     ...
     *
     * @param int $randomStartProgressionBarAtProgression If the node's step is randomly selected, this is the amount of the Talent Grid's progression experience at which the progression bar for the node should be shown.
     *
     * @return $this
     */
     ...
     *
     * @param string $layoutIdentifier A string identifier for a custom visual layout to apply to this talent node. Unfortunately, we do not have any data for rendering these custom layouts. It will be up to you to interpret these strings and change your UI if you want to have custom UI matching these layouts.
     *
     * @return $this
     */
     ...
     * Sets groupHash
     *
     * @param int $groupHash As of Destiny 2, nodes can exist as part of \"Exclusive Groups\". These differ from exclusive sets in that, within the group, many nodes can be activated. But the act of activating any node in the group will cause \"opposing\" nodes (nodes in groups that are not allowed to be activated at the same time as this group) to deactivate.  See DestinyTalentExclusiveGroup for more information on the details. This is an identifier for this node's group, if it is part of one.
     *
     * @return $this
     */
     ...
     * Sets loreHash
     *
     * @param int $loreHash Talent nodes can be associated with a piece of Lore, generally rendered in a tooltip. This is the hash identifier of the lore element to show, if there is one to be show.
     *
     * @return $this
     */
     ...
     *
     * @param string $nodeStyleIdentifier Comes from the talent grid node style: this identifier should be used to determine how to render the node in the UI.
     *
     * @return $this
     */
     ...
     *
     * @param bool $ignoreForCompletion Comes from the talent grid node style: if true, then this node should be ignored for determining whether the grid is complete.
     *
     * @return $this
     */
