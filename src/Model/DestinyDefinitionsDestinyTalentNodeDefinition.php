...
class DestinyDefinitionsDestinyTalentNodeDefinition implements ModelInterface, ArrayAccess
{
     ...
     * Gets steps
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyNodeStepDefinition[]|null
     */
     ...
     * Sets steps
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyNodeStepDefinition[]|null $steps At this point, \"steps\" have been obfuscated into conceptual entities, aggregating the underlying notions of \"properties\" and \"true steps\".  If you need to know a step as it truly exists - such as when recreating Node logic when processing Vendor data - you'll have to use the \"realSteps\" property below.
     *
     * @return $this
     */
