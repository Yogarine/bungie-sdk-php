 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyStatDisplayDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyStatDisplayDefinition';
    ...
    protected static $swaggerTypes = [
        ...
        'displayInterpolation' => '\Bungie\Model\InterpolationInterpolationPoint[]'
    ];
     ...
     * Sets statHash
     *
     * @param int $statHash The hash identifier for the stat being transformed into a Display stat.  Use it to look up the DestinyStatDefinition, or key into a DestinyInventoryItemDefinition's stats property.
     *
     * @return $this
     */
     ...
     * Sets maximumValue
     *
     * @param int $maximumValue Regardless of the output of interpolation, this is the maximum possible value that the stat can be. It should also be used as the upper bound for displaying the stat as a progress bar (the minimum always being 0)
     *
     * @return $this
     */
     ...
     *
     * @param bool $displayAsNumeric If this is true, the stat should be displayed as a number. Otherwise, display it as a progress bar. Or, you know, do whatever you want. There's no displayAsNumeric police.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\InterpolationInterpolationPoint[]
     */
     ...
     *
     * @param \Bungie\Model\InterpolationInterpolationPoint[] $displayInterpolation The interpolation table representing how the Investment Stat is transformed into a Display Stat.   See DestinyStatDefinition for a description of the stages of stat transformation.
     *
     * @return $this
     */
