 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyLocationReleaseDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyLocationReleaseDefinition';
     ...
     *
     * @param object $displayProperties Sadly, these don't appear to be populated anymore (ever?)
     *
     * @return $this
     */
     ...
     *
     * @param string $smallTransparentIcon smallTransparentIcon
     *
     * @return $this
     */
     ...
     *
     * @param string $largeTransparentIcon largeTransparentIcon
     *
     * @return $this
     */
     ...
     * Sets spawnPoint
     *
     * @param int $spawnPoint If we had map information, this spawnPoint would be interesting. But sadly, we don't have that info.
     *
     * @return $this
     */
     ...
     *
     * @param int $destinationHash The Destination being pointed to by this location.
     *
     * @return $this
     */
     ...
     * Sets activityHash
     *
     * @param int $activityHash The Activity being pointed to by this location.
     *
     * @return $this
     */
     ...
     *
     * @param int $activityGraphHash The Activity Graph being pointed to by this location.
     *
     * @return $this
     */
     ...
     *
     * @param int $activityGraphNodeHash The Activity Graph Node being pointed to by this location. (Remember that Activity Graph Node hashes are only unique within an Activity Graph: so use the combination to find the node being spoken of)
     *
     * @return $this
     */
     ...
     *
     * @param int $activityBubbleName The Activity Bubble within the Destination. Look this up in the DestinyDestinationDefinition's bubbles and bubbleSettings properties.
     *
     * @return $this
     */
     ...
     *
     * @param int $activityPathBundle If we had map information, this would tell us something cool about the path this location wants you to take. I wish we had map information.
     *
     * @return $this
     */
     ...
     *
     * @param int $activityPathDestination If we had map information, this would tell us about path information related to destination on the map. Sad. Maybe you can do something cool with it. Go to town man.
     *
     * @return $this
     */
     ...
     * Sets navPointType
     *
     * @param object $navPointType The type of Nav Point that this represents. See the enumeration for more info.
     *
     * @return $this
     */
     ...
     * Sets worldPosition
     *
     * @param int[] $worldPosition Looks like it should be the position on the map, but sadly it does not look populated... yet?
     *
     * @return $this
     */
