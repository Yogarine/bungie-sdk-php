...
class DestinyDefinitionsDestinyLocationReleaseDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'navPointType' => 'DestinyDestinyActivityNavPointType',
        'worldPosition' => 'int[]'
    ];
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $displayProperties Sadly, these don't appear to be populated anymore (ever?)
     *
     * @return $this
     */
     ...
     * Gets navPointType
     *
     * @return DestinyDestinyActivityNavPointType|null
     */
     ...
     * Sets navPointType
     *
     * @param DestinyDestinyActivityNavPointType|null $navPointType The type of Nav Point that this represents. See the enumeration for more info.
     *
     * @return $this
     */
