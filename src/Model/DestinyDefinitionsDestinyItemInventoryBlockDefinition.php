...
class DestinyDefinitionsDestinyItemInventoryBlockDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyItemInventoryBlockDefinition';
     ...
     *
     * @param string $stackUniqueLabel If this string is populated, you can't have more than one stack with this label in a given inventory. Note that this is different from the equipping block's unique label, which is used for equipping uniqueness.
     *
     * @return $this
     */
     ...
     * Sets maxStackSize
     *
     * @param int $maxStackSize The maximum quantity of this item that can exist in a stack.
     *
     * @return $this
     */
     ...
     * Sets bucketTypeHash
     *
     * @param int $bucketTypeHash The hash identifier for the DestinyInventoryBucketDefinition to which this item belongs. I should have named this \"bucketHash\", but too many things refer to it now. Sigh.
     *
     * @return $this
     */
     ...
     *
     * @param int $recoveryBucketTypeHash If the item is picked up by the lost loot queue, this is the hash identifier for the DestinyInventoryBucketDefinition into which it will be placed. Again, I should have named this recoveryBucketHash instead.
     *
     * @return $this
     */
     ...
     * Sets tierTypeHash
     *
     * @param int $tierTypeHash The hash identifier for the Tier Type of the item, use to look up its DestinyItemTierTypeDefinition if you need to show localized data for the item's tier.
     *
     * @return $this
     */
     ...
     * Sets isInstanceItem
     *
     * @param bool $isInstanceItem If TRUE, this item is instanced. Otherwise, it is a generic item that merely has a quantity in a stack (like Glimmer).
     *
     * @return $this
     */
     ...
     * Sets tierTypeName
     *
     * @param string $tierTypeName The localized name of the tier type, which is a useful shortcut so you don't have to look up the definition every time. However, it's mostly a holdover from days before we had a DestinyItemTierTypeDefinition to refer to.
     *
     * @return $this
     */
     ...
     * Sets tierType
     *
     * @param object $tierType The enumeration matching the tier type of the item to known values, again for convenience sake.
     *
     * @return $this
     */
     ...
     *
     * @param string $expirationTooltip The tooltip message to show, if any, when the item expires.
     *
     * @return $this
     */
     ...
     *
     * @param string $expiredInActivityMessage If the item expires while playing in an activity, we show a different message.
     *
     * @return $this
     */
     ...
     *
     * @param string $expiredInOrbitMessage If the item expires in orbit, we show a... more different message. (\"Consummate V's, consummate!\")
     *
     * @return $this
     */
     ...
     *
     * @param bool $suppressExpirationWhenObjectivesComplete suppressExpirationWhenObjectivesComplete
     *
     * @return $this
     */
