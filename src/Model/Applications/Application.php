...
class Application implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'applicationType' => '\Bungie\Model\Applications\OAuthApplicationType',
        'applicationId' => 'int',
        'name' => 'string',
        'redirectUrl' => 'string',
        'link' => 'string',
        'scope' => 'int',
        'origin' => 'string',
        'status' => '\Bungie\Model\Applications\ApplicationStatus',
     ...
     *
     * @return \Bungie\Model\Applications\OAuthApplicationType|null
     */
     ...
     *
     * @param \Bungie\Model\Applications\OAuthApplicationType|null $applicationType applicationType
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \Bungie\Model\Applications\ApplicationStatus|null
     */
     ...
     * Sets status
     *
     * @param \Bungie\Model\Applications\ApplicationStatus|null $status Current status of the application.
     *
     * @return $this
     */
