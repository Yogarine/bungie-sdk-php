...
class ApplicationScopes
{
    ...
    const APPLICATION_SCOPES_DESTINYUNLOCKVALUEQUERY = 8192;
    const APPLICATION_SCOPES_USERPIIREAD = 16384;
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::APPLICATION_SCOPES_DESTINYUNLOCKVALUEQUERY,
            self::APPLICATION_SCOPES_USERPIIREAD,
        ];
    }
}
