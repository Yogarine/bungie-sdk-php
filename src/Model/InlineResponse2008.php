...
class InlineResponse2008 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\User\UserSearchResponse',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\User\UserSearchResponse|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\User\UserSearchResponse|null $response response
     *
     * @return $this
     */
