...
class DestinyDefinitionsDestinyLocationDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyLocationDefinition';
     ...
     * Sets vendorHash
     *
     * @param int $vendorHash If the location has a Vendor on it, this is the hash identifier for that Vendor. Look them up with DestinyVendorDefinition.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyLocationReleaseDefinition[]
     */
