...
class DestinyDefinitionsItemsDestinyItemPlugDefinition implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'isPseudoPlug' => 'bool',
        'plugAvailability' => 'DestinyPlugAvailabilityMode',
        'alternateUiPlugLabel' => 'string',
        'alternatePlugStyle' => 'DestinyPlugUiStyles',
        'isDummyPlug' => 'bool',
     ...
     * Gets insertionRules
     *
     * @return \Bungie\Model\DestinyDefinitionsItemsDestinyPlugRuleDefinition[]|null
     */
     ...
     * Sets enabledRules
     *
     * @param \Bungie\Model\DestinyDefinitionsItemsDestinyPlugRuleDefinition[]|null $enabledRules The rules around whether the plug, once inserted, is enabled and providing its benefits.  The live data DestinyItemPlugComponent.enableFailIndexes will be an index into this array, so you can pull out the failure strings appropriate for the user.
     *
     * @return $this
     */
     ...
     * Gets plugStyle
     *
     * @return \Bungie\Model\DestinyPlugUiStyles|null
     */
     ...
     * Sets plugStyle
     *
     * @param \Bungie\Model\DestinyPlugUiStyles|null $plugStyle plugStyle
     *
     * @return $this
     */
     ...
     *
     * @return DestinyPlugAvailabilityMode|null
     */
     ...
     *
     * @param DestinyPlugAvailabilityMode|null $plugAvailability Indicates the rules about when this plug can be used. See the PlugAvailabilityMode enumeration for more information!
     *
     * @return $this
     */
     ...
     *
     * @return DestinyPlugUiStyles|null
     */
     ...
     *
     * @param DestinyPlugUiStyles|null $alternatePlugStyle The alternate plug of the plug: only applies when the item is in states that only the server can know about and control, unfortunately. See AlternateUiPlugLabel for the related label info.
     *
     * @return $this
     */
