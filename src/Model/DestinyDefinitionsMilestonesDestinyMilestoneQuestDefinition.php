...
class DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $displayProperties The individual quests may have different definitions from the overall milestone: if there's a specific active quest, use these displayProperties instead of that of the overall DestinyMilestoneDefinition.
     *
     * @return $this
     */
     ...
     * Sets questRewards
     *
     * @param DestinyDefinitionsMilestonesDestinyMilestoneQuestRewardsDefinition|null $questRewards The rewards you will get for completing this quest, as best as we could extract them from our data. Sometimes, it'll be a decent amount of data. Sometimes, it's going to be sucky. Sorry.
     *
     * @return $this
     */
     ...
     * Gets activities
     *
     * @return map[string,\Bungie\Model\DestinyDefinitionsMilestonesDestinyMilestoneActivityDefinition]|null
     */
