...
class DestinyDefinitionsDestinyStatOverrideDefinition implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $displayProperties The display properties to show instead of the base DestinyStatDefinition display properties.
     *
     * @return $this
     */
