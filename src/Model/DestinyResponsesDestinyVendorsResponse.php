...
class DestinyResponsesDestinyVendorsResponse implements ModelInterface, ArrayAccess
{
     ...
     * Gets sales
     *
     * @return DictionaryComponentResponseOfuint32AndDestinyVendorSaleItemSetComponent|null
     */
     ...
     * Sets sales
     *
     * @param DictionaryComponentResponseOfuint32AndDestinyVendorSaleItemSetComponent|null $sales Sales, keyed by the vendorItemIndex of the item being sold. These are keyed by the Vendor Hash, so you will get one Sale Item Set Component per vendor returned.  Note that within the Sale Item Set component, the sales are themselves keyed by the vendorSaleIndex, so you can relate it to the corrent sale item definition within the Vendor's definition.  COMPONENT TYPE: VendorSales
     *
     * @return $this
     */
