...
class InlineResponse20048 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Destiny\HistoricalStats\DestinyPostGameCarnageReportData',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Destiny\HistoricalStats\DestinyPostGameCarnageReportData|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Destiny\HistoricalStats\DestinyPostGameCarnageReportData|null $response response
     *
     * @return $this
     */
