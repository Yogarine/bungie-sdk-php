...
class InlineResponse20048 implements ModelInterface, ArrayAccess
{
     ...
     * Gets response
     *
     * @return map[string,map[string,\Bungie\Model\DestinyHistoricalStatsDestinyLeaderboard]]
     */
     ...
     * Sets response
     *
     * @param map[string,map[string,\Bungie\Model\DestinyHistoricalStatsDestinyLeaderboard]] $response response
     *
     * @return $this
     */
