...
class InlineResponse20048 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => 'map[string,map[string,\Bungie\Model\DestinyHistoricalStatsDestinyLeaderboard]]',
     ...
     * Gets response
     *
     * @return map[string,map[string,\Bungie\Model\DestinyHistoricalStatsDestinyLeaderboard]]|null
     */
     ...
     * Sets response
     *
     * @param map[string,map[string,\Bungie\Model\DestinyHistoricalStatsDestinyLeaderboard]]|null $response response
     *
     * @return $this
     */
