...
class InlineResponse20067 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\SearchResultOfFireteamResponse',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\SearchResultOfFireteamResponse|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\SearchResultOfFireteamResponse|null $response response
     *
     * @return $this
     */
