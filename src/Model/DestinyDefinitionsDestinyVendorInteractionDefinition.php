 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyVendorInteractionDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyVendorInteractionDefinition';
    ...
    protected static $swaggerTypes = [
        ...
        'replies' => '\Bungie\Model\DestinyDefinitionsDestinyVendorInteractionReplyDefinition[]',
        'vendorCategoryIndex' => 'int',
        'questlineItemHash' => 'int',
        'sackInteractionList' => '\Bungie\Model\DestinyDefinitionsDestinyVendorInteractionSackEntryDefinition[]',
     ...
     *
     * @param int $interactionIndex The position of this interaction in its parent array. Note that this is NOT content agnostic, and should not be used as such.
     *
     * @return $this
     */
     ...
     * Gets replies
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyVendorInteractionReplyDefinition[]
     */
     ...
     * Sets replies
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyVendorInteractionReplyDefinition[] $replies The potential replies that the user can make to the interaction.
     *
     * @return $this
     */
     ...
     *
     * @param int $vendorCategoryIndex If >= 0, this is the category of sale items to show along with this interaction dialog.
     *
     * @return $this
     */
     ...
     *
     * @param int $questlineItemHash If this interaction dialog is about a quest, this is the questline related to the interaction. You can use this to show the quest overview, or even the character's status with the quest if you use it to find the character's current Quest Step by checking their inventory against this questlineItemHash's DestinyInventoryItemDefinition.setData.
     *
     * @return $this
     */
     ...
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyVendorInteractionSackEntryDefinition[]
     */
     ...
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyVendorInteractionSackEntryDefinition[] $sackInteractionList If this interaction is meant to show you sacks, this is the list of types of sacks to be shown. If empty, the interaction is not meant to show sacks.
     *
     * @return $this
     */
     ...
     *
     * @param int $uiInteractionType A UI hint for the behavior of the interaction screen. This is useful to determine what type of interaction is occurring, such as a prompt to receive a rank up reward or a prompt to choose a reward for completing a quest. The hash isn't as useful as the Enum in retrospect, well what can you do. Try using interactionType instead.
     *
     * @return $this
     */
     ...
     *
     * @param object $interactionType The enumerated version of the possible UI hints for vendor interactions, which is a little easier to grok than the hash found in uiInteractionType.
     *
     * @return $this
     */
     ...
     *
     * @param string $rewardBlockLabel If this interaction is displaying rewards, this is the text to use for the header of the reward-displaying section of the interaction.
     *
     * @return $this
     */
     ...
     *
     * @param int $rewardVendorCategoryIndex If the vendor's reward list is sourced from one of his categories, this is the index into the category array of items to show.
     *
     * @return $this
     */
     ...
     * Sets flavorLineOne
     *
     * @param string $flavorLineOne If the vendor interaction has flavor text, this is some of it.
     *
     * @return $this
     */
     ...
     * Sets flavorLineTwo
     *
     * @param string $flavorLineTwo If the vendor interaction has flavor text, this is the rest of it.
     *
     * @return $this
     */
     ...
     *
     * @param object $headerDisplayProperties The header for the interaction dialog.
     *
     * @return $this
     */
     ...
     * Sets instructions
     *
     * @param string $instructions The localized text telling the player what to do when they see this dialog.
     *
     * @return $this
     */
