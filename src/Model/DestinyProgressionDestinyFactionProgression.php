 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyProgressionDestinyFactionProgression implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Progression.DestinyFactionProgression';
     ...
     * Sets factionHash
     *
     * @param int $factionHash The hash identifier of the Faction related to this progression. Use it to look up the DestinyFactionDefinition for more rendering info.
     *
     * @return $this
     */
     ...
     *
     * @param int $factionVendorIndex The index of the Faction vendor that is currently available. Will be set to -1 if no vendors are available.
     *
     * @return $this
     */
