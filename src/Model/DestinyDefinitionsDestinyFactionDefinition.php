...
class DestinyDefinitionsDestinyFactionDefinition implements ModelInterface, ArrayAccess
{
     ...
     * Gets vendors
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyFactionVendorDefinition[]|null
     */
     ...
     * Sets vendors
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyFactionVendorDefinition[]|null $vendors List of vendors that are associated with this faction. The last vendor that passes the unlock flag checks is the one that should be shown.
     *
     * @return $this
     */
