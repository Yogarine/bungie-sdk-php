 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse20013 implements \Bungie\Model\ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'response' => '\Bungie\Model\Content\NewsArticleRssResponse',
        'errorCode' => 'int',
        'throttleSeconds' => 'int',
        'errorStatus' => 'string',
        'message' => 'string',
     ...
     * Gets response
     *
     * @return \Bungie\Model\Content\NewsArticleRssResponse|null
     */
     ...
     * Sets response
     *
     * @param \Bungie\Model\Content\NewsArticleRssResponse|null $response response
     *
     * @return $this
     */
