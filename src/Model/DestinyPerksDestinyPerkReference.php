 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyPerksDestinyPerkReference implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Perks.DestinyPerkReference';
     ...
     * Sets iconPath
     *
     * @param string $iconPath The icon for the perk.
     *
     * @return $this
     */
     ...
     * Sets isActive
     *
     * @param bool $isActive Whether this perk is currently active. (We may return perks that you have not actually activated yet: these represent perks that you should show in the item's tooltip, but that the user has not yet activated.)
     *
     * @return $this
     */
     ...
     * Sets visible
     *
     * @param bool $visible Some perks provide benefits, but aren't visible in the UI. This value will let you know if this is perk should be shown in your UI.
     *
     * @return $this
     */
