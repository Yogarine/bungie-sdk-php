 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DestinyDefinitionsDestinyEquipmentSlotDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Destiny.Definitions.DestinyEquipmentSlotDefinition';
    ...
    protected static $swaggerTypes = [
        ...
        'artDyeChannels' => '\Bungie\Model\DestinyDefinitionsDestinyArtDyeReference[]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
     ...
     * Sets bucketTypeHash
     *
     * @param int $bucketTypeHash The inventory bucket that owns this equipment slot.
     *
     * @return $this
     */
     ...
     *
     * @param bool $applyCustomArtDyes If True, equipped items should have their custom art dyes applied when rendering the item. Otherwise, custom art dyes on an item should be ignored if the item is equipped in this slot.
     *
     * @return $this
     */
     ...
     * Gets artDyeChannels
     *
     * @return \Bungie\Model\DestinyDefinitionsDestinyArtDyeReference[]
     */
     ...
     * Sets artDyeChannels
     *
     * @param \Bungie\Model\DestinyDefinitionsDestinyArtDyeReference[] $artDyeChannels The Art Dye Channels that apply to this equipment slot.
     *
     * @return $this
     */
