...
class Destiny2Api
{
    ...
    {
        list($response) = $this->getClanBannerSourceWithHttpInfo();
        return $response;
    }

    /**
     * Operation getClanBannerSourceWithHttpInfo
     *
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getClanBannerSourceWithHttpInfo()
    {
        $request = $this->getClanBannerSourceRequest();
    ...
    /**
     * Operation getClanBannerSourceAsync
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClanBannerSourceAsync()
    {
        return $this->getClanBannerSourceAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getClanBannerSourceAsyncWithHttpInfo
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getClanBannerSourceAsyncWithHttpInfo()
    {
        $returnType = '\Bungie\Model\InlineResponse20045';
        $request = $this->getClanBannerSourceRequest();
    ...
    /**
     * Create request for operation 'getClanBannerSource'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     ...
     * @param  bool $getAllMemberships (optional) if set to &#39;true&#39;, all memberships regardless of whether they&#39;re obscured by overrides will be returned. Normal privacy restrictions on account linking will still apply no matter what. (optional)
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     ...
     */
    public function getLinkedProfiles($membershipId, $membershipType, $getAllMemberships = null)
    {
        list($response) = $this->getLinkedProfilesWithHttpInfo($membershipId, $membershipType, $getAllMemberships);
        return $response;
    }
     ...
     */
    public function getLinkedProfilesWithHttpInfo($membershipId, $membershipType, $getAllMemberships = null)
    {
        $request = $this->getLinkedProfilesRequest($membershipId, $membershipType, $getAllMemberships);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLinkedProfilesAsync($membershipId, $membershipType, $getAllMemberships = null)
    {
        return $this->getLinkedProfilesAsyncWithHttpInfo($membershipId, $membershipType, $getAllMemberships)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLinkedProfilesAsyncWithHttpInfo($membershipId, $membershipType, $getAllMemberships = null)
    {
        $returnType = '\Bungie\Model\InlineResponse20041';
        $request = $this->getLinkedProfilesRequest($membershipId, $membershipType, $getAllMemberships);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getLinkedProfilesRequest($membershipId, $membershipType, $getAllMemberships = null)
    {
        ...
        if ($getAllMemberships !== null) {
            $queryParams['getAllMemberships'] = ObjectSerializer::toQueryValue($getAllMemberships);
        }
     ...
     */
    public function getVendors($characterId, $destinyMembershipId, $membershipType, $components = null, $filter = null)
    {
        list($response) = $this->getVendorsWithHttpInfo($characterId, $destinyMembershipId, $membershipType, $components, $filter);
        return $response;
    }
     ...
     */
    public function getVendorsWithHttpInfo($characterId, $destinyMembershipId, $membershipType, $components = null, $filter = null)
    {
        $request = $this->getVendorsRequest($characterId, $destinyMembershipId, $membershipType, $components, $filter);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVendorsAsync($characterId, $destinyMembershipId, $membershipType, $components = null, $filter = null)
    {
        return $this->getVendorsAsyncWithHttpInfo($characterId, $destinyMembershipId, $membershipType, $components, $filter)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVendorsAsyncWithHttpInfo($characterId, $destinyMembershipId, $membershipType, $components = null, $filter = null)
    {
        $returnType = '\Bungie\Model\InlineResponse20047';
        $request = $this->getVendorsRequest($characterId, $destinyMembershipId, $membershipType, $components, $filter);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVendorsRequest($characterId, $destinyMembershipId, $membershipType, $components = null, $filter = null)
    {
        // verify the required parameter 'characterId' is set
        if ($characterId === null || (is_array($characterId) && count($characterId) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation insertSocketPlugFree
     *
     * @param  \Bungie\Model\Destiny\Requests\Actions\DestinyInsertPlugsFreeActionRequest $destinyInsertPlugsFreeActionRequest destinyInsertPlugsFreeActionRequest (required)
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     * @return \Bungie\Model\InlineResponse20052
     */
    public function insertSocketPlugFree($destinyInsertPlugsFreeActionRequest)
    {
        list($response) = $this->insertSocketPlugFreeWithHttpInfo($destinyInsertPlugsFreeActionRequest);
        return $response;
    }

    /**
     * Operation insertSocketPlugFreeWithHttpInfo
     *
     * @param  \Bungie\Model\Destiny\Requests\Actions\DestinyInsertPlugsFreeActionRequest $destinyInsertPlugsFreeActionRequest (required)
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     * @return array of \Bungie\Model\InlineResponse20052, HTTP status code, HTTP response headers (array of strings)
     */
    public function insertSocketPlugFreeWithHttpInfo($destinyInsertPlugsFreeActionRequest)
    {
        $request = $this->insertSocketPlugFreeRequest($destinyInsertPlugsFreeActionRequest);
    ...
    /**
     * Operation insertSocketPlugFreeAsync
     *
     * 
     *
     * @param  \Bungie\Model\Destiny\Requests\Actions\DestinyInsertPlugsFreeActionRequest $destinyInsertPlugsFreeActionRequest (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function insertSocketPlugFreeAsync($destinyInsertPlugsFreeActionRequest)
    {
        return $this->insertSocketPlugFreeAsyncWithHttpInfo($destinyInsertPlugsFreeActionRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation insertSocketPlugFreeAsyncWithHttpInfo
     *
     * 
     *
     * @param  \Bungie\Model\Destiny\Requests\Actions\DestinyInsertPlugsFreeActionRequest $destinyInsertPlugsFreeActionRequest (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function insertSocketPlugFreeAsyncWithHttpInfo($destinyInsertPlugsFreeActionRequest)
    {
        $returnType = '\Bungie\Model\InlineResponse20052';
        $request = $this->insertSocketPlugFreeRequest($destinyInsertPlugsFreeActionRequest);
    ...
    /**
     * Create request for operation 'insertSocketPlugFree'
     *
     * @param  \Bungie\Model\Destiny\Requests\Actions\DestinyInsertPlugsFreeActionRequest $destinyInsertPlugsFreeActionRequest (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function insertSocketPlugFreeRequest($destinyInsertPlugsFreeActionRequest)
    {
        // verify the required parameter 'destinyInsertPlugsFreeActionRequest' is set
        if ($destinyInsertPlugsFreeActionRequest === null || (is_array($destinyInsertPlugsFreeActionRequest) && count($destinyInsertPlugsFreeActionRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $destinyInsertPlugsFreeActionRequest when calling insertSocketPlugFree'
            );
        }

        $resourcePath = '/Destiny2/Actions/Items/InsertSocketPlugFree/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($destinyInsertPlugsFreeActionRequest)) {
            $_tempBody = $destinyInsertPlugsFreeActionRequest;
        }
    ...
    /**
     * Operation searchDestinyPlayerByBungieName
     *
     * @param  int $membershipType A valid non-BungieNet membership type, or All. Indicates which memberships to return. You probably want this set to All. (required)
     * @param  \Bungie\Model\User\ExactSearchRequest $exactSearchRequest exactSearchRequest (required)
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     ...
     */
    public function searchDestinyPlayerByBungieName($membershipType, $exactSearchRequest)
    {
        list($response) = $this->searchDestinyPlayerByBungieNameWithHttpInfo($membershipType, $exactSearchRequest);
        return $response;
    }

    /**
     * Operation searchDestinyPlayerByBungieNameWithHttpInfo
     *
     * @param  int $membershipType A valid non-BungieNet membership type, or All. Indicates which memberships to return. You probably want this set to All. (required)
     * @param  \Bungie\Model\User\ExactSearchRequest $exactSearchRequest (required)
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     ...
     */
    public function searchDestinyPlayerByBungieNameWithHttpInfo($membershipType, $exactSearchRequest)
    {
        $request = $this->searchDestinyPlayerByBungieNameRequest($membershipType, $exactSearchRequest);
    ...
    /**
     * Operation searchDestinyPlayerByBungieNameAsync
     *
     * 
     *
     * @param  int $membershipType A valid non-BungieNet membership type, or All. Indicates which memberships to return. You probably want this set to All. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchDestinyPlayerByBungieNameAsync($membershipType, $exactSearchRequest)
    {
        return $this->searchDestinyPlayerByBungieNameAsyncWithHttpInfo($membershipType, $exactSearchRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation searchDestinyPlayerByBungieNameAsyncWithHttpInfo
     *
     * 
     *
     * @param  int $membershipType A valid non-BungieNet membership type, or All. Indicates which memberships to return. You probably want this set to All. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchDestinyPlayerByBungieNameAsyncWithHttpInfo($membershipType, $exactSearchRequest)
    {
        $returnType = '\Bungie\Model\InlineResponse20040';
        $request = $this->searchDestinyPlayerByBungieNameRequest($membershipType, $exactSearchRequest);
    ...
    /**
     * Create request for operation 'searchDestinyPlayerByBungieName'
     *
     * @param  int $membershipType A valid non-BungieNet membership type, or All. Indicates which memberships to return. You probably want this set to All. (required)
     * @param  \Bungie\Model\User\ExactSearchRequest $exactSearchRequest (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchDestinyPlayerByBungieNameRequest($membershipType, $exactSearchRequest)
    {
        // verify the required parameter 'membershipType' is set
        if ($membershipType === null || (is_array($membershipType) && count($membershipType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $membershipType when calling searchDestinyPlayerByBungieName'
            );
        }
        // verify the required parameter 'exactSearchRequest' is set
        if ($exactSearchRequest === null || (is_array($exactSearchRequest) && count($exactSearchRequest) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $exactSearchRequest when calling searchDestinyPlayerByBungieName'
            );
        }

        $resourcePath = '/Destiny2/SearchDestinyPlayerByBungieName/{membershipType}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($exactSearchRequest)) {
            $_tempBody = $exactSearchRequest;
        }
     ...
     * @return \Bungie\Model\InlineResponse20025
     */
    public function setQuestTrackedState($destinyItemStateRequest)
    {
        list($response) = $this->setQuestTrackedStateWithHttpInfo($destinyItemStateRequest);
        return $response;
    }
     ...
     * @return array of \Bungie\Model\InlineResponse20025, HTTP status code, HTTP response headers (array of strings)
     */
    public function setQuestTrackedStateWithHttpInfo($destinyItemStateRequest)
    {
        $request = $this->setQuestTrackedStateRequest($destinyItemStateRequest);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setQuestTrackedStateAsync($destinyItemStateRequest)
    {
        return $this->setQuestTrackedStateAsyncWithHttpInfo($destinyItemStateRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setQuestTrackedStateAsyncWithHttpInfo($destinyItemStateRequest)
    {
        $returnType = '\Bungie\Model\InlineResponse20025';
        $request = $this->setQuestTrackedStateRequest($destinyItemStateRequest);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function setQuestTrackedStateRequest($destinyItemStateRequest)
    {
        // verify the required parameter 'destinyItemStateRequest' is set
        if ($destinyItemStateRequest === null || (is_array($destinyItemStateRequest) && count($destinyItemStateRequest) === 0)) {
            throw new \InvalidArgumentException(
