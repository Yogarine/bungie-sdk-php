...
class Destiny2Api
{
     ...
     * @param  bool $returnOriginalProfile (optional) If passed in and set to true, we will return the original Destiny Profile(s) linked to that gamertag, and not their currently active Destiny Profile. (optional)
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     ...
     */
    public function searchDestinyPlayer($displayName, $membershipType, $returnOriginalProfile = null)
    {
        list($response) = $this->searchDestinyPlayerWithHttpInfo($displayName, $membershipType, $returnOriginalProfile);
        return $response;
    }
     ...
     */
    public function searchDestinyPlayerWithHttpInfo($displayName, $membershipType, $returnOriginalProfile = null)
    {
        $request = $this->searchDestinyPlayerRequest($displayName, $membershipType, $returnOriginalProfile);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchDestinyPlayerAsync($displayName, $membershipType, $returnOriginalProfile = null)
    {
        return $this->searchDestinyPlayerAsyncWithHttpInfo($displayName, $membershipType, $returnOriginalProfile)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchDestinyPlayerAsyncWithHttpInfo($displayName, $membershipType, $returnOriginalProfile = null)
    {
        $returnType = '\Bungie\Model\InlineResponse20036';
        $request = $this->searchDestinyPlayerRequest($displayName, $membershipType, $returnOriginalProfile);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function searchDestinyPlayerRequest($displayName, $membershipType, $returnOriginalProfile = null)
    {
        ...
        if ($returnOriginalProfile !== null) {
            $queryParams['returnOriginalProfile'] = ObjectSerializer::toQueryValue($returnOriginalProfile);
        }
