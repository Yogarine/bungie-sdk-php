...
class ContentApi
{
    ...
    /**
     * Operation rssNewsArticles
     *
     * @param  string $pageToken Zero-based pagination token for paging through result sets. (required)
     * @param  string $categoryfilter Optionally filter response to only include news items in a certain category. (optional)
     * @param  bool $includebody Optionally include full content body for each news item. (optional)
     *
     * @throws \Bungie\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @throws \GuzzleHttp\Exception\GuzzleException
     ...
     */
    public function rssNewsArticles($pageToken, $categoryfilter = null, $includebody = null)
    {
        list($response) = $this->rssNewsArticlesWithHttpInfo($pageToken, $categoryfilter, $includebody);
        return $response;
    }

    /**
     * Operation rssNewsArticlesWithHttpInfo
     *
     * @param  string $pageToken Zero-based pagination token for paging through result sets. (required)
     * @param  string $categoryfilter Optionally filter response to only include news items in a certain category. (optional)
     * @param  bool $includebody Optionally include full content body for each news item. (optional)
     ...
     */
    public function rssNewsArticlesWithHttpInfo($pageToken, $categoryfilter = null, $includebody = null)
    {
        $request = $this->rssNewsArticlesRequest($pageToken, $categoryfilter, $includebody);
    ...
    /**
     * Operation rssNewsArticlesAsync
     *
     * 
     *
     * @param  string $pageToken Zero-based pagination token for paging through result sets. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rssNewsArticlesAsync($pageToken, $categoryfilter = null, $includebody = null)
    {
        return $this->rssNewsArticlesAsyncWithHttpInfo($pageToken, $categoryfilter, $includebody)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation rssNewsArticlesAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $pageToken Zero-based pagination token for paging through result sets. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rssNewsArticlesAsyncWithHttpInfo($pageToken, $categoryfilter = null, $includebody = null)
    {
        $returnType = '\Bungie\Model\InlineResponse20013';
        $request = $this->rssNewsArticlesRequest($pageToken, $categoryfilter, $includebody);
    ...
    /**
     * Create request for operation 'rssNewsArticles'
     *
     * @param  string $pageToken Zero-based pagination token for paging through result sets. (required)
     * @param  string $categoryfilter Optionally filter response to only include news items in a certain category. (optional)
     * @param  bool $includebody Optionally include full content body for each news item. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rssNewsArticlesRequest($pageToken, $categoryfilter = null, $includebody = null)
    {
        // verify the required parameter 'pageToken' is set
        if ($pageToken === null || (is_array($pageToken) && count($pageToken) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pageToken when calling rssNewsArticles'
            );
        }

        $resourcePath = '/Content/Rss/NewsArticles/{pageToken}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($categoryfilter !== null) {
            $queryParams['categoryfilter'] = ObjectSerializer::toQueryValue($categoryfilter);
        }
        // query params
        if ($includebody !== null) {
            $queryParams['includebody'] = ObjectSerializer::toQueryValue($includebody);
        }
        ...
        if ($pageToken !== null) {
            $resourcePath = str_replace(
                '{' . 'pageToken' . '}',
                ObjectSerializer::toPathValue($pageToken),
                $resourcePath
            );
        }
