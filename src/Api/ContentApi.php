...
class ContentApi
{
     ...
     */
    public function rssNewsArticles($pageToken)
    {
        list($response) = $this->rssNewsArticlesWithHttpInfo($pageToken);
        return $response;
    }
     ...
     */
    public function rssNewsArticlesWithHttpInfo($pageToken)
    {
        $request = $this->rssNewsArticlesRequest($pageToken);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rssNewsArticlesAsync($pageToken)
    {
        return $this->rssNewsArticlesAsyncWithHttpInfo($pageToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rssNewsArticlesAsyncWithHttpInfo($pageToken)
    {
        $returnType = '\Bungie\Model\InlineResponse20013';
        $request = $this->rssNewsArticlesRequest($pageToken);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function rssNewsArticlesRequest($pageToken)
    {
