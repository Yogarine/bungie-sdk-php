...
# **abdicateFoundership**
> \Bungie\Model\InlineResponse20020 abdicateFoundership($founderIdNew, $groupId, $membershipType)
...
> \Bungie\Model\InlineResponse20015 addOptionalConversation($groupId, $groupOptionalConversationAddRequest)
...
# **approvePending**
> \Bungie\Model\InlineResponse20020 approvePending($groupId, $membershipId, $membershipType, $groupApplicationRequest)
...
# **banMember**
> \Bungie\Model\InlineResponse20025 banMember($groupId, $membershipId, $membershipType, $groupBanRequest)
...
# **editClanBanner**
> \Bungie\Model\InlineResponse20025 editClanBanner($groupId, $clanBanner)
...
# **editFounderOptions**
> \Bungie\Model\InlineResponse20025 editFounderOptions($groupId, $groupOptionsEditAction)
...
# **editGroup**
> \Bungie\Model\InlineResponse20025 editGroup($groupId, $groupEditAction)
...
# **editGroupMembership**
> \Bungie\Model\InlineResponse20025 editGroupMembership($groupId, $membershipId, $membershipType, $memberType)
...
> \Bungie\Model\InlineResponse20015 editOptionalConversation($conversationId, $groupId, $groupOptionalConversationEditRequest)
...
> \Bungie\Model\InlineResponse20026 getAdminsAndFounderOfGroup($currentpage, $groupId)
...
# **getAvailableAvatars**
> \Bungie\Model\InlineResponse20018 getAvailableAvatars()
...
# **getAvailableThemes**
> \Bungie\Model\InlineResponse20019 getAvailableThemes()
...
> \Bungie\Model\InlineResponse20028 getBannedMembersOfGroup($currentpage, $groupId)
...
# **getGroup**
> \Bungie\Model\InlineResponse20023 getGroup($groupId)
...
# **getGroupByName**
> \Bungie\Model\InlineResponse20023 getGroupByName($groupName, $groupType)
...
# **getGroupByNameV2**
> \Bungie\Model\InlineResponse20023 getGroupByNameV2($groupNameSearchRequest)
...
> \Bungie\Model\InlineResponse20024 getGroupOptionalConversations($groupId)
...
# **getMembersOfGroup**
> \Bungie\Model\InlineResponse20026 getMembersOfGroup($currentpage, $groupId, $memberType, $nameSearch)
...
> \Bungie\Model\InlineResponse20033 getPotentialGroupsForMember($filter, $groupType, $membershipId, $membershipType)
...
> \Bungie\Model\InlineResponse20021 getRecommendedGroups($createDateRange, $groupType)
...
> \Bungie\Model\InlineResponse20020 getUserClanInviteSetting($mType)
...
# **groupSearch**
> \Bungie\Model\InlineResponse20022 groupSearch($groupQuery)
...
> \Bungie\Model\InlineResponse20034 individualGroupInvite($groupId, $membershipId, $membershipType, $groupApplicationRequest)
...
> \Bungie\Model\InlineResponse20034 individualGroupInviteCancel($groupId, $membershipId, $membershipType)
...
# **kickMember**
> \Bungie\Model\InlineResponse20027 kickMember($groupId, $membershipId, $membershipType)
...
> \Bungie\Model\InlineResponse20032 recoverGroupForFounder($groupType, $membershipId, $membershipType)
...
# **unbanMember**
> \Bungie\Model\InlineResponse20025 unbanMember($groupId, $membershipId, $membershipType)
