...
# **getCoreTopicsPaged**
> \Bungie\Model\InlineResponse20011 getCoreTopicsPaged($categoryFilter, $page, $quickDate, $sort, $locales)
...
> \Bungie\Model\InlineResponse20013 getForumTagSuggestions($partialtag)
...
# **getPoll**
> \Bungie\Model\InlineResponse20011 getPoll($topicId)
...
# **getPostAndParent**
> \Bungie\Model\InlineResponse20011 getPostAndParent($childPostId, $showbanned)
...
> \Bungie\Model\InlineResponse20011 getPostAndParentAwaitingApproval($childPostId, $showbanned)
...
> \Bungie\Model\InlineResponse20011 getPostsThreadedPaged($getParentPost, $page, $pageSize, $parentPostId, $replySize, $rootThreadMode, $sortMode, $showbanned)
...
> \Bungie\Model\InlineResponse20011 getPostsThreadedPagedFromChild($childPostId, $page, $pageSize, $replySize, $rootThreadMode, $sortMode, $showbanned)
...
> \Bungie\Model\InlineResponse20014 getRecruitmentThreadSummaries($requestBody)
...
# **getTopicForContent**
> \Bungie\Model\InlineResponse20012 getTopicForContent($contentId)
...
# **getTopicsPaged**
> \Bungie\Model\InlineResponse20011 getTopicsPaged($categoryFilter, $group, $page, $pageSize, $quickDate, $sort, $locales, $tagstring)
