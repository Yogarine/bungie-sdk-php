...
------------ | ------------- | ------------- | -------------
**customDyes** | [**\Bungie\Model\\Bungie\Model\Destiny\DyeReference[]**](DyeReference.md) | Custom dyes, calculated by iterating over the character&#39;s equipped items. Useful for pre-fetching all of the dye data needed from our server. | [optional] 
