...
**equipStatus** | [**\Bungie\Model\Exceptions\PlatformErrorCodes**](PlatformErrorCodes.md) | A PlatformErrorCodes enum indicating whether it succeeded, and if it failed why. | [optional] 
