...
**socketArrayType** | [**\Bungie\Model\Destiny\Requests\Actions\DestinySocketArrayType**](DestinySocketArrayType.md) | This property, combined with the socketIndex, tells us which socket we are referring to (since operations can be performed on both Intrinsic and \&quot;default\&quot; sockets, and they occupy different arrays in the Inventory Item Definition). I know, I know. Don&#39;t give me that look. | [optional] 
