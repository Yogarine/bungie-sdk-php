...
**enumValue** | [**\Bungie\Model\Destiny\DamageType**](DamageType.md) | We have an enumeration for damage types for quick reference. This is the current definition&#39;s damage type enum value. | [optional] 
