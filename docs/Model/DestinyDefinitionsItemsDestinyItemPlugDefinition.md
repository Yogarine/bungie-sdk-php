...
**plugAvailability** | [**DestinyPlugAvailabilityMode**](DestinyPlugAvailabilityMode.md) | Indicates the rules about when this plug can be used. See the PlugAvailabilityMode enumeration for more information! | [optional] 
...
**alternatePlugStyle** | [**DestinyPlugUiStyles**](DestinyPlugUiStyles.md) | The alternate plug of the plug: only applies when the item is in states that only the server can know about and control, unfortunately. See AlternateUiPlugLabel for the related label info. | [optional] 
