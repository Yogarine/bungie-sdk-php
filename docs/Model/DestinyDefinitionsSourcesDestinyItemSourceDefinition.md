...
**computedStats** | [**map[string,\Bungie\Model\DestinyDefinitionsDestinyInventoryItemStatDefinition]**](DestinyDefinitionsDestinyInventoryItemStatDefinition.md) | The stats computed for this level/quality range. | [optional] 
